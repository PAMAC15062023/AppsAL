<%@ Page Language="C#" MasterPageFile="~/CM.master" AutoEventWireup="true" CodeBehind="CM_Reviewer_Approval.aspx.cs" Inherits="ChangeManagement.CM_Reviewer_Approval" %>
    ...
    <table style="width: 688px;">
        <tr>
            <td class="TableTitle" style="height: 27px" colspan="4">
                <span style="font-size: 13pt; font-weight: bold;">Reviewer Approval</span>
            </td>
        </tr>
    </table>
    <table style="width: 688px;">
    ...
    <asp:Panel runat="server" ID="panel2" Visible="true">
        <table style="width: 688px;"><%--add on 19/11/2024--%>
            <tr>
                ...
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtsearch_crno" runat="server"  Width="150px" MaxLength="15" autocomplete="off"
                        OnTextChanged="txtsearch_crno_TextChanged" AutoPostBack="true"></asp:TextBox>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
        ...
        <table style="width: 688px;">
            <tr>
               ...
               <td class="TableTitle" style="height: 27px" colspan="8">
                ...
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtReviewerRemark" runat="server"  Width="150px" ></asp:TextBox>
                </td>
            </tr>
        </table>
