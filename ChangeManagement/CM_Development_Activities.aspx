<%@ Page Language="C#" MasterPageFile="~/CM.master" AutoEventWireup="true" CodeBehind="CM_Development_Activities.aspx.cs" Inherits="ChangeManagement.CM_Development_Activities" %>
    ...
    <table style="width: 688px;">
        <tr>
            <td class="TableTitle" style="height: 27px" colspan="4">
                <span id="lblHeader" runat="server" style="font-size: 13pt; font-weight: bold;">Development Activities</span>
            </td>
        </tr>
    </table>
    <table style="width: 688px;">
    ...
    <asp:Panel runat="server" ID="panel1" Visible="true">
        ...
        <table style="width: 688px;">
            <tr>
                ...
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">VH Approval Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtVHApprovalDate" runat="server" Enabled="false" Width="150px"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table style="width: 688px;">
            <tr>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">VH Name</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtVHName" runat="server" Enabled="false" Width="150px"></asp:TextBox>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
        ...
        <table style="width: 688px;">
            <tr>
                ...
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">REV Approval Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtREVApprovalDate" runat="server" Enabled="false" Width="150px"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table style="width: 688px;">
            <tr>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">REV Name</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtREVName" runat="server" Enabled="false" Width="150px"></asp:TextBox>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label runat="server" Visible="false" Width="150px" Font-Size="10" Height="20" Style="text-align: center;"></asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="TextBox2" runat="server" Width="150px" Visible="false"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table style="width: 688px;">
            ...
            <tr>
                ...
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:DropDownList ID="ddlAnyClarificationRequired" runat="server" Width="160px" OnSelectedIndexChanged="ddlAnyClarificationRequired_SelectedIndexChanged" AutoPostBack="true">
                ...
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblClarification" runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">Clarification</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtClarification" runat="server" Width="150px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table id="FNFClarification" runat="server" style="width: 688px;" visible="false">
            <tr>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblFirstClarificationSoughtDate" runat="server" Visible="false" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">First Clarification Sought Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtFirstClarificationSoughtDate" runat="server" Width="150px" TextMode="Date" autoClose="true"
                        onchange="TDate()" BorderWidth="1px" SkinID="txtSkin" Visible="false"></asp:TextBox>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblFinalClarificationReceivedDate" runat="server" Visible="false" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">	Final Clarification Received Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtFinalClarificationReceivedDate" runat="server" Width="150px" TextMode="Date" autoClose="true"
                        onchange="TDate()" BorderWidth="1px" SkinID="txtSkin" Visible="false"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table style="width: 688px;">
            <tr>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblEstimatedDateOfDelivery" runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">Estimated Date Of Delivery</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtEstimatedDateOfDelivery" runat="server" Width="150px" TextMode="Date" autoClose="true"
                        onchange="TDate()" BorderWidth="1px" SkinID="txtSkin" Visible="false"></asp:TextBox>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblAllocatedToDeveloperDate" runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">	Allocated To Developer Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtAllocatedToDeveloperDate" runat="server" Width="150px" TextMode="Date" autoClose="true"
                        onchange="TDate()" BorderWidth="1px" SkinID="txtSkin"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table id="UATDate" runat="server" visible="false" style="width: 688px;">
            <tr>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblGivenForUATDate" runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">Given For UAT Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtGivenForUATDate" runat="server" Width="150px" TextMode="Date" autoClose="true"
                        onchange="TDate()" BorderWidth="1px" SkinID="txtSkin"></asp:TextBox>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblUATConfirmationReceivedDate" runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">UAT Confirmation Received Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtUATConfirmationReceivedDate" runat="server" Width="150px" TextMode="Date" autoClose="true"
        ...
        <table style="width: 688px;">
            ...
            <tr>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblActualDeliveryDate" runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">Actual Delivery Date</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtActualDeliveryDate" runat="server" Width="150px" TextMode="Date" autoClose="true"
                        onchange="TDate()" BorderWidth="1px" SkinID="txtSkin"></asp:TextBox>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:Label ID="lblDEVORITRemark" runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">DEV OR IT Remark</asp:Label>
                </td>
                <td class="TableTitle" style="height: 27px" colspan="8">
                    <asp:TextBox ID="txtDEVORITRemark" runat="server" Width="150px"></asp:TextBox>
                </td>
            </tr>
        </table>
