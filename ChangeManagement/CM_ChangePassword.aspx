<%@ Page Language="C#" MasterPageFile="~/ChangeManagement.master" AutoEventWireup="true" CodeBehind="CM_ChangePassword.aspx.cs" Inherits="ChangeManagement.CM_ChangePassword" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <tr>
            <td class="TableHeader" colspan="8" rowspan="1" style="height: 14px">
                &nbsp;Change Password</td>
        </tr>
        <tr>
            <td style="width: 9px">
            ...
            <td class="TableTitle">
                &nbsp; OldPassword&nbsp; <span style="color: #ff0000">*</span></td>
            ...
            <td style="width: 59px; height: 3px">
            </td>
            <td style="width: 59px; height: 3px">
            </td>
            <td style="width: 59px; height: 3px">
        ...
        <tr>
            ...
            <td class="TableTitle" >
                &nbsp; NewPassword&nbsp; <span style="color: #ff0000">*</span></td>
        ...
        <tr>
            ...
            <td class="TableTitle" style="height: 8px;">
                ConfirmPassword<span style="color: #ff0000">*</span>
            </td>
        ...
        <tr>
            <td colspan="1" style="width: 9px">
            </td>
            <td colspan="7">
                <span style="color: #ff0000">&nbsp;<span style="font-size: 8pt">*</span></span>
                <strong><span style="font-size: 8pt">Indicate</span> <span style="font-size: 8pt">Mandatory</span>
                    <span style="font-size: 8pt">fields</span></strong></td>
        </tr>
        <tr>
            <td colspan="1" style="width: 9px; height: 66px">
            </td>
            <td colspan="7" style="height: 66px">
                <asp:RegularExpressionValidator ID="regExAlphabets" runat="server" ControlToValidate="txtNewPassword"
                  ...
                  <asp:RegularExpressionValidator ID="refExUpper" runat="server" ControlToValidate="txtNewPassword"
                    ErrorMessage="Alleast 1 Alphabets should be in Upper Case !" ValidationExpression=".{0,}[A-Z]{1,}.{0,}"
                    ValidationGroup="grpCngPwd" Width="311px"></asp:RegularExpressionValidator><br />
        ...
        <tr style="font-size: 8pt">
            <td class="TableTitle" colspan="8" rowspan="1" style="height: 37px">
                &nbsp;&nbsp;
                <asp:Button ID="btnConfirm" runat="server" Text="Save" Font-Bold="True" OnClick="btnConfirm_Click" Width="71px" ValidationGroup="grpCngPwd" BorderWidth="1px" />
                &nbsp;
                <asp:Button ID="btnReset" runat="server" Text="Reset" Font-Bold="True" OnClick="btnReset_Click" BorderWidth="1px" />
                &nbsp; <asp:Button ID="btnLogin" runat="server" Font-Bold="True"
                    Text="Login Again" OnClick="btnLogin_Click" BorderWidth="1px" />&nbsp;
                    <asp:LinkButton ID="lnkclear" runat="server" Text="Clear" 
                    onclick="lnkclear_Click"></asp:LinkButton>
                    </td>
        </tr>
        <tr>
            <td colspan="1" style="width: 9px; height: 13px">
            </td>
            <td colspan="7">
         ...
         <tr>
             <td colspan="1" style="width: 9px; height: 12px">
             </td>
				...
				<div class="shadow3">
                    ...
                    <li class="MsoNormal" style="margin: 0in 0in 0pt; mso-list: l0 level1 lfo1; tab-stops: list .5in">
                        <span style="font-size: 8pt; color: navy; font-family: verdana">Your Password
                            Minimum Length should be 8 Characters longs.</span></li><li class="MsoNormal" style="margin: 0in 0in 0pt; mso-list: l0 level1 lfo1; tab-stops: list .5in">
                        <span style="font-size: 8pt; color: navy; font-family: verdana">Your Password
                            should consist of  at least 4 Alphabets Character [a-z] or [A-Z],</span></li><li class="MsoNormal" style="margin: 0in 0in 0pt; mso-list: l0 level1 lfo1; tab-stops: list .5in">
                    <span style="font-size: 8pt; color: navy; font-family: verdana">Your Password
                            should consist of  at least 1 Upper Case Character [A-Z],</span></li><li class="MsoNormal" style="margin: 0in 0in 0pt; mso-list: l0 level1 lfo1; tab-stops: list .5in">     <span style="font-size: 8pt; color: navy; font-family: verdana">Your Password
                            Should consist of  least 3 Numeric [0-9] and 1 special character [!@#$%^&amp;*].</span></li><li class="MsoNormal" style="margin: 0in 0in 0pt; mso-list: l0 level1 lfo1; tab-stops: list .5in">
                <span style="font-size: 8pt; color: navy; font-family: verdana">Your Password
        ...
        <tr>
            ...
            <td colspan="7" style="width: 825px; height: 12px">
            </td>
        </tr>
    </table>
