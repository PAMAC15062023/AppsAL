...
{
    public partial class CM_VH_Approval : System.Web.UI.Page
    {
        ...
        protected void btnAccepted_Click(object sender, EventArgs e)
        {
            if (Session["UserName"] != null)
            {
                ...
                bool result = VH_Accepted();
                if (result)
                {
                    lblMsgXls.Visible = true;
                    lblMsgXls.Text = "VH Accepted the Request.";
                    //Response.Redirect("CM_VH_Approval.aspx", false);
                    return;
                }
                else
                {
                    lblMsgXls.Visible = true;
                    lblMsgXls.Text = "Something went wrong.";
                    //Response.Redirect("CM_VH_Approval.aspx", false);
                }
            }
            else
        ...
        protected void btnRejected_Click(object sender, EventArgs e)
        {
            if (Session["UserName"] != null)
            {
                ...
                bool result = VH_Rejected();
                if (result)
                {
                    lblMsgXls.Visible = true;
                    lblMsgXls.Text = "VH Rejected the Request.";
                    //Response.Redirect("CM_VH_Approval.aspx", false);
                    return;
                }
                else
        ...
        protected void Fetch_Values_In_Fields()
        {
            ...
            CRNo.Value = Convert.ToString(Session["CR_No"]);
        ...
        protected bool VH_Rejected()
        {
            ...
            //{
                ...
                sqlcom.Connection = sqlCon;
                sqlcom.CommandType = CommandType.StoredProcedure;
                sqlcom.CommandText = "CM_VH_Reject_SP";
                sqlcom.CommandTimeout = 0;
                ...
                SqlParameter VH_comment = new SqlParameter();
                VH_comment.SqlDbType = SqlDbType.VarChar;
                VH_comment.Value = txtVHRemark.Text;
                VH_comment.ParameterName = "@VH_Remark";
                sqlcom.Parameters.Add(VH_comment);
        ...
        protected bool VH_Accepted()
        {
            ...
            sqlcom.Connection = sqlCon;
            sqlcom.CommandType = CommandType.StoredProcedure;
            sqlcom.CommandText = "CM_VH_Accept_SP";
            sqlcom.CommandTimeout = 0;
