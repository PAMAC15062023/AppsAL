<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CDMA.Master" CodeBehind="CDMA_Product_Master.aspx.cs" Inherits="CoreDailyMISAutomation.CDMA_Product_Master" %>

<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
<table style="width: 688px;">
        <tr>
            <td class="TableTitle" style="height: 27px" colspan="4">
                <span style="font-size: 13pt; font-weight: bold;">Product Master</span>
            </td>
        </tr>
    </table>
    <table style="width: 688px;">
    ...
    <div>
        ...
        <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" 
            EmptyDataText="No records has been added." BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" AllowPaging="True" OnPageIndexChanging="gvProduct_PageIndexChanging">
