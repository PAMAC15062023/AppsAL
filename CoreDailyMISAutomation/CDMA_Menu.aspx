<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CDMA_Menu.aspx.cs" Inherits="CoreDailyMISAutomation.CDMA_Menu" %>
    ...
    <form id="form" runat="server">
      ...
      <i class="fa fa-caret-down"></i>
                    ...
                    <div class="dropdown-content">
                        <table>
                            <tr id="EditAndDownload" runat="server" visible="false">
                                <td>
                                    <a href="CDMA_RateMaster.aspx">Rate Master</a>
                                    <a href="CDMA_ReportExtract.aspx">Extract Report</a>
                                    <a href="UserMaster.aspx">User Master</a>
                                    <a href="CDMA_SubVerticalMaster.aspx">Sub Vertical Master</a>
                                    <a href="CDMA_Client_Master.aspx">Client Name Master</a>
                                    <a href="CDMA_Activity_Master.aspx">Activity Master</a>
                                    <a href="CDMA_Product_Master.aspx">Product Master</a>
                                    <a href="CDMA_SubProduct_Master.aspx">Sub Product Master</a>
                                </td>
                            </tr>
                            <tr id="Upload" runat="server" visible="false">
                                <td >
                                      <a href="CDMA_MIS_Upload.aspx">Upload MIS</a>
                                    <a href="CDMA_ManualUpdate.aspx">Core Manual Update</a>
                                </td>
                            </tr>
                        </table>
                    </div>
