...
{
    public partial class CDMA_Activity_Master : System.Web.UI.Page
    {
        ...
        public void BindActivity()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "CDMA_BindActivity_Master";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "CDMA_ActivityMasterSaveData_SP";
                cmd.Connection = sqlCon;
        ...
        protected void btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            hdnID.Value = gvActivity.DataKeys[gr.RowIndex]["ID"].ToString();

            Label lblActivity = (Label)gr.FindControl("lblActivity");
            txtActivity.Text = lblActivity.Text.Trim();
