<%@ Page Language="C#"  MasterPageFile="~/Pages/TCFSL_CDLOAN/sample.master" AutoEventWireup="true" CodeFile="IMPORT_MMDDYYYY.aspx.cs" Inherits="Pages_TCFSL_CDLOAN_IMPORT_MMDDYYYY" %>
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="ddlType" class="form-control" runat="server" 
                                    SkinID="ddlSkin" >
                                            ...
                                            <asp:ListItem Value="SFDC">SFDC(MM/DD/YYYY)</asp:ListItem>
