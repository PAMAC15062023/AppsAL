...
public partial class Pages_TCFSL_CDLOAN_IMPORT : System.Web.UI.Page
{
    ...
    protected void BindImportType()
    {
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            ddlType.DataValueField = "Code_Id";
    ...
    protected void Update_Into_TCFSL_CD_upload(DataRow dr)
    {
        ...
        try
        {
            ...
            sqlcmd.CommandText = "TCFSL_TCFSL_IMPORT_New_SP";//TCFSL_IMPORT
            ...
            if (dr["Case Number"].ToString() != "" && dr["Loan Application: Webtop Id"].ToString() != "" && dr["Status"].ToString() != "" && dr["Last Modified Date Time"].ToString() != "")
            {
                ...
                else
                {
                    ...
                    sqlCom.CommandText = "TCFSL_Check_Screen_SP";
