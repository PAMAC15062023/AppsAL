...
public partial class Pages_TCFSL_CDLOAN_IMPORT : System.Web.UI.Page
{
    ...
    protected void Update_Into_TCFSL_CD_upload(DataRow dr)
    {
        ...
        try
        {
            ...
            sqlcmd.CommandText = "IMPORTTCFSL_CDLOAN";//IMPORTTCFSL_CD1
            sqlcmd.CommandTimeout = 0;


            sqlcmd.Parameters.AddWithValue("@Store_Customer_Name", dr["SortLOAN APPLICATION"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Case_Number", dr["SortCASE NUMBER"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Webtop_Id", dr["SortWEBTOP #"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Stage", dr["SortAPPLICATION STAGE"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Customer_Name", dr["SortCUSTOMER NAME"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Status", dr["SortSTATUS"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@CDSubvention_Product_Category", dr["SortPRODUCT"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Finnone_Branch", dr["SortSALES USER BRANCH"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Requested_Loan_Amount", dr["SortNET FINANCED AMOUNT"].ToString().Trim());
            sqlcmd.Parameters.AddWithValue("@Last_Modified_Date", strDateFunc(dr["SortLAST MODIFIED DATESorted Ascending"].ToString().Trim()));
            sqlcmd.Parameters.AddWithValue("@Owner_FulLName", dr["SortOWNER NAME"].ToString().Trim());
