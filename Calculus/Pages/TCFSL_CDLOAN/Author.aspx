<%@ Page Language="C#" MasterPageFile="~/Pages/TCFSL_CDLOAN/sample.master" AutoEventWireup="true"
    CodeFile="Author.aspx.cs" Inherits="Pages_TCFSL_CDLOAN_Author" %>
            ...
            <div class="col-md-12">
                <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="hidWrapper">
                                                <div class="col-md-4">
                                                    ...
                                                    <asp:HiddenField ID="hdnChkAssign" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <div class="form-group">
                                        <asp:GridView ID="grdlos" runat="server" Style="background" class="table table-striped table-bordered table-hover table-responsive"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="LAN Agreement No">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtLanAgreementNo" runat="server" onkeyup="UpperLetter(this);" Height="30px"
                                                            SkinID="txtSkin" TextMode="MultiLine" Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-2">
                                <asp:Button ID="lnkCompleteNext" Visible="false" class="form-control btn-primary"
                                    runat="server" Text="CompleteNext" OnClick="lnkCompleteNext_Click" />
                            </div>
                            <div class="col-md-2">
                                <asp:Button ID="lnkCompleteExit" Visible="false" class="form-control btn-primary"
                                    runat="server" Text="CompleteExit" OnClick="lnkCompleteExit_Click" />
                            </div>
                            <div class="col-md-2">
