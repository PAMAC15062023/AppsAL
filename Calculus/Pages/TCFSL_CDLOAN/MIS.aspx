<%@ Page Language="C#" MasterPageFile="~/Pages/TCFSL_CDLOAN/sample.master" AutoEventWireup="true" CodeFile="MIS.aspx.cs" Inherits="Pages_TCFSL_CDLOAN_MIS" %>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-3 col-sm-3">
                    <asp:DropDownList ID="ddlMIS" runat="server" class="form-control " AutoPostBack="true">
                        <asp:ListItem Value="TCFSL_ENDToEND_MIS24Jun2019">Screening MIS</asp:ListItem>
                        <%-- TCFSL_ENDToEND_MIS10nov18--%>
                        <asp:ListItem Value="TCFSL_ENDToEND_MIS_pending_24Jun2019">Pending MIS</asp:ListItem>
                        <%-- TCFSL_ENDToEND_MIS12Jun2019_pending--%>
                        <%--<asp:ListItem Value="TCFSL_ENDToEND_MISAPP10nov181">Approved MIS</asp:ListItem>
                        --%>
                        <asp:ListItem Value="TCFSL_ENDToEND_MISAPP_24Jun2019">Author MIS</asp:ListItem>
                        <%-- TCFSL_ENDToEND_MISAPP_12Jun2019--%>


                        <asp:ListItem Value="TCFSL_ENDToEND_MISReject24Jun2019">Reject MIS</asp:ListItem>
                        <%-- TCFSL_ENDToEND_MISReject12Jun2019--%><%--TCFSL_ENDToEND_MISReject10nov18--%>
                        <asp:ListItem Value="TCFSL_ENDToEND_MIS12_pending24Jun2019">Pending For Finone MIS</asp:ListItem>
                        <%-- TCFSL_ENDToEND_MIS12_pending12Jun2019--%>
                        <asp:ListItem Value="TCFSL_ENDToEND_MIS12_hold24June2019">Hold MIS</asp:ListItem>
                        <%-- TCFSL_ENDToEND_MIS12_hold12Jun2019--%>
                        <asp:ListItem Value="END_TO_END_MIS_TCFSL_24Jun2019">End To End MIS</asp:ListItem>
                        <%-- END_TO_END_MIS_TCFSL12Jun2019--%>
                        <asp:ListItem Value="DAILY_MIS_TCFSL_24Jun2019">Daily MIS</asp:ListItem>
                        <%-- DAILY_MIS_TCFSL12_12Jun2019--%>
                        <asp:ListItem Value="TCFSL_ENDToEND_MISAPP_maker_24Jun2019">Maker MIS</asp:ListItem>
                        <%-- TCFSL_ENDToEND_MISAPP_12Jun2019_maker--%>
                        <asp:ListItem Value="TCFSL_DownTimeTrackerMIS_24Jun2019">Down Time Tracker</asp:ListItem>
                        <%--TCFSL_DownTimeTrackerMIS12Jun2019--%>
                        <asp:ListItem Value="TCFSL_TAT_MIS_03July2019">TAT MIS</asp:ListItem>
                        <%--TCFSL_TAT_MIS--%>
                    </asp:DropDownList>
                </div>
            </div>
