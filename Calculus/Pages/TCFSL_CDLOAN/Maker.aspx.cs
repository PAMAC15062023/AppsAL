...
public partial class Pages_TCFSL_CDLOAN_Maker : System.Web.UI.Page
{
    ...
    private void Sp_Assign_Maker()
    {
        ...
        try
        {
            ...
            sqlCom2.CommandText = "TCFSL_Sp_Assign_Maker_New1_SP";//Sp_Assign_maker,Sp_Assign_makernew
    ...
    private void Sp_Assign_QCToMKR()
    {
        ...
        try
        {
            ...
            sqlCom2.Connection = sqlCon;
            sqlCom2.CommandType = CommandType.StoredProcedure;
            sqlCom2.CommandText = "TCFSL_Assign_QCTOLSR_SP";
                ...
                if (chkSelect.Checked == true)
                {
                    ...
                    if (ddlstatus.SelectedIndex != 0)
                    {
                        ...
                        if (HdnWIPStatus.Value == "InProcess")
                        {
                            ...
                            sqlCom.Connection = sqlCon;
                            sqlCom.CommandType = CommandType.StoredProcedure;
                            sqlCom.CommandText = "TCFSL_MAKER_COMPLETE_SP";
                            sqlCom.CommandTimeout = 0;
    ...
    private void IfStuckOpen()
    {
        ...
        try
        {
            ...
            sqlCom.Connection = sqlCon;
            sqlCom.CommandType = CommandType.StoredProcedure;
            sqlCom.CommandText = "uspOpenMakerStuckCase";
