<%@ Page Language="C#" MasterPageFile="~/Pages/TCFSL_CDLOAN/sample.master" AutoEventWireup="true"
    CodeFile="SFDC_Screening.aspx.cs" Inherits="Pages_TCFSL_CDLOAN_SFDC_Screening" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <fieldset>
                    <legend class="showname">Screening Form</legend>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <asp:GridView ID="grdlos" runat="server" Style="background" class="table table-striped table-bordered table-hover table-responsive"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Case_Number" HeaderText="Case_Number" />
                                                <asp:BoundField DataField="Webtop_Id" HeaderText="Webtop_Id" />
                                                <asp:BoundField DataField="SCREEN_PRODUCT" HeaderText="ID" HeaderStyle-CssClass="Hide" ItemStyle-CssClass="Hide" />
                                                <asp:TemplateField HeaderText="Count Of Product">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtproductno" runat="server" MaxLength="1" autocomplete="off" onkeypress="return isNumberKey(event)"
                                                            Height="30px" Width="45px" SkinID="txtSkin" TextMode="SingleLine"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Status">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlstatus" runat="server" SkinID="ddlSkin" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged"
                                                            ...
                                                            <asp:ListItem Value="Approved">Pending For QC</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <%--<asp:TemplateField HeaderText="Add Product AppNo">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtproduct" runat="server" onkeyup="UpperLetter(this);" Height="30px"
                                                            Width="120px" SkinID="txtSkin" MaxLength="12"  Visible="false"></asp:TextBox>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <asp:GridView ID="grdPending" CssClass="table table-striped table-bordered table-responsive"
                                CaptionAlign="Top" Caption='<table border="1" width="100%" class="TestCssStyle" cellpadding="0" cellspacing="0" bgcolor="yellow";><tr><td>Pending For Finone</td></tr></table>' runat="server" AutoGenerateColumns="false">
                                <Columns>
                                    <asp:TemplateField>
                                        <%--<HeaderTemplate>
                                            <input id="chkSelectAll" type="checkbox" />
