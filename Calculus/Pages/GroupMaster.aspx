<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="GroupMaster.aspx.cs" Inherits="Pages_GroupMaster" Title="Untitled Page" %>
    ...
    <table border="0" cellpadding="2" cellspacing="2">
        ...
        <tr>
            <td class="TableHeader" colspan="5">
                &nbsp;User Group Master</td>
        </tr>
        <tr>
            <td class="TableTitle" style="width: 162px">
                &nbsp;Group Name</td>
            <td style="width: 100px">
                <asp:TextBox ID="txtGroupName" runat="server" ValidationGroup="BranchENtry" BorderWidth="1px"></asp:TextBox></td>
            <td style="width: 100px">
                </td>
            <td style="width: 100px">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:TextBox ID="txtGroupDescription" runat="server" BorderWidth="1px" ValidationGroup="BranchENtry"></asp:TextBox></td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            </td>
