...
public partial class Pages_Calculus_BranchUtilityPaymentRequest_View : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/pages/calculus/BranchUtilityPaymentRequest.aspx", true);
    }
    ...
    private void Get_TransactionList_For_Process()
    {
        ...
        sqlCom.CommandText = "CalOnlineTrans_GetRecordsForUtilityPaymentProcessViewNew_SP";
