<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewOpeningBalanceByBranch.aspx.cs"
    Inherits="Pages_Calculus_ViewOpeningBalanceByBranch" StylesheetTheme="SkinFile" %>
        ...
        <div>
            <table style="width: 611px">
                ...
                <tr>
                    ...
                    <td colspan="2" style="height: 20px" class="TableTitle">
                        &nbsp;Request Type</td>
                    <td style="height: 20px" class="TableGrid" colspan="3">
                        ...
                        <div style="border-right: darkgray thin solid; border-top: darkgray thin solid; overflow: scroll;
                            ...
                            <asp:GridView ID="grvTransactionInfo" runat="server" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TotalTransactionAmount" HeaderText="Total Transaction Amt" SortExpression="TotalTransactionAmount" />
                                    <asp:BoundField DataField="TotalAvailableAmount" HeaderText="Available Amt" SortExpression="TotalAvailableAmount" />
                                    <asp:BoundField DataField="ClosingAmount" HeaderText="Closing Amt" SortExpression="ClosingAmount" />
