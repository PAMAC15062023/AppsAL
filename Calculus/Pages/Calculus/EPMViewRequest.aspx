<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="EPMViewRequest.aspx.cs" Inherits="Pages_Calculus_EPMViewRequest"
    Title="EPMViewRequest" StylesheetTheme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        ...
        <tr>
            <td class="TableHeader" colspan="7" style="height: 22px">&nbsp;EPM Payment Request View</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="TableTitle">&nbsp;ServiceTaxReg.No</td>
            <td style="width: 100px" class="TableGrid">
                                        ...
                                        <td colspan="100%">
                                            <div id='div<%# Eval("AutoNo") %>' style="display: none; position: inherit; left: 15px; overflow: scroll;">
                                                <asp:GridView ID="grvDetails" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="Payee_Name" HeaderText="ClaimantName" />
                                                        <asp:BoundField DataField="BillNo" HeaderText="PCVNo" />
                                                        <asp:BoundField DataField="BillDate" DataFormatString="{0:MMM-dd-yyyy}" HeaderText="VoucherDate"
                                                            HtmlEncode="False" />
                                                        ...
                                                        <asp:BoundField DataField="Authorize_Remark" HeaderText="Authorize Remark" />
