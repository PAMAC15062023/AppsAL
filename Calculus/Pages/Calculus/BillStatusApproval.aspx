<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="BillStatusApproval.aspx.cs" Inherits="Pages_Calculus_BillStatusApproval"
    Title="Bill Status & Approval" StylesheetTheme="SkinFile" Theme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        ...
        <tr>
            <td class="TableHeader" colspan="7" style="height: 22px">&nbsp;Bill Status Confirmation
            </td>
        </tr>
        <tr>
            <td style="width: 9px"></td>
            <td class="TableTitle" style="width: 173px">&nbsp;TransactionID
            </td>
            <td class="TableGrid" style="width: 100px">
                <asp:TextBox ID="txtTransactionID" runat="server" BorderWidth="1px" SkinID="txtSkin"></asp:TextBox>
            </td>
            <td class="TableTitle" style="width: 141px">&nbsp;Total Amount
            </td>
            <td class="TableGrid" style="width: 100px">
                <asp:TextBox ID="txtTotalAmount" runat="server" BorderWidth="1px" SkinID="txtSkin" oninput="validateDecimal(this)"></asp:TextBox>
            </td>
        ...
        <tr>
            <td style="width: 9px"></td>
            <td class="TableTitle" style="width: 173px">&nbsp;Status :
            </td>
            <td class="TableGrid" style="width: 100px">
            ...
            <td class="TableTitle" style="width: 141px"></td>
        ...
        <tr>
            <td style="width: 9px"></td>
            <td class="TableTitle" style="width: 173px">&nbsp;Branch
            </td>
            <td class="TableGrid" style="width: 100px">
                <asp:DropDownList ID="ddlBranchList" runat="server" SkinID="ddlSkin">
                </asp:DropDownList>
            </td>
            <td class="TableTitle" style="width: 141px">&nbsp;Payee Name
            </td>
            <td class="TableGrid" style="width: 100px">
                <asp:TextBox ID="txtPayeeName" runat="server" BorderWidth="1px" SkinID="txtSkin"></asp:TextBox>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 98px; height: 20px">
                    <tr>
                        <td style="width: 100px; height: 20px">
                            <asp:TextBox ID="txtBillDate" runat="server" BorderWidth="1px" SkinID="txtSkin" Width="72px"></asp:TextBox>&nbsp;
                        </td>
                        <td style="width: 100px; height: 20px">
        ...
        <tr>
            <td style="width: 9px"></td>
            <td class="TableTitle" style="width: 173px">&nbsp;Payout Date
            </td>
            <td class="TableGrid" style="width: 100px">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 98px; height: 20px">
                    <tr>
            ...
            <td class="TableTitle" style="width: 141px">&nbsp;Bill No
            </td>
            <td class="TableGrid" style="width: 100px">
                <asp:TextBox ID="txtBillNo" runat="server" BorderWidth="1px" SkinID="txtSkin"></asp:TextBox>
            </td>
            <td class="TableTitle">&nbsp;Bill Amount
            </td>
            <td class="TableGrid" style="width: 100px">
                <asp:TextBox ID="txtBillAmount" runat="server" BorderWidth="1px" SkinID="txtSkin"
                    Width="92px" oninput="validateDecimal(this)"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 9px"></td>
            ...
            <td style="width: 100px">
                ...
                <asp:HiddenField ID="hdntxtServiceTaxAmt" runat="server" />
                <asp:HiddenField ID="hdntxtServiceTaxAmt1" runat="server" />
                <asp:HiddenField ID="hdnTaxType" runat="server" />
                <asp:HiddenField ID="hdnTaxPer" runat="server" />
                <asp:HiddenField ID="hdnTotalPayableAmt" runat="server" />
        ...
        <tr>
            <td class="TableTitle" colspan="7" style="height: 31px">&nbsp;<asp:Button ID="btnSearch" runat="server" BorderWidth="1px" Font-Bold="False"
                OnClick="btnSearch_Click" Text="Search" />&nbsp;<asp:Button ID="btnReset" runat="server"
                    BorderWidth="1px" Text="Reset" Width="54px" />&nbsp;
            </td>
        </tr>
        <tr>
            <td class="TableHeader" colspan="7" style="height: 16px">&nbsp;Payment Request Approved List
            </td>
        </tr>
        <tr>
            <td colspan="7">
                <div style="overflow: scroll; width: 854px; height: 200px">
                    <asp:GridView ID="grvTransactionInfo" runat="server" AutoGenerateColumns="False"
                        DataKeyNames="TransactionID" Font-Size="8pt" OnRowDataBound="grv_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="AccountLedger">
                                <ItemTemplate>
        ...
        <tr>
            <td class="TableGrid" colspan="7" style="height: 32px">
                <asp:Button ID="btnAddPayment" runat="server" BorderWidth="1px" Font-Bold="False"
                    OnClick="btnAddPayment_Click" Text="Approve Payment" Width="108px" />
                ...
                <asp:Button ID="btnCancel" runat="server" BorderWidth="1px" OnClick="btnCancel_Click"
                    Text="Cancel" />
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Pages/Calculus/updateTax.aspx">Update ST</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td style="width: 9px"></td>
