...
public partial class Pages_Calculus_EPMViewRequest : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/Pages/Calculus/EPMAddRequest.aspx", true);
    }
    ...
    private void Get_TransactionList_For_Process()
    {
        ...
        sqlCom.CommandText = "CalOnlineTrans_GetRecordsViewProcess_EPM__SP";
    ...
    {
        Response.Redirect("EPMAddRequest.aspx?Vw=1&TID="+hdnTransID.Value.Trim() , true);
    }
    ...
    {
        Response.Redirect("EPMAddRequest.aspx?TID=" + hdnTransID.Value.Trim(), true);
