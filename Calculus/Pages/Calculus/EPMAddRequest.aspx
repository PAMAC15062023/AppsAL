<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="EPMAddRequest.aspx.cs" Inherits="Pages_Calculus_EPMAddRequest"
    Title="EPM Add Request" StylesheetTheme="SkinFile" Theme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function TotalReqAmountCalculation() {
            ...
            for (i = 0; i <= MainTab.rows.length - 1; i++) {
                if (i != 0) {
                    TotalAmt = TotalAmt + parseFloat(MainTab.rows[i].cells[8].innerText);
                }
            }
        ...
        function ValidateGrid() {
            ...
            //            if (ddlServiceTax.selectedIndex != 4) {
            //                if (txtServiceTaxRegNo.value == '') {
            //                    ErrorMessage = "Please Enter Service Tax Reg.No...!";
            //                    ReturnValue = false;
            //                    txtServiceTaxRegNo.focus();
        ...
        function AddColumnToGrid() {
            ...
            if (ValidateGrid()) {
              ...
              var txtRemark = document.getElementById("<%=txtRemark.ClientID%>");
                ...
                var TotalPayableAmt = parseFloat(txtBillAmt.value); //+parseFloat(txtServiceTaxAmt.value);
                // strhdvValue = strhdvValue + ddlVerticalList.options[selectedIndex_Vertical].innerText + "|" + ddlActivityList.options[selectedIndex_Activity].innerText + "|" + ddlProductList.options[selectedIndex_Product].innerText + "|" + ddlVenderList.options[Index].innerText + "|" + txtBillNo.value + "|" + txtBillDate.value + "|" + txtBillAmt.value + "|" + ddlServiceTax.options[selectedIndex_ServiceTax].innerText+"|"+txtServiceTaxAmt.value+"|"+TotalPayableAmt+"|"+txtServiceTaxRegNo.value+"|"+ddlAccountHeadList.options[selectedIndex_AccountHeadList].innerText+"|"+txtMobile_TelNo.value+"|"+txtDuedate.value+"|"+txtDueAmount.value+"|"+txtPanCard.value+"|"+txtRemark.value+"|"+VenderID+"|"+ddlServiceTax.value+"|"+ddlAccountHeadList.value+"|"+ddlVerticalList.value+"|"+ddlActivityList.value+"|"+ddlProductList.value+"^";
                strhdvValue = strhdvValue + ddlVerticalList.options[selectedIndex_Vertical].innerText + "|" + ddlActivityList.options[selectedIndex_Activity].innerText + "|" + ddlProductList.options[selectedIndex_Product].innerText + "|" + ddlVenderList.options[Index].innerText + "|" + txtBillNo.value + "|" + txtBillDate.value + "|" + txtBillAmt.value + "|" + TotalPayableAmt + "|" + ddlAccountHeadList.options[selectedIndex_AccountHeadList].innerText + "|" + txtMobile_TelNo.value + "|" + txtDuedate.value + "|" + txtDueAmount.value + "|" + txtRemark.value + "|" + VenderID + "|" + ddlAccountHeadList.value + "|" + ddlVerticalList.value + "|" + ddlActivityList.value + "|" + ddlProductList.value + "^";
    ...
    <table style="width: 782px" border="0" cellpadding="1" cellspacing="2" class="Table">
        ...
        <tr>
            <td class=" TableHeader" colspan="10" style="height: 22px">&nbsp;EPM Payment Request
            </td>
        </tr>
        <tr>
                ...
                <table>
                    <tr>
                        ...
                        <td class="TableTitle" colspan="4" style="height: 20px">&nbsp;<strong>Transaction ID</strong> &nbsp;&nbsp; :
                            <asp:Label ID="lblTransactionID" runat="server" Font-Bold="True" Width="320px"></asp:Label></td>
                        <td class="TableTitle" colspan="4"
                            style="height: 20px; text-align: center; font-weight: 700;">&nbsp;HO Approved Budget Balance
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 6px; height: 20px;"></td>
                        <td class="TableTitle" style="height: 20px">&nbsp;Region/Cluster</td>
                        <td style="width: 142px; height: 20px;" class="TableGrid">
                            <asp:Label ID="lblRegionCluster" runat="server" SkinID="LabelSkin" Width="149px"></asp:Label></td>
                        <td class="TableTitle" style="width: 90px; height: 20px;">&nbsp;Centre</td>
                        <td style="width: 72px; height: 20px;" class="TableGrid">
                            <asp:Label ID="lblbranch" runat="server" SkinID="LabelSkin" Font-Bold="False" Width="130px"></asp:Label></td>
                        <td class="TableTitle" style="height: 20px">&nbsp;Opening Balance</td>
                    ...
                    <tr>
                        ...
                        <td class="TableTitle">&nbsp;<asp:Label ID="lblRequestDate" runat="server" Text="Request Date" Width="96px"></asp:Label></td>
                                ...
                                <tr>
                                    <td style="width: 100px; height: 20px;">
                                        <asp:TextBox ID="txtPaymentDate" runat="server" BorderWidth="1px" SkinID="txtSkin"
                                            Width="78px" ReadOnly="True"></asp:TextBox>&nbsp;</td>
                                    <td style="width: 95px; height: 20px;">
                                        <img id="Img1" alt="Calendar" src="../ChequeProcessing/SmallCalendar.png" style="width: 19px; height: 18px" /></td>
                                </tr>
                            </table>
                        </td>
                        <td class="TableTitle" style="width: 90px;">&nbsp;</td>
                        <td style="width: 72px;" class="TableGrid"></td>
                        <td class="TableTitle">&nbsp;Transaction During Month</td>
                        <td class="TableGrid" colspan="3">
                            <asp:Label ID="lblTransactionAmout" runat="server" SkinID="LabelSkin" Width="206px"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 6px;"></td>
                        <td class="TableTitle" colspan="4">&nbsp;&nbsp;<a href="javascript:openwindow();" title="View Opening Balance">View 
                            Opening Budget Balance</a></td>
                        <td class="TableTitle">&nbsp;<asp:Label ID="lbl" runat="server" Text="Available Amount" Width="117px"></asp:Label></td>
                        <td class="TableGrid">
                            <asp:Label ID="lblAvailableAmt" runat="server" SkinID="LabelSkin"></asp:Label></td>
                        <td class="TableTitle" colspan="1">&nbsp;YearMonth</td>
                        <td class="TableGrid">&nbsp;<asp:Label ID="lblYearMonth" runat="server" SkinID="LabelSkin"></asp:Label></td>
                    </tr>
                </table>
        ...
        <tr>
            <td class="TableHeader" colspan="10" style="height: 19px">&nbsp;Payment Request Details</td>
        </tr>
        <tr>
            <td style="width: 60px"></td>
            <td class="TableTitle" colspan="" style="text-align: left">&nbsp;Vertical</td>
            <td class="TableTitle" style="text-align: left">&nbsp; Activity</td>
            <td style="text-align: left;" class="TableTitle">Claimant Name</td>
            <td style="text-align: left;" class="TableTitle">&nbsp; &nbsp;PCV no</td>
            <td class="TableTitle">&nbsp;Voucher Date</td>
            <td style="width: 93px;" class="TableTitle">&nbsp;Bill Amount</td>
            <%--    <td style="width: 37px;" class="TableTitle">
                &nbsp;ST%&nbsp;</td>
            <td class="TableTitle">
                &nbsp;ST Amount</td>--%>
        </tr>
        <tr>
            <td style="width: 60px;"></td>
            <td class="TableGrid" colspan="">&nbsp;<asp:DropDownList ID="ddlVerticalList" runat="server" SkinID="ddlSkin" AutoPostBack="True"
                OnSelectedIndexChanged="ddlVerticalList_SelectedIndexChanged" AccessKey="N">
            </asp:DropDownList></td>
            <td class="TableGrid">&nbsp;
                    ...
                    <tr>
                        <td style="width: 100px; height: 21px;">
                            <asp:TextBox ID="txtPayeeNameSearch" runat="server" BorderWidth="1px" SkinID="txtSkin"
                                Width="98px" MaxLength="25"></asp:TextBox></td>
                        <td style="width: 100px; height: 21px;">
                            <asp:Button ID="btnSearch" runat="server" BorderWidth="1px" Height="19px" Text=">>"
                                Width="30px" Font-Bold="True" OnClick="btnSearch_Click" />&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="height: 20px">
                            <asp:DropDownList ID="ddlVenderList" runat="server" SkinID="ddlSkin" Font-Bold="False">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
            ...
            <td style="width: 93px;" class="TableGrid">
                <asp:TextBox ID="txtBillAmt" runat="server" BorderWidth="1px" SkinID="txtSkin" Width="72px"
                    MaxLength="15" oninput="validateDecimal(this)">0.00</asp:TextBox></td>
            <%-- <td style="width: 37px;" class="TableGrid">
                <asp:DropDownList ID="ddlServiceTax" runat="server" SkinID="ddlSkin" 
                   Visible="False">
                </asp:DropDownList></td>
            <td class="TableGrid">
                <asp:TextBox ID="txtServiceTaxAmt" runat="server" BorderWidth="1px" ReadOnly="True" Visible="False"
                    SkinID="txtSkin" Width="74px" MaxLength="15">0.00</asp:TextBox></td>--%>
        </tr>
        <tr>
            <td style="width: 60px"></td>
            <%-- <td class="TableTitle" colspan="2">
                &nbsp; ST Reg. No.</td>--%>
            <td class="TableTitle">&nbsp;DEPT</td>
            <td class="TableTitle">&nbsp;Account Head</td>
            <td class="TableTitle">&nbsp;MobileNo/TelNo</td>
            <td class="TableTitle">&nbsp;DueDate</td>
            <td class="TableTitle" style="width: 93px">&nbsp;Due Amount</td>
            <td class="TableTitle" style="width: 37px">&nbsp;<%--PanNo--%></td>
            <%--<td class="TableTitle">
                <br />
                <br />
                &nbsp;</td>
        ...
        <tr>
            ...
            <%--   <td class="TableGrid" colspan="2">
                <asp:TextBox ID="txtServiceTaxRegNo" runat="server" BorderWidth="1px" SkinID="txtSkin"
                    Width="82px" MaxLength="20" Visible="False" ></asp:TextBox></td>--%>
            <td class="TableGrid">
            ...
            <td class="TableGrid">
                <asp:TextBox ID="txtMobile_TelNo" runat="server" BorderWidth="1px" SkinID="txtSkin"
                    Width="82px" MaxLength="12"></asp:TextBox></td>
            <td class="TableGrid">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 98px; height: 20px">
                    <tr>
                        <td style="width: 100px; height: 20px;">
            ...
            <td class="TableGrid" style="width: 93px">
                <asp:TextBox ID="txtDueAmount" runat="server" BorderWidth="1px" SkinID="txtSkin"
                    Width="71px" oninput="validateDecimal(this)"></asp:TextBox></td>
            <td style="width: 37px;" class="TableGrid">
                <asp:TextBox ID="txtPanCard" runat="server" BorderWidth="1px" MaxLength="10" SkinID="txtSkin"
                    Width="72px" Visible="False"></asp:TextBox></td>
            <%--<td class="TableGrid">
                &nbsp;</td>
            <td class="TableGrid">
                &nbsp;</td>--%>
        ...
        <tr>
            <td style="width: 60px"></td>
            <td class="TableTitle" colspan="8">&nbsp;Remark</td>
        ...
        <tr>
            ...
            <td class="TableGrid" colspan="8">
                <asp:TextBox ID="txtRemark" runat="server" BorderWidth="1px" SkinID="txtSkin" Width="793px"
                    MaxLength="500" TextMode="MultiLine" Height="36px"></asp:TextBox></td>
            <td class="TableGrid">
                    ...
                    <tr>
                        <td style="width: 58px; height: 18px;">
                            <asp:Button ID="btnAddtoGrid" runat="server" BorderWidth="1px" CssClass="Button"
                                ...
                                AccessKey="A" /></td>
                        <td style="width: 100px; height: 18px;">&nbsp;<asp:Button ID="btnRemove" runat="server"
                            BorderWidth="1px" CssClass="Button"
                            Text="Remove" ToolTip="Remove Selected from grid" Width="60px"
                            AccessKey="R" OnClick="btnRemove_Click" /></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td class="TableHeader" colspan="10">&nbsp; Payment Request List</td>
        </tr>
        <tr>
            <td style="width: 60px; height: 12px"></td>
            <td colspan="9" style="height: 12px">
                <div style="overflow: auto; width: 944px; height: 160px; border-right: darkgray 1px solid; border-top: darkgray 1px solid; border-left: darkgray 1px solid; border-bottom: darkgray 1px solid;"
                    ...
                    <table id="MainTab" class="GridViewStyle">
                        <tr>
                            ...
                            <th class="TableGrid">Vertical</th>
                            <th class="TableGrid">Activity</th>
                            <th class="TableGrid">DEPT</th>
                            <th class="TableGrid">&nbsp;ClaimantName</th>
                            <th class="TableGrid">&nbsp;PCVNo</th>
                            <th class="TableGrid">&nbsp; VoucherDate</th>
                            <th class="TableGrid">&nbsp;BillAmount</th>
                            <%--<th class="TableGrid">
                                &nbsp;ST%</th>
                            <th class="TableGrid">
                                ST Amount</th>--%>
                            <th class="TableGrid">Bill Total Amt</th>
                            <%--<th class="TableGrid">
                                ST Reg. No</th>--%>
                            <th class="TableGrid">&nbsp;AccountHead</th>
                            <th class="TableGrid">MobileNo /TelNo</th>
                            <th class="TableGrid">Due Date</th>
                            <th class="TableGrid">Due Amt</th>
                            <%-- <th class="TableGrid">
                                Pan No</th>--%>
                            <th class="TableGrid">Remark</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
        ...
        <tr>
            <td class="TableTitle" colspan="10">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        <td class="TableTitle">&nbsp;<strong>Attach Support Document</strong></td>
                        <td class="TableGrid">
                            <asp:FileUpload ID="FileUpload1" runat="server" BorderWidth="1px" Width="307px" Font-Bold="False"
                                Height="23px" AccessKey="B" /></td>
                        <td style="width: 100px"></td>
                        <td style="width: 100px"></td>
                        <td style="width: 100px; text-align: right" class="TableTitle">Total:
                        </td>
                        <td class="TableGrid" style="width: 100px">
                            <asp:Label ID="lblTotalRequestedAmount" runat="server" Width="12px" Font-Bold="True"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="TableTitle" style="height: 18px">&nbsp;<strong>Uploaded Document</strong></td>
                        <td class="TableGrid" style="height: 18px">
                            <asp:Label ID="lblAttachDocumentName" runat="server"></asp:Label></td>
        ...
        <tr>
            <td class="TableTitle" colspan="10" style="height: 17px">&nbsp;
                ...
                <asp:Button ID="btnAdd" runat="server" BorderWidth="1px" Text="Add New Transaction"
                    Width="145px" OnClick="btnAdd_Click" />&nbsp;<asp:Button ID="btnCancel" runat="server"
                        BorderWidth="1px" Text="Cancel" Width="69px" OnClick="btnCancel_Click" AccessKey="C" /></td>
        </tr>
        <tr>
            <td style="width: 60px"></td>
            <td></td>
