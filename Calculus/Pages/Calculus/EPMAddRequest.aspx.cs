...
public partial class Pages_Calculus_EPMAddRequest : System.Web.UI.Page
{
    ...
    private void Get_PayeeMasterList_BranchWise(string pPayeeName)
    {
        try
        {
            ...
            sqlCom.Connection = sqlCon;
            sqlCom.CommandType = CommandType.StoredProcedure;
            sqlCom.CommandText = "CalOnlineTrans_GetPayeeMasterList____SP";
    ...
    private void Insert_PaymentRequest()
    {
        try
        {
            ...
            sqlCom.Connection = sqlCon;
            sqlCom.CommandType = CommandType.StoredProcedure;
            sqlCom.CommandText = "CalOnlineTrans_Insert_TransactionInfo____SP";
    ...
    try
        {
            ...
            RequestType.Value = Convert.ToInt32(4);//pBranchId;
