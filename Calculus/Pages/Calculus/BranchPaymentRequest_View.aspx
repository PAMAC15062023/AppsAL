<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="BranchPaymentRequest_View.aspx.cs" Inherits="Pages_Calculus_BranchPaymentRequest_View"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        ...
        <tr>
            <td class="TableHeader" colspan="7" style="height: 22px">&nbsp;Branch Payment Request View</td>
        </tr>
        <tr>
