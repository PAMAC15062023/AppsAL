<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDS_PayReport.aspx.cs" Inherits="TDS_PayReport" StylesheetTheme="SkinFile" %>
        ...
        <tr>
            <td style="height: 30px;" class="TableTitle" colspan="7">
                ...
                <asp:Button ID="BtnGenerate" runat="server" AccessKey="G" BorderWidth="1px" OnClick="BtnGenerate_Click"
                    Text="Generate" ValidationGroup="ValGenReport" />&nbsp;<asp:Button ID="btnReset"
                        runat="server" AccessKey="R" BorderWidth="1px" Text="Reset" Width="70px" /></td>
        </tr>
        <tr>
            <td colspan="7">
