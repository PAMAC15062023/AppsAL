...
public partial class TDS_PayReport : System.Web.UI.Page
{
    ...
    private void Get_ChequeTrackerData()
    {
        ...
        sqlcmd.Connection = sqlcon;
        sqlcmd.CommandType = CommandType.StoredProcedure;
        sqlcmd.CommandText = "CalOnlineTrans_GetTDSReportNew_SP";
        SqlDataAdapter sqlda = new SqlDataAdapter();
        sqlda.SelectCommand = sqlcmd;
    ...
    {
        String attachment = "attachment; filename=TDS_Report.xls";
        ...
        tblCell1.Text = "<b><font size='4'>PAMAC FINSERVE PVT. LTD., MUMBAI</font></b> <br/>" +
                        "<b><font size='2' color='blue'>TDS Report ,Payment for Date : " + txtFromDate.Text + " To : " + txtFromDate.Text + " </font></b> <br/>";
