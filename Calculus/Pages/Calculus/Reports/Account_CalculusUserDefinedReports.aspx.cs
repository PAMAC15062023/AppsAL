...
using System.IO;
public partial class Pages_Calculus_Reports_Account_CalculusUserDefinedReports : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (((UserInfo.structUSERInfo)(SaveUSERInfo)).GroupName.Contains("Admin") || ((UserInfo.structUSERInfo)(SaveUSERInfo)).GroupName.Contains("FTS_Supervisor") || ((UserInfo.structUSERInfo)(SaveUSERInfo)).GroupName.Contains("Cal_Online_Trans"))
            {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //}
        //else if (ddlReportList.SelectedIndex == 2)
        //{
        //    Get_OtherThanPettyCashReport_VendorPaymentSingle();
        //}
        //else
        //{
    ...
    private void Get_OtherThanPettyCashReport_VendorPayment()
    {
        ...
        sqlcmd.Connection = sqlcon;
        sqlcmd.CommandType = CommandType.StoredProcedure;
        sqlcmd.CommandText = "CalOnlineTrans_GetVendorPaymentReportBranchWiseNew123_SP";
		sqlcmd.CommandTimeout = 10675199;
        SqlDataAdapter sqlda = new SqlDataAdapter();
        sqlda.SelectCommand = sqlcmd;
    ...
    private void Get_OtherThanPettyCashReport_VendorPaymentSingle()
    {
        Object SaveUSERInfo = (Object)Session["UserInfo"];
        ...
        sqlcmd.Connection = sqlcon;
        sqlcmd.CommandType = CommandType.StoredProcedure;
        sqlcmd.CommandText = "CalOnlineTrans_GetVendorPaymentReportSingleTrack_SP";
		sqlcmd.CommandTimeout = 10675199;
        SqlDataAdapter sqlda = new SqlDataAdapter();
        sqlda.SelectCommand = sqlcmd;
