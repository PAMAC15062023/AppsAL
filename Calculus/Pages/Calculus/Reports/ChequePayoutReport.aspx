<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="ChequePayoutReport.aspx.cs" Inherits="Pages_Calculus_Reports_ChequePayoutReport" StylesheetTheme="SkinFile" %>
    ...
    <table>
        ...
        <tr>
            <td colspan="7" class="TableHeader">
                &nbsp;Cheque Request Tracker -<asp:Label ID="lblReportType" runat="server"></asp:Label></td>
        </tr>
        <tr>
            ...
            <td style="height: 30px;" class="TableTitle" colspan="7">
                ...
                <asp:Button ID="BtnGenerate" runat="server" AccessKey="G" BorderWidth="1px" OnClick="BtnGenerate_Click"
                    Text="Generate" ValidationGroup="ValGenReport" />&nbsp;<asp:Button ID="btnReset" runat="server" AccessKey="R" BorderWidth="1px"
                        Text="Reset" Width="70px" />&nbsp;<asp:Button ID="Button1" 
                    runat="server" OnClick="Button1_Click" Text="Report  Request date" />
            </td>
        </tr>
        <tr>
            <td colspan="7">
