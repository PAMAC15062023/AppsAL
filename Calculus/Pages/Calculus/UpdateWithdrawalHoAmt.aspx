<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="UpdateWithdrawalHoAmt.aspx.cs" Inherits="Pages_UpdateWithdrawalHoAmt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 858px; height: 59px">
        <tr>
            <td class="TableHeader" colspan="4" style="height: 24px">&nbsp;Update Withdrawal HO Amount
            </td>
        </tr>
        <tr>
                ...
                <asp:GridView ID="Gr_Ope_Bal" runat="server" AutoGenerateColumns="False" Height="131px"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblOpeningBalanceID" runat="server" Text='<%#Eval("openingBalanceID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <%--<asp:BoundField DataField="openingBalanceYear" HeaderText="Year" ReadOnly="true" />--%>
                        <asp:TemplateField HeaderText="Year">
                            <ItemTemplate>
                                <asp:Label ID="lblYear" runat="server" Text='<%#Eval("openingBalanceYear") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlYearUpdate" runat="server" Width="109px" Height="28px">
                                    <asp:ListItem>-Select-</asp:ListItem>
                                    <asp:ListItem Value="2018">2018</asp:ListItem>
                                    <asp:ListItem Value="2019">2019</asp:ListItem>
                                    <asp:ListItem Value="2020">2020</asp:ListItem>
                        ...
                        <%-- <asp:BoundField DataField="openingBalanceMonth" HeaderText="Month" ReadOnly="true" />--%>
                        <asp:TemplateField HeaderText="Month">
                            <ItemTemplate>
                                <asp:Label ID="lblMonth" runat="server" Text='<%#Eval("openingBalanceMonth") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlMonthUpdate" runat="server" Width="109px" Height="28px">
                                    <asp:ListItem>-Select-</asp:ListItem>
                                    <asp:ListItem Value="01">January</asp:ListItem>
                                    <asp:ListItem Value="02">February</asp:ListItem>
                                    <asp:ListItem Value="03">March</asp:ListItem>
                        ...
                        <asp:TemplateField HeaderText="Amount">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtBalanceAmount" runat="server" Text='<%#Eval("BalanceAmount") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Updated Remark">
                            <ItemTemplate>
                                <asp:Label ID="lblRemark" runat="server" Text='<%#Eval("UpdatedRemark") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtRemark" runat="server" Text='<%#Eval("UpdatedRemark") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
