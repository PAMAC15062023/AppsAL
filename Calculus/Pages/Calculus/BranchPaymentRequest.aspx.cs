...
public partial class Pages_Calculus_BranchPaymentRequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            TransR1.Visible = false;
            TransR2.Visible = false;
            TransRefNoDDL.Visible = false;

            EmployeeCode.Visible = false; //add on 04/03/2024
            txtEmpCode.Visible = false; //add on 04/03/2024
        }
        ...
        try
        {
            if ((ddlVenderList.SelectedValue.ToString() != "") && (ddlVenderList.SelectedValue.ToString() != "--Select--"))
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //add by Rutu on 22/11/23 >>
                    if (txtServiceTaxRegNo.Text == "")
                    {
                        txtServiceTaxRegNo.Text = "0";
                    }
    ...
    private void Get_ServiceTaxList12()
    {
        try
        {
            ...
            sqlCom.Connection = sqlCon;
            sqlCom.CommandType = CommandType.StoredProcedure;
            sqlCom.CommandText = "CalOnlineTrans_GetServiceTaxList17102020_SP";//Get_ServiceTaxList03jul2017
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //int PayeeID = Convert.ToInt16(strlist[21]); 
            int PayeeID = Convert.ToInt32(strlist[23]); //add by Rutu on 20/11/23
    ...
    private void Insert_PaymentRequest()
    {
        try
        {
            ...
            sqlCom.Connection = sqlCon;
            sqlCom.CommandType = CommandType.StoredProcedure;
            sqlCom.CommandText = "CalOnlineTrans_InsertTransactionInfoNew_SP"; //Insert_TransactionInfo_new_23Apr12
    ...
    private void Get_AccountHeadList()
    {
        ...
        sqlCom.Connection = sqlCon;
        sqlCom.CommandType = CommandType.StoredProcedure;
        sqlCom.CommandText = "CalOnlineTrans_GetAccountHeadList_New__SP";//addedPrachi
    ...
    public void GetTransRefNo()
    {
        try
        {
            Object SaveUSERInfo = (Object)Session["UserInfo"];

            int BranchId = (Convert.ToInt32(((UserInfo.structUSERInfo)(SaveUSERInfo)).BranchId));
            ...
            TransRefNoDDL.DataTextField = "TransRefNo";
            TransRefNoDDL.DataValueField = "TransRefNo";
            TransRefNoDDL.DataSource = dt;
            TransRefNoDDL.DataBind();

            TransRefNoDDL.Items.Insert(0, "--Select--");
            TransRefNoDDL.SelectedIndex = 0;
        }
        catch (Exception ex)
        {
    ...
    protected void TransRefNoDDL_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (txtEmpCode.Text != "") //add on 04/03/2024
        {
            if (TransRefNoDDL.SelectedIndex != 0)
            {
                string strTransRefNo = TransRefNoDDL.SelectedItem.Value;
    ...
    protected void ddlAccountHeadList_SelectedIndexChanged(object sender, EventArgs e)
    {


        if (ddlAccountHeadList.SelectedValue == "21")//"Repairs & Maintenance")
        {
            TransR1.Visible = true;
            TransR2.Visible = true;
            TransRefNoDDL.Visible = true;
            //GetTransRefNo();

            EmployeeCode.Visible = true; //add on 04/03/2024
            txtEmpCode.Visible = true;   //add on 04/03/2024
        }
        else
        {
            TransR1.Visible = false;
    ...
    protected void txtEmpCode_TextChanged(object sender, EventArgs e) //add on 04/03/2024
    {
