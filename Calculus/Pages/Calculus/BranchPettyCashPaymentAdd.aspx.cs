...
public partial class BranchPettyCashPaymentAdd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
                ...
                { 
                    Get_BankInfo();
                    lblTransctionID.Text = arrPARAM[0].ToString(); // Request.QueryString["TID"].ToString(); //Request.QueryString["TID"].Trim();
    ...
    private void Get_TransactionDetails(string pTransactionID)
    {
        try
        {
            ...
            sqlCom.CommandText = "Get_PaymentRequestDetails_For_MakePayment";
    ...
    private void Insert_PaymentInfo(string pPaymentID)
    {
        try
        {
            ...
            sqlCom.Connection = sqlCon;
            sqlCom.CommandType = CommandType.StoredProcedure;
            sqlCom.CommandText = "Insert_PaymentInfo";
