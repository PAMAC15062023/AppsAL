<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="ALL_BranchPaymentRequest.aspx.cs" Inherits="Pages_Calculus_ALL_BranchPaymentRequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Auto_Remark() {
            ...
            if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Advertisement Expenses') {
                strRemark = strRemark + "Advertisement Exps for ____ for the Period _____ agst bill no: " + txtBillNo.value + "for Activity (" + ddlActivityList.options[Index_Activity].innerText + ") for Branch (" + lblbranch.innerText + "), Cluster (" + lblRegionCluster.innerText + ")";
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Internet Expenses') {
                strRemark = strRemark + "Internet Charges of (office) for the (period) for (" + ddlActivityList.options[Index_Activity].innerText + ")(" + lblbranch.innerText + ")(" + lblRegionCluster.innerText + ".)";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Gratuity') {
                strRemark = strRemark + "Being amount paid towards Gratuity to (name) of (" + ddlActivityList.options[Index_Activity].innerText + ") for(" + lblbranch.innerText + ") (" + lblRegionCluster.innerText + ".)";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Mobile Charges') {
                strRemark = strRemark + "Mobile Charges Reimbursed to ____ for Ph no:" + txtMobile_TelNo.value + " for the period  ____ for activity (" + ddlActivityList.options[Index_Activity].innerText + ") for Branch (" + lblbranch.innerText + " ), Cluster (" + lblRegionCluster.innerText + ")";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Petty Cash') {
                strRemark = strRemark + "Being Petty cash Trf to (" + lblbranch.innerText + "), (" + lblRegionCluster.innerText + ")";
                txtRemark.innerText = strRemark;
            }
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Printing and Stationery') {
                strRemark = strRemark + "Printing Stationery Charges for the (Period) for (" + ddlActivityList.options[Index_Activity].innerText + ") for(" + lblbranch.innerText + "), (" + lblRegionCluster.innerText + ").";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Professional Fees') {
                strRemark = strRemark + "Professional Fees to (name) for the month of (Period) for( " + lblbranch.innerText + " ), ( " + lblRegionCluster.innerText + " )";
                txtRemark.innerText = strRemark;
            }
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Reimbursement') {
                strRemark = strRemark + "Being amount paid towards Reimbursement Exps of (Name) for the month of (Period) (" + ddlActivityList.options[Index_Activity].innerText + "), ( " + lblRegionCluster.innerText + " )";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Repairs & Maintenance') {
                strRemark = strRemark + "Repairs & Maintenance Exps of (location) agst (" + txtBillNo.value + ") for ( " + ddlActivityList.options[Index_Activity].innerText + " ) for( " + lblbranch.innerText + " ), ( " + lblRegionCluster.innerText + " ).";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Telephone Expenses') {
                strRemark = strRemark + "Telephone expenses of (Ph.no." + txtMobile_TelNo.value + "), for the (period ) for(" + ddlActivityList.options[Index_Activity].innerText + " ), for ( " + lblbranch.innerText + " ), ( " + lblRegionCluster.innerText + " )";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Xerox Charges') {
                strRemark = strRemark + "Xerox Charges for the Period ____ for Activity (" + ddlActivityList.options[Index_Activity].innerText + " ) for Branch ( " + lblbranch.innerText + " ), Cluster ( " + lblRegionCluster.innerText + " ).";
                txtRemark.innerText = strRemark;
            }

            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Legal Exps') {
                strRemark = strRemark + "Legal Exps(Purpose) for( " + ddlActivityList.options[Index_Activity].innerText + " ) for( " + lblbranch.innerText + " ), ( " + lblRegionCluster.innerText + " ).";
                txtRemark.innerText = strRemark;
            }
            ...
            else if (ddlAccountHeadList.options[Index_AccHead].innerText == 'Fuel Cost') {
                strRemark = strRemark + "Generator Fuel Cost for (office) for (period)(Location), for(" + ddlActivityList.options[Index_Activity].innerText + ") for( " + lblbranch.innerText + " ), ( " + lblRegionCluster.innerText + " ).";
                txtRemark.innerText = strRemark;
            }
        ...
        function ValidateGrid()// add by:Manswini 08-Nov-2014
        {
            ...
            //            }
            //           else if (ddlServiceTax.selectedIndex != 4 ) {
            ...
            //            else if (ddlTaxtype.selectedIndex == 2)  {
            //                ddlProductList.focus(); //add
            //                if (txtServiceTaxRegNo.value == '') {
            //                    ErrorMessage = "Please Enter Service Tax Reg.No...!";
            //                    ReturnValue = false;
            //                    txtServiceTaxRegNo.focus();
            //                }
            //            }
            //           else if (ddlTaxtype.selectedIndex == 1)  {
            //                ddlProductList.focus(); //add
            //                if (txtServiceTaxRegNo.value == '') {
            //                    ErrorMessage = "Please Enter Service Tax Reg.No...!";
            //                    ReturnValue = false;
        ...
        function AddColumnToGrid() {
            ...
            if (ValidateGrid()) {
                ...
                if (ddladjusttype.value == '2') {
                    var TotalPayableAmt = parseFloat(parseFloat(txtBillAmt.value).toFixed(2)) + parseFloat(parseFloat(txtServiceTaxAmt.value).toFixed(2)) + parseFloat(parseFloat(txtServiceTaxAmt1.value).toFixed(2)) + parseFloat(parseFloat(txtDueAmount.value).toFixed(2));
                    //                    alert(TotalPayableAmt);
                    TotalPayableAmt = parseFloat(TotalPayableAmt.toFixed(2));
                }
                else if (ddladjusttype.value == '4') {
                    var TotalPayableAmt = parseFloat(parseFloat(txtBillAmt.value).toFixed(2)) + parseFloat(parseFloat(txtServiceTaxAmt.value).toFixed(2)) + parseFloat(parseFloat(txtServiceTaxAmt1.value).toFixed(2));
                    //                    alert(TotalPayableAmt);
                    TotalPayableAmt = parseFloat(TotalPayableAmt.toFixed(2));
                }
                else {
    ...
    <table style="width: 782px" border="0" cellpadding="1" cellspacing="2" class="Table">
        ...
        <tr>
            <td class=" TableHeader" colspan="11" style="height: 22px">&nbsp;Branch Payment Request All Branch (Vendor)
            </td>
        </tr>
        <tr>
            ...
            <td colspan="10" style="height: 2px">
                <table>
                    ...
                    <tr>
                        ...
                        <asp:Label ID="lblSelBrnch"
                            runat="server" Text="Select Branch" Width="96px" Font-Bold="true"></asp:Label>
                        </td>
                        <td style="width: 72px;" class="TableGrid">
                            <asp:DropDownList ID="ddlBranchList" runat="server" SkinID="ddlSkin"
                                OnSelectedIndexChanged="ddlBranchList_SelectedIndexChanged"
                                AutoPostBack="true" Height="16px" Width="101px">
                            </asp:DropDownList>
                        </td>
        ...
        <tr>
            ...
            <td class="TableGrid">
                <asp:TextBox ID="txtServiceTaxAmt" runat="server" BorderWidth="1px" ReadOnly="True"
                    SkinID="txtSkin" Width="74px" MaxLength="15">0.00</asp:TextBox>&nbsp; <strong>+</strong><br />
                &nbsp;<asp:TextBox ID="txtServiceTaxAmt1" runat="server" BorderWidth="1px" ReadOnly="True"
        ...
        <tr>
            ...
            <td class="TableGrid" style="width: 93px">
                ...
                <%--OnSelectedIndexChanged="ddladjusttype_SelectedIndexChanged" AutoPostBack="true"--%>
            </td>
            <td class="TableGrid" style="width: 93px">
