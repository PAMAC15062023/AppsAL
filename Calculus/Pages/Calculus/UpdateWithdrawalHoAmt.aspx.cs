...
public partial class Pages_UpdateWithdrawalHoAmt : System.Web.UI.Page
{
    ...
    {
        if (Convert.ToInt32(txtAmount.Text, 10) % 100 == 0)
        {
    ...
    protected void Insert_OpeningBalanceData()
    {
        try
        {
            ...
            sqlCmd.Connection = sqlCon;
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandText = "Insert_WithdrawalHOAmount";//CalOnlineTrans_Show_Withdrawal_HO_Amount1_SP
    ...
    protected void Gr_Ope_Bal_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        Label id = Gr_Ope_Bal.Rows[e.RowIndex].FindControl("lblOpeningBalanceID") as Label;
        TextBox txtBalanceAmount = Gr_Ope_Bal.Rows[e.RowIndex].FindControl("txtBalanceAmount") as TextBox;
        TextBox txtRemark = Gr_Ope_Bal.Rows[e.RowIndex].FindControl("txtRemark") as TextBox;
        TextBox txtDate = Gr_Ope_Bal.Rows[e.RowIndex].FindControl("txtDate") as TextBox;
        DropDownList ddlYearUpdate = Gr_Ope_Bal.Rows[e.RowIndex].FindControl("ddlYearUpdate") as DropDownList;
        DropDownList ddlMonthUpdate = Gr_Ope_Bal.Rows[e.RowIndex].FindControl("ddlMonthUpdate") as DropDownList;
        Object SaveUSERInfo = (Object)Session["UserInfo"];
        ...
        sqlCmd.Connection = sqlCon;
        sqlCmd.CommandType = CommandType.StoredProcedure;
        sqlCmd.CommandText = "CalOnlineTrans__UpdateHOWidrawalAmount__SP";

        SqlParameter OpeningBalanceId = new SqlParameter();
        OpeningBalanceId.SqlDbType = SqlDbType.VarChar;
        OpeningBalanceId.Value = id.Text;
        OpeningBalanceId.ParameterName = "@openingBalanceID";
        sqlCmd.Parameters.Add(OpeningBalanceId);
        ...
        BalanceAmount.SqlDbType = SqlDbType.VarChar;
        BalanceAmount.Value = txtBalanceAmount.Text;
        BalanceAmount.ParameterName = "@BalanceAmount";
        sqlCmd.Parameters.Add(BalanceAmount);

        SqlParameter UpdatedRemark = new SqlParameter();
        UpdatedRemark.SqlDbType = SqlDbType.VarChar;
        UpdatedRemark.Value = txtRemark.Text;
        UpdatedRemark.ParameterName = "@UpdatedRemark";
        sqlCmd.Parameters.Add(UpdatedRemark);
        ...
        string Month = ddlMonthUpdate.SelectedItem.Value.ToString().Trim();
        string Year = ddlYearUpdate.SelectedItem.Value.ToString().Trim();
        string strYrMonth = Year + Month; //Get_DateFormat(txtWithdrawDate.Text, "yyyyMMdd");
        string test = strYrMonth.Substring(0, 6);
