<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="BranchUtilityPaymentRequest.aspx.cs" Inherits="Pages_Calculus_BranchUtilityPaymentRequest"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateGrid() {
            ...
            if (ddlVenderList.selectedIndex == 0) {
                ...
                ErrorMessage = "Please select GST% to continue...!";
                ReturnValue = false;
                ddlServiceTax.focus();
            }
    ...
    <table style="width: 782px" border="0" cellpadding="1" cellspacing="2" class="Table">
        ...
        <tr>
            <td class=" TableHeader" colspan="11" style="height: 22px">&nbsp;Branch Payment Request (Utility)
            </td>
        </tr>
        <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 5px">
                    ...
                    <tr>
                        <td colspan="2" style="height: 20px">
                            <asp:DropDownList ID="ddlVenderList" runat="server" OnSelectedIndexChanged="ddlVenderList_SelectedIndexChanged" AutoPostBack="true" SkinID="ddlSkin" Font-Bold="False">
                            </asp:DropDownList>
                            <%--OnSelectedIndexChanged="ddlVenderList_SelectedIndexChanged" AutoPostBack="true"--%>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td class="TableGrid" style="width: 93px">
                ...
                <asp:TextBox ID="txtDueAmount" runat="server" ToolTip="Kindly Enter Adjustment amount only" BorderWidth="1px" SkinID="txtSkin"
                    Width="71px" oninput="validateDecimal(this)"></asp:TextBox>
            </td>
            <td style="width: 37px;" class="TableGrid">
