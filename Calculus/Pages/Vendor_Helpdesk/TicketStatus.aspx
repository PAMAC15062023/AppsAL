...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="TableTitle" style="width: 191px; height: 23px;">
                &nbsp;Department</td>
            <td class="TableGrid" style="width: 39px; height: 23px;">
                <asp:Label ID="lblDepartment" runat="server" SkinID="LabelSkin" Width="147px"></asp:Label></td>

                <%--Changed by sanket--%>
            <td class="TableTitle" style="height: 23px">&nbsp;Vender Name</td>
            <td class="TableGrid"</td style="height: 23px">
...
--%>            
                <asp:Label ID="Label1" runat="server" Text="[lblVenderName]"></asp:Label>
        ...
        <tr>
            ...
            <td class="TableTitle" style="width: 191px; height: 23px;">
                &nbsp;Vender Provider&nbsp;</td>
            <td class="TableGrid" style="width: 39px; height: 23px;">
                <asp:Label ID="Label2" runat="server" Text="[lblvenderProv]"></asp:Label>
            </td>

            <td class="TableTitle" style="height: 23px">&nbsp;Vender Services&nbsp;</td>
            <td class="TableGrid"</td style="height: 23px">

                <asp:Label ID="Label3" runat="server" Text="[lblvenderServices]"></asp:Label>
            <td style="width: 112px; height: 23px;">
                &nbsp;</td>
            <td style="width: 100px; height: 23px;">
                &nbsp;</td>
...
<%--changed by sanket--%>
   ...
   <%--changes end by sanket--%>
        ...
        <tr>
            ...
            <td class="TableTitle" style="width: 191px; height: 28px">
                &nbsp;Ticket Status</td>
            <td class="TableGrid" style="height: 28px" colspan="3">
