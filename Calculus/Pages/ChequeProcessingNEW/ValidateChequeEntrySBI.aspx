<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
 CodeFile="ValidateChequeEntrySBI.aspx.cs" Inherits="Pages_ChequeProcessingNEW_ValidateChequeEntrySBI"
 Title="Validate Cheque Entry SBI " StylesheetTheme="SkinFile" Theme="SkinFile" %>
...
//                    txtMICRCode.focus();
        ...
        function ChequeDate_Validate() {
            ...
            if (strChequeDate.length == 0) {
                ...
                if (diff <= -1 && diff > -30) {
                    ...
                    hdnChequeStaus.value = '1';
                    ddlReasonList.selectedIndex = 14;
                    ddlReasonList.disabled = true;
                }
                else 
                       if (diff <= -90) {
                        //                            ErrorMessage="Post Dated Cheque!";
                        alert("Cheque Date is more than 90 days");
                        hdnChequeStaus.value = '1';
                        ddlReasonList.selectedIndex = 4;
                        ddlReasonList.disabled = true;
        ...
        function Validate_ChequeStatus(ArrayNo, value) {
            ...
            if (hdnChequeStaus.value == '0') {
                ...
                if (ddlReasonList.selectedIndex == 14 || ddlReasonList.selectedIndex == 6 || ddlReasonList.selectedIndex == 11 || ddlReasonList.selectedIndex == 4) {
