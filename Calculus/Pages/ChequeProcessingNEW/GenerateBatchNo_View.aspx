<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="GenerateBatchNo_View.aspx.cs" Inherits="Pages_ChequeProcessingNEW_GenerateBatchNo_View" Title="BatchFileView" StylesheetTheme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 851px">
        ...
        <tr>
            <td class="TableHeader" colspan="7" style="height: 22px">&nbsp;Batch File Search</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="height: 10px;" class="TableHeader" colspan="7">&nbsp;&nbsp; Batch File View</td>
        </tr>
        <tr>
            <td colspan="7">
        ...
        <tr>
            <td style="height: 30px;" class="TableTitle" colspan="7">&nbsp;<asp:Button ID="btnView" runat="server" BorderWidth="1px" Text="View" Width="65px" OnClick="btnView_Click" />
                <asp:Button ID="btnModify" runat="server" BorderWidth="1px"
                    OnClick="btnModify_Click" Text="Modify" Width="65px" />
                <asp:Button ID="btnChequeEntry" runat="server" BorderWidth="1px" Text="Cheuqe Capture" Width="112px" OnClick="btnChequeEntry_Click" />
                <asp:Button ID="btnOtherBank" runat="server" BorderWidth="1px" Text="Other" Width="69px" OnClick="btnOtherBank_Click" />
                <asp:Button ID="btnUpCountry" runat="server" BorderWidth="1px" Text="UpCountry" Width="81px" OnClick="btnUpCountry_Click" ToolTip="UpCountry Entry" />
