...
public partial class _Default : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                imgScan.ImageUrl = "~\\Pages\\images\\images.jpeg";
                get_NanoModelList();
                Get_BranchList();    
            }
            Add_javascript();
    ...
    private void Add_javascript()
    {
        try
        {
            ...
            ddlApplicant_CategoryList.Attributes.Add("onchange", "javascript:HideControl('"+ddlApplicant_CategoryList.ClientID+"','"+txtApplicantCategory.ClientID+"','Other');");
            ddlPhotoIdProff.Attributes.Add("onchange", "javascript:HideControl('"+ddlPhotoIdProff.ClientID+"','"+txtPhotoIdProff.ClientID+ "','Any Other');");
            // btnSave.Attributes.Add("onclick", "javascript:return Validate_PanNo_Form60601();");
            //ddlDiscrepancy.Attributes.Add("onchange", "javascript:return Check_Discrepancy();");
            ddlSalutation.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(10);");
            txtAdd1.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(20);");
            txtEmailId.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(32);");
            txtAccountHolder.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(50);");
            ddlNanoModelNo.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(60);");
            ddlDeliveryList.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(69);");
            txtCheque_ddNo.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(77);");
            txtSellingBank.Attributes.Add("onfocus", "javascript:Enabled_ImagePosition_Refresh(90);");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                int Row=Insert_NEWApplication();
                Clear_AllControls();

                if (Row > 0)
                {
                    if ((txtNanoApplicationNo.Text != "") && (Hdn_puid.Value != ""))
                    {
                        Response.Redirect("application.aspx?ApplicationNo=" + Convert.ToString(txtNanoApplicationNo.Text.Trim()) + "&PUID=" + Convert.ToString(Hdn_puid.Value.Trim()));
                    }
                }
    ...
    protected void lnkApplicationExists_Click(object sender, EventArgs e)
    {
        try
        {
            pnlDetails.Page.MaintainScrollPositionOnPostBack = true;
    ...
    private int Insert_NEWApplication()
    {
        try
        {
            Object SaveUSERInfo = (Object)Session["UserInfo"];
            ...
            sqlCom.Connection = sqlCon;
            sqlCom.CommandType = CommandType.StoredProcedure;
            sqlCom.CommandText = "Insert_ApplicationInfo";
            ...
            NanoApplicationDate.Value = txtApplicationDate.Text.Trim();//txtApplicationDate.Text.Trim()).ToString("dd-MM-yyyy");
            ...
            Str_PUID.Direction = ParameterDirection.Output;
            Str_PUID.Value = "";
            Str_PUID.Size = 300;
           ...
           int  intRows=sqlCom.ExecuteNonQuery();
            ...
            string strPUID =Convert.ToString( sqlCom.Parameters["@PUID"].Value );
            Hdn_puid.Value =Convert.ToString(strPUID);
            sqlCon.Close();
            ...
            if (intRows > 0)
            {
                lblMessage.CssClass = "UpdateMessage";
                lblMessage.Visible = true;
                lblMessage.Text = " Data Successfully Updated!,New PAMAC ID: " + Convert.ToString(strPUID.ToString());
            }
            else
            {
                lblMessage.CssClass = "ErrorMessage";
                lblMessage.Visible = true;
                lblMessage.Text = "Error occur, not update!";
            }
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        try
        {
            if (FileUpload1.FileName != "")
            {
               ...
               //string FileSavePath = "~\\Pages\\images\\"+ Convert.ToString(DateTime.Now.ToString("yyyyMMddHHmmss")) + "." + FileFormat[FileFormat.Length-1];
                //string FileSavePath= "C:\\ImageFiles\\" + Convert.ToString(DateTime.Now.ToString("yyyyMMddHHmmss")) + "." + FileFormat[FileFormat.Length-1]; 
               string fullSitePath = this.Request.PhysicalApplicationPath;
               fullSitePath = fullSitePath + "Pages\\Images\\";
               ...
               imgScan.ImageUrl = "~\\Pages\\images\\" + fileName;
