...
{     
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { 
            ...
            else
            {
                ...
                //lblWelcomeClient.Text = "Client Name:" + "  " + Convert.ToString(((UserInfo.structUSERInfo)(SaveUSERInfo)).ClientName);
                //lblWelcomeClient.ForeColor = System.Drawing.Color.Red;
    ...
    private void check_logout()
    {
        ...
        try
        {
            if (sqlCon.State == ConnectionState.Closed)
            {
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "save_logoutdataNew";
                sqlCom.CommandTimeout = 0;
    ...
    private void IsAuthorizeUser_ForPage()
    {
        ...
        Object SaveUSERInfo = (Object)Session["UserInfo"];
                ...
                if (ReturnValue == false)
                {
                    if (Request.AppRelativeCurrentExecutionFilePath.ToString() == "~/Pages/IndusInd/DedupSearch.aspx")
                    {
                    }
                    else
