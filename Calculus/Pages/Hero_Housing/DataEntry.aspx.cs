...
public partial class Pages_Hero_Housing_DataEntry : System.Web.UI.Page
{
        ...
        try
        {
            ...
            for (int i = 0; i <=grdlos.Rows.Count -1; i++)
            {
                ...
                if (ddlstatus.SelectedValue.ToString() != null)
                {
                    ...
                    sqlCom.CommandText = "Hero_Housing_InsertRecord_SP";
    ...
    public void Autoassign()
    {
        ...
        try
        {
            ...
            sqlCom2.CommandText = "Hero_Housing_Auto_Assign1_SP"; 
            ...
            sqlCom2.Parameters.Add(BranchID);
        ...
        try
        {
            ...
            for (int i = 0; i <= grdlos.Rows.Count - 1; i++)
            {
                ...
                if (ddlstatus.SelectedValue.ToString() != null)
                {
                    ...
                    sqlCom.Connection = sqlCon;
                    sqlCom.CommandType = CommandType.StoredProcedure;
                    sqlCom.CommandText = "Hero_Housing_Insert_Record_SP";
                    sqlCom.CommandTimeout = 0;
    ...
    public void Updatedate(DataRow dr)
    {
        ...
        try
        {
            ...
            sqlcmd.CommandText = "Hero_Housing_Date_Update_SP";
            ...
            DataEntryStartTime.ParameterName = "@DataEntryStartTime";
    ...
    protected void grdlos_RowEditing(object sender, GridViewEditEventArgs e)
    {
