...
public partial class Pages_ICICIRPC_Doc_import : System.Web.UI.Page
{
    ...
    private void Sp_Assign_docimport()
    {
        ...
        try
        {
            ...
            sqlCom2.CommandText = "IRPC_Assign_ICICI_TO_DOC_Product_SP";
    ...
    private void getdata_doc()
    {
        ...
        try
        {
            ...
            sqlCom2.Connection = sqlCon;
            sqlCom2.CommandType = CommandType.StoredProcedure;
            sqlCom2.CommandText = "IRPC_ICICI_DOC_SP";
        ...
        try
        {
            ...
            for (int i = 0; i <= grdlos.Rows.Count - 1; i++)
            {
                ...
                if (chkSelect.Checked == true)
                {
                    ...
                    sqlCom.CommandText = "IRPC_ICICI_DOC_Import_SP";
                ...
                if (chkSelect.Checked == true)
                {
                    if (txtremark.Text != "")
                    {
                        ...
                        if (ddlstatus.SelectedIndex != 0)
                        {
                            ...
                            sqlCom.Connection = sqlCon;
                            sqlCom.CommandType = CommandType.StoredProcedure;
                            sqlCom.CommandText = "IRPC_SaveCOMStatusDOCImport_SP";
                            sqlCom.CommandTimeout = 0;
    ...
    protected void grdlos_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            cmd.Parameters.AddWithValue("@Types", "DOCStatusType");
