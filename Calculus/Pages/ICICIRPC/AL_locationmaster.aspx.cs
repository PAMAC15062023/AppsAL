...
public partial class Pages_ICICIRPC_AL_locationmaster : System.Web.UI.Page
{
    ...
    public void bind()
    {
        ...
        using (SqlConnection sqlCon = new SqlConnection(ConfigurationSettings.AppSettings["ConnectionString"]))
        {
            ...
            sqlcmd.CommandText = "IRPC_Get_Data_AL_SP";
            sqlcmd.CommandTimeout = 0;

            SqlDataAdapter ad = new SqlDataAdapter("IRPC_Get_Data_AL_SP", sqlCon);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        sqlcmd.Connection = sqlCon;
        sqlcmd.CommandType = CommandType.StoredProcedure;
        sqlcmd.CommandText = "IRPC_Add_LM_Data_AL_SP";
        sqlcmd.CommandTimeout = 0;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("IRPC_Update_Grid_AL_SP", sqlCon);
        cmd.CommandType = CommandType.StoredProcedure;
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        using (SqlConnection sqlCon = new SqlConnection(ConfigurationSettings.AppSettings["ConnectionString"]))
        {
            ...
            SqlCommand cmd = new SqlCommand("IRPC_Delete_Query_AL_SP", sqlCon);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@id", HiddenField2.Value);
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        using (SqlConnection sqlCon = new SqlConnection(ConfigurationSettings.AppSettings["ConnectionString"]))
        {
            ...
            SqlCommand cmd = new SqlCommand("IRPC_Update_Grid_AL_12_SP", sqlCon);
