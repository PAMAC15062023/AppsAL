<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Doc_import.aspx.cs" Inherits="Pages_ICICIRPC_Doc_import" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        ...
        <tr>
            <td class="TableHeader" colspan="6" style="height: 22px">Doc Upload</td>
        </tr>
        <tr>
            ...
            <td colspan="6">
                <asp:GridView ID="grdlos" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="docStartStatus" HeaderText="Start Status" />
