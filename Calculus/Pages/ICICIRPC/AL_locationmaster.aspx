<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="AL_locationmaster.aspx.cs" Inherits="Pages_ICICIRPC_AL_locationmaster" %>
        ...
        <tr>
            <td style="width: 691px;">
                <table style="width: 686px; height: 113px;">
                    <tr>
                        <td class="TableHeader" colspan="6">Location Master (AL)</td>
                    </tr>
                    <tr>
                        <td colspan="6">
