...
public partial class Pages_ICICIRPC_CPV : System.Web.UI.Page
{
    ...
    public void getdataforQDE_DDE()
    {
        ...
        try
        {
            ...
            sqlCom.CommandText = "IRPC_ICICI_CPV12_SP";
    ...
    public void DDE()
    {
        ...
        try
        {
            ...
            sqlCom2.CommandText = "IRPC_BDE_TO_CPV_Assign_SP";
    ...
    private void Sp_Assign_LOSToCPV()
    {
        Object SaveUSERInfo = (Object)Session["UserInfo"];
        SqlConnection sqlCon = new SqlConnection(ConfigurationSettings.AppSettings["ConnectionString"]);
        ...
        try
        {
            ...
            sqlCom2.Connection = sqlCon;
            sqlCom2.CommandType = CommandType.StoredProcedure;
            sqlCom2.CommandText = "IRPC_Assign_BDE_TO_CPV_AUTO_Product_SP";
        ...
        try
        {
            ...
            for (int i = 0; i <= grdlos.Rows.Count - 1; i++)
            {
                ...
                if (chkSelect.Checked == true)
                {
                    ...
                    sqlCom.Connection = sqlCon;
                    sqlCom.CommandType = CommandType.StoredProcedure;
                    sqlCom.CommandText = "IRPC_ICICI_Indexer_CPV_SP";
                    sqlCom.CommandTimeout = 0;
                ...
                if (chkSelect.Checked == true)
                {
                    if (txtremark.Text != "")
                    {
                        ...
                        if (ddlstatus.SelectedIndex != 0)
                        {
                            ...
                            sqlCom.Connection = sqlCon;
                            sqlCom.CommandType = CommandType.StoredProcedure;
                            sqlCom.CommandText = "IRPC_BDE_ICICI_CPV_SP";
                            sqlCom.CommandTimeout = 0;
    ...
    protected void lnkCompletedtobde_Click(object sender, EventArgs e)
    {
    ...
    private void Sp_Assign_LOSToIndexcer123()
    {
        ...
        try
        {
            ...
            sqlCom2.Connection = sqlCon;
            sqlCom2.CommandType = CommandType.StoredProcedure;
            sqlCom2.CommandText = "IRPC_ICICI_CPV1234_SP";
    ...
    private void Sp_Assign_LOSToIndexcer1234()
    {
        Object SaveUSERInfo = (Object)Session["UserInfo"];
        SqlConnection sqlCon = new SqlConnection(ConfigurationSettings.AppSettings["ConnectionString"]);
        try
        {
            ...
            sqlCom2.Connection = sqlCon;
            sqlCom2.CommandType = CommandType.StoredProcedure;
            sqlCom2.CommandText = "IRPC_ICICI_Inprocess_CPV_SP";
                ...
                if (chkSelect.Checked == true)
                {
                    if (txtremark.Text != "")
                    {
                        if (ddlstatus.SelectedIndex != 0)
                        {
                            ...
                            sqlCom.Connection = sqlCon;
                            sqlCom.CommandType = CommandType.StoredProcedure;
                            sqlCom.CommandText = "IRPC_Completed_Process123_SP";
                            sqlCom.CommandTimeout = 0;
    ...
    protected void lnkcompleted_cam_Click(object sender, EventArgs e)
    {
                    ...
                    if (txtremark.Text != "")
                    {
                        ...
                        if (ddlstatus.SelectedIndex != 0)
                        {
                            ...
                            if (SqlRow > 0)
                            {
                                ...
                                lblMessage.Text = "";
                                Response.Redirect("CAM.aspx?losno=" + HdnUID.Value);
                                //Response.Redirect("~/pages/CAM.aspx");
                            }
                        }
                        else
                        {
    ...
    protected void grdlos_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            cmd.Parameters.AddWithValue("@Types", "CPVStatusType");
