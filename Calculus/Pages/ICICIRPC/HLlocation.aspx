<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="HLlocation.aspx.cs" Inherits="Pages_ICICIRPC_HLlocation" %>
        ...
        <tr>
            <td style="width: 691px;">
                <table style="width: 686px; height: 113px;">
                    <tr>
                        <td class="TableHeader" colspan="6">Location Master (HL)</td>
                    </tr>
                    <tr>
                        <td colspan="6">
                    ...
                    <tr>
                        <td class="TableTitle" colspan="6">
                            <asp:Button ID="btnSubmit" runat="server" CssClass="button"
                                OnClick="btnSubmit_Click" SkinID="btnImport"
                                Text="Submit" />&nbsp;&nbsp;&nbsp;
