...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 903px">
        ...
        <tr>
            <td runat="server" class="TableHeader" colspan="11">&nbsp;Requested Ticket Assignment</td>
        </tr>
        <tr>
            ...
            --%>
            <td class="TableTitle">&nbsp;Request By</td>
            <td class="TableGrid">
        ...
        <tr>
            ...
            <td class="TableTitle">&nbsp;PromblemType</td>
            <td class="TableGrid">
                <asp:UpdatePanel ID="UP_ddlProblemTypeList" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlProblemTypeList" runat="server" SkinID="ddlSkin" AutoPostBack="True" OnSelectedIndexChanged="ddlProblemTypeList_SelectedIndexChanged">
                        </asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlProblemTypeList" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
            <td class="TableTitle">&nbsp;ProblemDetail</td>
            <td class="TableGrid">
                <asp:UpdatePanel ID="UP_ddlProblemDetailList" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlProblemDetailList" runat="server" SkinID="ddlSkin">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="TableTitle">&nbsp;Assigned By</td>
            <td class="TableGrid">
        ...
        <tr>
            <td style="width: 13px; height: 36px;"></td>
            <td class="TableTitle">&nbsp;RequestFrom</td>
            <td class="TableGrid">
            ...
            <td class="TableTitle">&nbsp;Request DateTo
            </td>
            <td class="TableGrid">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 98px; height: 20px">
                    <tr>
            ...
            <td class="TableTitle">&nbsp;Ticket Status</td>
            <td class="TableGrid">
            ...
            <td class="TableTitle">&nbsp;Assigned To</td>
            <td class="TableGrid">
        ...
        <tr>
            <td style="height: 34px;" class="TableTitle" colspan="11">&nbsp;&nbsp;
                ...
                <asp:Button ID="btnReset" runat="server" BorderWidth="1px" Text="Reset" Width="53px" />
        ...
        <tr>
            <td style="height: 16px;" class="TableHeader" colspan="11">&nbsp;&nbsp; Requested Ticket Search Details</td>
        </tr>
        <tr>
            <td colspan="9" style="height: 15px">
                <div style="overflow: scroll; width: 1212px; height:350px">

                    <asp:GridView ID="grv_TicketList" runat="server" AutoGenerateColumns="False" OnRowDataBound="grv_TicketList_RowDataBound" Font-Overline="False" Font-Size="7.5pt" CssClass="mGrid">
                        <Columns>
                            ...
                            <asp:BoundField DataField="UserRemark" HeaderText="UserRemark" />  <%--add on 19/01/2024--%>
                ...
                <tr>
                    <td style="width: 13px"></td>
                    <td style="width: 2065px"></td>
                    <td></td>
                    <td style="width: 904px"></td>
                    <td style="width: 233px"></td>
                    <td style="width: 1447px"></td>
                    <td style="width: 401px"></td>
                    <td style="width: 6684px"></td>
