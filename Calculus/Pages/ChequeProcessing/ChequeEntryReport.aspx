<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChequeEntryReport.aspx.cs"
    Inherits="ChequeEntryReport" MasterPageFile="~/Pages/MasterPage.master" StylesheetTheme="SkinFile" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td colspan="6" headers="Y" style="height: 20px" class="TableHeader">
                &nbsp;Non SBI Generate Cheque Entry Report</td>
        </tr>
        <tr>
            <td class="TableTitle">
                &nbsp;&nbsp; Upload File  
