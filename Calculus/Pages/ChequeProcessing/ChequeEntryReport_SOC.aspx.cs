...
public partial class ChequeEntryReport_SOC : System.Web.UI.Page 
{
    ...
    {         
        try
        {
            if (pFilePath!="")
            {
                ...
                OleDbCommand oleCom = new OleDbCommand("SELECT * FROM  trxnheader Where trantype in('N11','NP6','N50','KH1','N33','N25','NP9','N49','N16','N18','N17','T90','N82','N19','N20','N61','PUR','N59','ROU','AO1','NP3','PR5','PR6','NP5','NP8','N14','N21','NP7') And Invalidtrxnyn='N' ");
    ...
    private string GenerateExportFile(DataTable dt)
    {
        try
        {
            ...
            for (i = 0; i <= dt.Rows.Count - 1; i++)
            {
                ...
                strWrite = strWrite + Trim_TEXT("10606568891", 0, 11);
