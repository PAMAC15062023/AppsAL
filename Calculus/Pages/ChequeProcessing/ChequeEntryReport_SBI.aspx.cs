...
public partial class ChequeEntryReport_SBI : System.Web.UI.Page 
{
    ...
    {         
        try
        {
            if (pFilePath!="")
            {
                ...
                OleDbCommand oleCom = new OleDbCommand("SELECT * FROM trxndetail INNER JOIN trxnheader ON trxndetail.serialno = trxnheader.serialno Where  BankName Like '%STATE BANK OF INDIA%' And InstType='C' And  trantype in('N11','SP1','NP6','N50','KH1','N33','N25','NP9','N49','N16','N17','N18','T90','N82','N19','N20','N61','PUR','N59','ROU','AO1','NP3','PR5','PR6','NP5','NP8','N14','N21','NP7') And Invalidtrxnyn='N'");
    ...
    private string GenerateExportFile(DataTable dt)
    {
        try
        {
            ...
            for (i = 0; i <= dt.Rows.Count - 1; i++)
            {
                ...
                {
                    strWrite = strWrite + System.Environment.NewLine;
                }
            }
            string FileName = "";
            string FileSAVEPath = "";
    ...
    private void Upload_RecordTo_Grid_XLS(string pFilePath)
    {
        try
        {
            if (pFilePath != "")
            {
                ...
                OleDbCommand oleCom = new OleDbCommand("SELECT * FROM [sheet1$] INNER JOIN [sheet2$] ON [sheet2$].serialno = [sheet1$].serialno Where  BankName Like '%STATE BANK OF INDIA%' And InstType='C' And  trantype in('N11','SP1','NP6','N50','KH1','N33','N25','NP9','N49','N16','N17','N18','T90','N82','N19','N20','N61','PUR','N59','ROU','AO1','NP3','PR5','PR6','NP5','NP8','N14','N21','NP7') And Invalidtrxnyn='N'");
                oleCom.Connection = oleCon;
