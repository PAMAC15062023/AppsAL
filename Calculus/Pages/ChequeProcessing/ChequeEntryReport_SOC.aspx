<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChequeEntryReport_SOC.aspx.cs"
    Inherits="ChequeEntryReport_SOC" MasterPageFile="~/Pages/MasterPage.master" StylesheetTheme="SkinFile" %>
    ...
    <table border="0" cellspacing="1" cellpadding="1">
        ...
        <tr>
            <td colspan="6" headers="Y" style="height: 20px" class="TableHeader">
                &nbsp;SOC Generate Cheque Entry Report</td>
        </tr>
        <tr>
            <td class="TableTitle">
                &nbsp;&nbsp; Upload File  
            ...
            <td colspan="5" style="height: 29px">
                &nbsp;<asp:FileUpload ID="FileUpload1" runat="server" Height="25px" Width="485px" BorderColor="Maroon"
                    BorderWidth="1px" /></td>
        </tr>
        <tr>
