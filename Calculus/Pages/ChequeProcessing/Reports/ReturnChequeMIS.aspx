<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReturnChequeMIS.aspx.cs" Inherits="ReturnChequeMIS" Title="Return Cheque MIS" %>
    ...
    <table border="0" cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td class="TableHeader" colspan="6" headers="Y" style="height: 20px">
                &nbsp;Return Cheque MIS</td>
        </tr>
        <tr>
            <td class="TableTitle" style="width: 153px; height: 29px">
                &nbsp;Return Date From</td>
            <td colspan="5" style="height: 29px; width: 779px;">
        ...
        <tr>
            ...
            <td colspan="5" style="width: 779px">
            </td>
        </tr>
        <tr>
            <td class="TableTitle" colspan="6" style="height: 35px">
                ...
                <asp:Button ID="btnUpload" runat="server" BorderWidth="1px" Height="23px" OnClick="btnUpload_Click"
                    Text="Retrieve" Width="97px" /></td>
        </tr>
        <tr>
            <td colspan="6">
                <asp:Panel ID="Panel1" runat="server" Height="200px" ScrollBars="Auto" Width="800px">
                    &nbsp;
                    <table border="0" id="tbExport" cellpadding="0" cellspacing="0" runat="server" visible="true"
                        width="100%">
                        <tr>
                            <td>
                                &nbsp;&nbsp;
