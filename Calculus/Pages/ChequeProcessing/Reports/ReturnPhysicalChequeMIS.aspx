<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="ReturnPhysicalChequeMIS.aspx.cs" Inherits="ReturnPhysicalChequeMIS" Title="Return Cheque MIS" %>
    ...
    <table border="0" cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td class="TableTitle" style="width: 153px; height: 29px">
                &nbsp;Return Date From</td>
            <td colspan="5" style="height: 29px; width: 639px;">
