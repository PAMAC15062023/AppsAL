<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="InvalidChequeMIS.aspx.cs" Inherits="Pages_ChequeProcessing_Reports_InvalidChequeMIS" Title="Untitled Page" %>
    ...
    <table border="0" cellpadding="0" cellspacing="1">
        ...
        <tr>
            <td class="TableHeader" colspan="6" headers="Y" style="height: 20px">
                &nbsp;Invalid Cheque MIS</td>
        </tr>
        <tr>
            <td class="TableTitle" style="width: 153px; height: 29px">
                &nbsp;Deposit Date From
            </td>
            <td colspan="5" style="height: 29px; width: 645px;">
