<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InwardBTChequeMIS.aspx.cs"
    Inherits="InwardBTCheque" MasterPageFile="~/Pages/MasterPage.master" StylesheetTheme="SkinFile" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td colspan="6" headers="Y" style="height: 20px" class="TableHeader">
                &nbsp;Inward BT Identification MIS</td>
        </tr>
        <tr>
            <td style="width: 102px" class="TableTitle">
                &nbsp; Pickup Date From</td>
            <td colspan="5" style="height: 29px; width: 684px;">
        ...
        <tr>
            <td class="TableTitle" style="width: 102px">
                &nbsp; Pickup Date To</td>
            <td colspan="5" style="width: 684px; height: 29px">
        ...
        <tr>
            ...
            <td colspan="5" style="width: 684px">
            </td>
        </tr>
        <tr>
