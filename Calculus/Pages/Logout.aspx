<%@ Page Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Logout.aspx.cs" Inherits="Pages_Logout" Title="Log out from NANO" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="lblMessage" runat="server" Font-Size="14pt" ForeColor="Red" Height="33px"
        Text="Successfully logout from system!!!!!!!!!!!!!!" Width="470px"></asp:Label></td>
        </tr>
        <tr>
