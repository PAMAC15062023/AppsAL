...
public partial class Pages_HeroHousing_CAM : System.Web.UI.Page
{
    ...
    public void sp_assign_CAM()
    {
        ...
        try
        {
            SqlCommand sqlcmd = new SqlCommand("HeroHousing_Assign_HousingCAM_SP", sqlcon);
    ...
    public void get_importdata()
    {
        ...
        try
        {
            SqlCommand cmd1 = new SqlCommand("HeroHousing_Get_Data_CAM_SP", conn);
    ...
    public void DiscripancyGridBind()
    {
        ...
        try
        {
            for (int i = 0; i <= grdlos.Rows.Count - 1; i++)
            {
                ...
                SqlCommand cmd = new SqlCommand("HeroHousing_CAM_SelectDiscripancy_SP", conn);
    ...
    protected void lnkWIP_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            for (int i = 0; i <= grdlos.Rows.Count - 1; i++)
            {
                ...
                SqlCommand cmd = new SqlCommand("HeroHousing_Inproc_CAM_SP", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
            ...
            if (sqlCon.State == ConnectionState.Closed)
            {
                ...
                for (int i = 0; i <= grdlos.Rows.Count - 1; i++)
                {
                    ...
                    if (HdnWIPStatus.Value == "InProcess")
                    {
                        ...
                        sqlCom.CommandText = "HeroHousing_CAM_AddDiscripancy_SP";
        ...
        try
        {
            ...
            for (int i = 0; i <= GridDiscripancy.Rows.Count - 1; i++)
            {
                ...
                if (chkSelect.Checked == true)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("HeroHousing_CAM_UpdateDiscripancy_SP", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandTimeout = 0;
    ...
    protected void lnkCompleteNext_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            for (int i = 0; i <= grdlos.Rows.Count - 1; i++)
            {
                ...
                SqlCommand cmd = new SqlCommand("HeroHousing_CAM_COMPLETE_SP", sqlcon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
