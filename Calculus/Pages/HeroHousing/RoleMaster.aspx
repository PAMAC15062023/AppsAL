<%@ Page Language="C#" MasterPageFile="~/Pages/HeroHousing/sample.master" AutoEventWireup="true" CodeFile="RoleMaster.aspx.cs" Inherits="Pages_HeroHousing_RoleMaster" %>
                                                ...
                                                <asp:TemplateField HeaderText="Change Role">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:DropDownList ID="ddlrole" runat="server" SkinID="ddlSkin" AutoPostBack="True"
                                                            ...
                                                            <asp:ListItem Text="Data Entry" Value="HH_DataEntry"></asp:ListItem>
                                                            <asp:ListItem Text="CAM" Value="MHH_CAMaker"></asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                                </ContentTemplate>
                                                            <Triggers>
