...
public partial class Pages_HeroHousing_RoleMaster : System.Web.UI.Page
{
    ...
    private void Get_DataForRole()
    {
        ...
        try
        {
            ...
            sqlCom.CommandText = "Userdetailspresent_HeroHousing";
            ...
            for (int i = 0; i <= grdrole.Rows.Count - 1; i++)
            {
                ...
                if (chkSelect.Checked == true)
                {
                    ...
                    if (Role1.SelectedValue.ToString() != "0")
                    {
                        ...
                        sqlCom.Connection = sqlCon;
                        sqlCom.CommandType = CommandType.StoredProcedure;
                        sqlCom.CommandText = "Sp_ChangedRole_HeroHousing";
                        sqlCom.CommandTimeout = 0;
