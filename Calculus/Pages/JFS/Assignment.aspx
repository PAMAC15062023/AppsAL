<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Assignment.aspx.cs" Inherits="Pages_JFS_Assignment" %>
...
//        alert("kkkk")
    ...
    <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="DE User Assignment Stage" Font-Size="Medium"></asp:Label>
    <br />
    </td>
    </tr>
        <tr>
   ...
   <asp:ListItem>---All---</asp:ListItem>
    ...
    <asp:Button ID="btnsearch" runat="server" Text="Search" onclick="btnsearch_Click" 
      ...
      <asp:Button ID="btnassign" runat="server" Text="Assign/Reassign" BorderColor="#400000" BorderWidth="1px" 
                        Font-Bold="False" Width="105px" style="height: 24px"  onclick="Button1_Click" OnClientClick="javascript:ClientCheckmm()"/> 
                     &nbsp; &nbsp; &nbsp;
