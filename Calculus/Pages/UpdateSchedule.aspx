<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/MasterPage.master"  CodeFile="UpdateSchedule.aspx.cs" Inherits="application" Title="Schedule Update" %>
 ...
 <div> 
     <asp:Label ID="lblMess" runat="server" Width="244px" ForeColor="Red"></asp:Label><br />
     ...
     <table style="width: 100%">
         <tr>
             ...
             <td class="TableHeader" colspan="6">
                 &nbsp;Schedule Modification &nbsp;</td>
         </tr>
         <tr>
             <td class="TableTitle">
                 Application No</td>
             <td style="width: 269px">
         <asp:TextBox ID="txtAppNo" runat="server" Width="161px" ValidationGroup="App"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="Rq_Retreive" runat="server" ControlToValidate="txtAppNo"
                     ErrorMessage="Please enter Application No to Contine.." ValidationGroup="App">?</asp:RequiredFieldValidator></td>
             <td class="TableTitle">
         <asp:Button ID="btnRet" runat="server" Text="Retrive" OnClick="btnRet_Click" ValidationGroup="App" /></td>
         ...
         <tr>
             ...
             <td style="width: 269px">
                 ...
                 <asp:RequiredFieldValidator ID="Rq_dateofAgreement" runat="server" ControlToValidate="txtAgriDate"
                     ErrorMessage="Agreement date not entered!" ValidationGroup="BasicEntry">?</asp:RequiredFieldValidator></td>
             <td class="TableTitle">
                 &nbsp;(DD/MM/YYYY)</td>
             <td style="width: 100px">
             </td>
         ...
         <tr>
             ...
             <td style="width: 269px">
                 ...
                 <img id="Img1" alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtBirthDate.ClientID%>, 'dd/mm/yyyy', 0, 0);"
                     src="SmallCalendar.gif" />
                 <asp:RequiredFieldValidator ID="Rq_DOB" runat="server" ControlToValidate="txtBirthDate"
                     ErrorMessage="Date of Birth not entered" ValidationGroup="BasicEntry">?</asp:RequiredFieldValidator></td>
             <td class="TableTitle">
                 (DD/MM/YYYY)</td>
             <td style="width: 100px">
             </td>
         ...
         <tr>
             <td class="TableHeader" colspan="6" style="height: 17px">
                 &nbsp;<asp:Button ID="BtnSave1" runat="server" Text="Update Changes" Width="117px" OnClick="BtnSave1_Click" ValidationGroup="BasicEntry" />
     <asp:Button ID="btnClear1" runat="server" Text="Clear" Width="50px" />
                 <asp:Button ID="btnCancel" runat="server" Text="Cancel" Width="50px" OnClick="btnCancel_Click" /></td>
         </tr>
         <tr>
