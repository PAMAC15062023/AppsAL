<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AUMVD_Login.aspx.cs" Inherits="AUMVD.AUMVD_Login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" style="width: 728px">
            <tr>
                <td style="width: 214px" align="center"></td>
                <td style="width: 513px">&nbsp;</td>
            </tr>
            <table cellpadding="0" cellspacing="0"
                style="width: 600px; background-image: url('LoginScreen1.jpg'); height: 204px; background-repeat: no-repeat;">
                <tr>
                    <td>&nbsp;</td>
                    <td>
