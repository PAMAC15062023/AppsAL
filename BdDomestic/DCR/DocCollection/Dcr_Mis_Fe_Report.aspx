<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DCR/DocCollection/CC_MasterPage.master" Theme="SkinFile" CodeFile="~/DCR/DocCollection/Dcr_Mis_Fe_Report.aspx.cs" Inherits="DcrTeleMIS" %>
...
//}
    ...
    <td>
    <fieldset>
    <legend class="FormHeading">DCR FE Productivity Report</legend>
    ...
    <table border="0" id="tblExport" cellpadding="0" cellspacing="0" width="100%">
    <tr>
    <td>
