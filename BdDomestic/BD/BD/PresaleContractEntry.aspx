...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:RequiredFieldValidator ID="rfvclient" runat="server" ControlToValidate="ddlClient"
        ...
        <asp:SqlDataSource ID="sdsClient" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
            ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SELECT [CLIENT_ID], [CLIENT_NAME], [CLIENT_DOMAIN] FROM [CLIENT_MASTER] WHERE billing_add1 is null ORDER BY [CLIENT_NAME]">
        </asp:SqlDataSource>
