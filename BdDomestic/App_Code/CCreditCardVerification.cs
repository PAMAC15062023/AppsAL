...
public class CCreditCardVerification
{
    ...
    public DataSet GetAttemptDtl(string sCaseID,string sVerificationTypeId)
    {
        ...
        sSql = "SELECT E.EMP_ID , E.FULLNAME,CSM.STATUS_CODE,CSM.STATUS_NAME,CD.Case_Status_ID,CD.DECLINED_CODE,CD.DECLINED_REASON, " +
              " VAT.ATTEMPT_DATE_TIME,VAT.REMARK,cd.add_date,vat.SubRemark " +
    ...
    public DataSet GetAttemptDtl2(string sCaseID, string sVerificationTypeId)
    {
        string sSql = "";

        sSql = "select top 3 a.case_id,a.verification_type_id, c.fullname,a.date_time from CPV_CC_FE_CASE_MAPPING a,employee_master c where " +
                " a.fe_id=c.emp_id and a.case_id='" + sCaseID + "' and a.verification_type_id='" + sVerificationTypeId + "' union all " + 
                " select top 3 b.case_id,b.verification_type_id,c.fullname,b.date_time from cpv_cc_fe_case_mapping_history b,employee_master c " +
    ...
    private string sStandLive;
    public string StandLive
    {
        get { return sStandLive; }
        set { sStandLive = value; }
    }
    private string sTypeProof;
    public string TypeProof
    {
        get { return sTypeProof; }
        set { sTypeProof = value; }
    }
    ...
    private string sSpouseOccu;
    public string SpouseOccu
    {
        get { return sSpouseOccu; }
        set { sSpouseOccu = value; }
    }

    private string sSpouseName;
    public string SpouseName
    {
        get { return sSpouseName; }
        set { sSpouseName = value; }
    }
    ...
    private string sExteriorPremises;
    public string ExteriorPremises
    {
        get { return sExteriorPremises; }
        set { sExteriorPremises = value; }
    }
    ...
    private string sStanLiving;
    public string StanLiving
    {
        get { return sStanLiving; }
        set { sStanLiving = value; }
    }
    ...
    private string sVeriScore;
    public string VeriScore
    {
        get { return sVeriScore; }
        set { sVeriScore = value; }
    }
   ...
   // Start Property for New Added Fields for City Bank (Dubai)
    ...
    /////add by kamal
   private string sNameDisplayedInNameBoardOfTheSociety;
   public string NameDisplayedInNameBoardOfTheSociety
   {
       get { return sNameDisplayedInNameBoardOfTheSociety; }
       set { sNameDisplayedInNameBoardOfTheSociety = value; }

   }

    private string sDoesTheApplicantWorkHere;
    public string DoesTheApplicantWorkHere
    {
        get { return sDoesTheApplicantWorkHere; }
        set { sDoesTheApplicantWorkHere = value;}

    }

    private string sShiftOfWork;
    public string ShiftOfWork
    {
        get { return sShiftOfWork; }
        set { sShiftOfWork = value; }
    ...
    private string sAddressApporch;
    public string AddressApporch
    {
        get { return sAddressApporch; }
        set { sAddressApporch = value; }

    }


    private string sVisitingCard;
    public string VisitingCard
    {
        get { return sVisitingCard; }
        set { sVisitingCard = value; }
    ...
    private string sSeparateOfficeArea;
    public string SeparateOfficeArea
    {
        get { return sSeparateOfficeArea; }
        set { sSeparateOfficeArea = value; }

    }

    private string sCommentOnBusinessActivity;
    public string CommentOnBusinessActivity
    {
        get
        {
            return sCommentOnBusinessActivity;
        }
        set
        {
            sCommentOnBusinessActivity = value;
        }

    }

    /// <summary>
    /// /////add by Mashrque Bank/////////
    /// </summary>
    /// 
    private string sEmirates;
    public string Emirates
    {
        get { return sEmirates; }
        set { sEmirates = value; }

    }
    private string sPoboxNo;
    ...
    private string sSignboardDoor;
    public string SignboardDoor
    {
        get { return sSignboardDoor; }
        set { sSignboardDoor = value; }

    }
    private string sModeSalary;
    public string ModeSalary
    {
        get { return sModeSalary; }
        set { sModeSalary = value; }

    }
    private string sBusiTo;
    public string BusiTo
    {
        get { return sBusiTo; }
        set { sBusiTo = value; }

    }
    private string sCompClients;
    public string CompClients
    {
        get { return sCompClients; }
        set { sCompClients = value; }

    }
    private string sCompBank;
    public string CompBank
    {
        get { return sCompBank; }
        set { sCompBank = value; }

    }
    private string sOffice1;
    ...
    private string sDateJoin;
    public string DateJoin
    {
        get { return sDateJoin; }
        set { sDateJoin = value; }

    }
    private string sApplicantReport;
    public string ApplicantReport
    {
        get { return sApplicantReport; }
        set { sApplicantReport = value; }
    ...
    private string sApplicantOwner;
    public string ApplicantOwner
    {
        get { return sApplicantOwner; }
        set { sApplicantOwner = value; }

    }
    private string sYesRelation;
    public string YesRelation
    {
        get { return sYesRelation; }
        set { sYesRelation = value; }

    }
    private string sDetailsVerified;
    public string DetailsVerified
    {
        get { return sDetailsVerified; }
        set { sDetailsVerified = value; }

    }
    private string sLoanNumber;
    public string LoanNumber
    {
        get { return sLoanNumber; }
        set { sLoanNumber = value; }

    }
    private string sRefTelNumber;
    public string RefTelNumber
    {
        get { return sRefTelNumber; }
        set { sRefTelNumber = value; }

    }
    private string sRefCont;
    public string RefCont
    {
        get { return sRefCont; }
        set { sRefCont = value; }
    ...
    private string sEmirate1;
    public string Emirate1
    {
        get { return sEmirate1; }
        set { sEmirate1 = value; }

    }
    private string sLoanAppli;
    public string LoanAppli
    {
        get { return sLoanAppli; }
        set { sLoanAppli = value; }
    ...
    //----added by kamal matekar for mashreq bank.....femu requirment
    private string sSponser1Designation;
    public string Sponser1Designation
    {
        get { return sSponser1Designation; }
        set { sSponser1Designation = value; }

    }
    private string sSponser2Designation;
    public string Sponser2Designation
    {
        get { return sSponser2Designation; }
        set { sSponser2Designation = value; }

    }
    private string sFavouritePlace;
    public string FavouritePlace
    {
        get { return sFavouritePlace; }
        set { sFavouritePlace = value; }

    }
    private string sReferenceNoInUAE;
    public string ReferenceNoInUAE
    {
        get { return sReferenceNoInUAE; }
        set { sReferenceNoInUAE = value; }

    }
    private string sAnyOtherBankCcFinancialfacility;
    public string AnyOtherBankCcFinancialfacility
    {
        get { return sAnyOtherBankCcFinancialfacility; }
        set { sAnyOtherBankCcFinancialfacility = value; }
    ...
    private string sVehicalFinanced;
    public string VehicalFinanced
    {
        get { return sVehicalFinanced; }
        set { sVehicalFinanced = value; }

    }
    private string sBreakUpNumberOfEmployeesWithDesignations;
    public string BreakUpNumberOfEmployeesWithDesignations
    {
        get { return sBreakUpNumberOfEmployeesWithDesignations; }
        set { sBreakUpNumberOfEmployeesWithDesignations = value; }

    }
    private string sIsOfficePremisesSharedAnyOtherOffice;
    public string IsOfficePremisesSharedAnyOtherOffice
    {
        get { return sIsOfficePremisesSharedAnyOtherOffice; }
        set { sIsOfficePremisesSharedAnyOtherOffice = value; }
   ...
   /// <summary>
    ...
    private string sIfAddressNotFound;
    public string IfAddressNotFound
    {
        get { return sIfAddressNotFound; }
        set { sIfAddressNotFound = value; }

    }

    private string sDoNeighbourNeighboringshopsorofficesknowthecustomer;
    public string DoNeighbourNeighboringshopsorofficesknowthecustomer
    {
        get { return sDoNeighbourNeighboringshopsorofficesknowthecustomer; }
        set { sDoNeighbourNeighboringshopsorofficesknowthecustomer = value; }
    ...
    private string sReasonforApplicantNotMet;
    public string ReasonforApplicantNotMet
    {
        get { return sReasonforApplicantNotMet; }
        set { sReasonforApplicantNotMet = value; }
    ...
    private string sIfOtherSpecify;
    public string IfOtherSpecify
    {
        get { return sIfOtherSpecify; }
        set { sIfOtherSpecify = value; }

    }

    private string sTypeOfOccupation;
    public string TypeOfOccupation
    {
        get { return sTypeOfOccupation; }
        set { sTypeOfOccupation = value; }

    }

    private string sHeadofficebranch;
    public string Headofficebranch
    {
        get { return sHeadofficebranch; }
        set { sHeadofficebranch = value; }

    }


    ///////added for RV by kamal metekar

    private string sApplicantliveswith;
    public string Applicantliveswith
    {
        get { return sApplicantliveswith; }
        set { sApplicantliveswith = value; }
    ...
    private string sRelationshipwithBank;
    public string RelationshipwithBank
    {
        get { return sRelationshipwithBank; }
        set { sRelationshipwithBank = value; }
    ...
    private string sNumberofRooms;
    public string NumberofRooms
    {
        get { return sNumberofRooms; }
        set { sNumberofRooms = value; }
   ...
   ///////////end by kamal matekar
    ...
    public OleDbDataReader GetCaseVerDescriptionRV(string sCaseId, string sVeriType)
    {
         ...
         sSql = "SELECT PP_NORMAL, QUALIFICATION, TIME_AT_CURR_Y_M, MARITAL_STATUS, IS_SPOUSE_WORKING, S_COMPANY_NAME, S_SALARY, S_TELEPHONE," +
              ...
              "ADDRESS2, APPLICANT_AGE2, NO_OF_RES_AT_HOME2, YEARS_LIVE_AT_ADD2,S_SALARY,RESIDANCE_STATUS2,WORKING,CHILDREN,App_dob_approx_Age,Door_Lock,door_colour, " +
              "NAME_SOCIETY_BOARD,Nature_Business " +
              "FROM CPV_CC_VERI_DESCRIPTION " +
              "WHERE CASE_ID = '" + sCaseId + "' AND VERIFICATION_TYPE_ID = '" + sVeriType + "'";
         //Added New Column In Dir_Check above code 
        //Added By Avinash Wankhede 04 June 2009
        //Chnages for GESBI
    ...
    #region GetCaseVerDescription1RV
     ...
     public OleDbDataReader GetCaseVerDescription1RV(string sCaseId, string sVeriType)
     {
         ...
         sSql="SELECT CONTACTED_PERSON_DESIGN, INCOME_DOC_SUBMITTED_WITH_APLICATION, FE_REMARK, CO_APP_NAME, PRIORITY_CUSTOMER, "+
              ...
              "OFFICE_ADDRESS,RESIDANCE_STATUS,OFFICE_ADDRESS,STAY,NEIGHBOUR_NAME_2,NEIGHBOUR_REFERENCE,PINCODE,RESIDANCE_IS,PERMANENT_ADDRESS,LAND_MARK_OBSERVED,Affilation_Political_Party_Seen,job_desc,job_type, "+
              "Directory_check,NEIGHBOUR_ADD_2,MAILING_ADDRESS,AVG_MONTH_TURNOVER,BUSINESS_STOCK_SEEN,neighbour_name_2 " +
              "FROM CPV_CC_VERI_DESCRIPTION1 " +
              "WHERE CASE_ID = '" + sCaseId + "' AND VERIFICATION_TYPE_ID = '" + sVeriType + "'";
    ...
    public OleDbDataReader GetCaseVerOtherDtlRV(string sCaseId, string sVeriType)
     {
         ...
         sSql = "SELECT REL_WITH_APPLICANT, PERSON_CONTACTED, IS_RESIDANT, PERMANENT_ADDRESS, IS_NEGATIVE_AREA, "+
                "IS_OCL, LOCALITY_TYPE, RES_TYPE,IS_APP_NAME_ON_DOOR,AGENCY_NAME,Address_Apporch,Applicant_lives_with, "+
                "Additional_Comments,Residence_Address_updatedbyFE,Address_of_Company,Relationship_With_Bank,Roof_Type,Number_of_Rooms,Family_Seen,OFF_NAME_ON_BOARD,NAME_PLATE " +
    ...
    public OleDbDataReader GetCaseVerDtlRV(string sCaseId, string sVeriType)
     {
         ...
         sSql = "SELECT DECLINED_CODE,DECLINED_REASON,RATING,DEFAULTED_WITH,DEFAULTED_PRODUCT,DEFAULT_AMOUNT," +
                "SUPERVISOR_ID,SUPERVISOR_REMARKS,CASE_STATUS_ID,OVERALL_ASSESMENT,OVERALL_ASSESMENT_REASON,Reason, " +
                "Spouse_Occu,Spouse_Name,Car_Park,Entrance_Motorable,Exterior_Premises,Residence_Internal,Flooring, " +
                "Roofing,StanLiving FROM CPV_CC_VERI_DETAILS " +                
                "WHERE CASE_ID = '" + sCaseId + "' AND VERIFICATION_TYPE_ID = '" + sVeriType + "'";
    ...
    #region GetCaseVerDescriptionBV
     ...
     public OleDbDataReader GetCaseVerDescriptionBV(string sCaseId, string sVeriType)
     {
         ...
         sSql = "SELECT PP_NORMAL, QUALIFICATION,TIME_AT_CURR_Y_M, MARITAL_STATUS, IS_SPOUSE_WORKING, S_COMPANY_NAME, S_SALARY, S_TELEPHONE," +
              ...
              "INFO_REFUSED, OCCUPATION, REASON_ADD_NOT_CONFIRM, LOCALITY, RESULT_CALLING, MISMATCH_RESI_ADD, IS_APP_KNOWN_PERSON, " +
              "ADDRESS_BELONG, VERIFICATION_CONDUCTED, ACCOMODATION, INTERIOR, EXTERIOR, TPC_BY, OBSERVATION, TPC2, PERSON_MET2, " +
              "ADDRESS2, APPLICANT_AGE2, NO_OF_RES_AT_HOME2, YEARS_LIVE_AT_ADD2,S_SALARY,RESIDANCE_STATUS2,INTERIOR,EXTERIOR,VERIFIED_NEIGHBOUR,Nature_Business,Service_Provider,NAME_SOCIETY_BOARD,APPLICANT_WORKS_AT,WORKING " +
              "FROM CPV_CC_VERI_DESCRIPTION " +
              "WHERE CASE_ID = '" + sCaseId + "' AND VERIFICATION_TYPE_ID = '" + sVeriType + "'";
    ...
    public OleDbDataReader GetCaseVerDescription1BV(string sCaseId, string sVeriType)
     {
        ...
        sSql="SELECT CONTACTED_PERSON_NAME,TIME_AT_CURRENT_EMPLOYMENT,CONTACTED_PERSON_DESIGN, BUSINESS_TYPE, COMPANY_EXISTENCE_YEAR, EMP_JOB_TYPE, "+
             ...
             "DESIGNATION, DOB_APPLICANT, PARTICULARS, AVG_MONTH_TURNOVER,APP_MET_AT,NAMEOFCOMPANY1,PREVIOUS_EMP_DETAIL,OFFICE_REPUTATION,BUSINESS_TYPE,NEIGHBOUR_REFERENCE,MAILING_ADDRESS " +
             "FROM CPV_CC_VERI_DESCRIPTION1 "+
             "WHERE CASE_ID = '" + sCaseId + "' AND VERIFICATION_TYPE_ID = '" + sVeriType + "'";
    ...
    public OleDbDataReader GetCaseVerOtherDtlBV(string sCaseId, string sVeriType)
    {
        ...
        sSql="SELECT REL_WITH_APPLICANT, PERSON_CONTACTED, CONT_PERSON_REMARK, IS_NEGATIVE_AREA, IS_OCL, LOCALITY_TYPE, RES_TYPE, "+
             ...
             "NAME_OF_OWNER,BRANCHES_WARESHOUSE_COMPANY_IN_UAE,Address_Apporch,If_address_not_found,Do_Neighbour_Neighboring_shops_or_offices_know_the_customer," +
             "Brief_Job_Responsibilities,Reason_for_applicant_not_met,Type_Of_Organization,If_Other_specify,Type_of_occupation,Head_office_branch,TYPE_OF_LOAN " +
             "FROM CPV_CC_VERI_OTHER_DETAILS "+
             "WHERE CASE_ID = '" + sCaseId + "' AND VERIFICATION_TYPE_ID = '" + sVeriType + "' ";
    ...
    public OleDbDataReader GetCaseVerDtlBV(string sCaseId, string sVeriType)
    {
        ...
        sSql = "SELECT DECLINED_CODE,DECLINED_REASON,CASE_STATUS_ID,OVERALL_ASSESMENT,OVERALL_ASSESMENT_REASON,RATING,SUPERVISOR_REMARKS,SUPERVISOR_ID,Reason " +
    ...
    public OleDbDataReader GetCaseVerDtlBVSoc(string sCaseId, string sVeriType)
    {
        string sSql = "";

        sSql = "SELECT Emirates,Pobox_No,Signboard_Door,Mode_Salary,Busi_To,Comp_Clients,Comp_Bank,Office1,Office2,Office3, " +
               " Office4,Date_Join,Applicant_Report,Desig,Applicant_Owner,Yes_Relation,Details_Verified,Loan_Number,Ref_Tel_Number, " +
               " Ref_Cont,Area,Emirate_1,Loan_Appli,Location,VisitingCard,BusinessOwnership,SeparateOfficeArea,CommentsOnBusinessActivities ," +
               " desig1,desig2,Fav_Place,Ref_UAE,Other_Bank,Vehical_Own,Vehical_Fin,Breakup_Emp,Premise_Share " +
               " FROM Cpv_Cc_Veri_Society " +
               "WHERE CASE_ID = '" + sCaseId + "' AND VERIFICATION_TYPE_ID = '" + sVeriType + "'";
    ...
    public string InsertUpdateCCBusiVerificationEntry(ArrayList arrAttempt)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                OleDbParameter[] paramCCVerDesc = new OleDbParameter[54];
                ...
                /////added by kamal matekar for femu.....////
                paramCCVerDesc[50] = new OleDbParameter("@NAME_SOCIETY_BOARD", OleDbType.VarChar, 50);
                paramCCVerDesc[50].Value = NameDisplayedInNameBoardOfTheSociety;
                paramCCVerDesc[51] = new OleDbParameter("@APPLICANT_WORKS_AT", OleDbType.VarChar, 50);
                paramCCVerDesc[51].Value = DoesTheApplicantWorkHere;
                paramCCVerDesc[52] = new OleDbParameter("@WORKING", OleDbType.VarChar, 50);
                paramCCVerDesc[52].Value = ShiftOfWork;
            
                paramCCVerDesc[53] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                paramCCVerDesc[53].Direction = ParameterDirection.Output;
                ...
                if (Convert.ToInt32( paramCCVerDesc[53].Value) == 1)
                {
                    sRetVal = "Record added successfully.";

                }
                else if (Convert.ToInt32(paramCCVerDesc[53].Value) == 2)
                {
            ...
            try
            {
                ...
                sSql = "";
                OleDbParameter[] paramCCVerDesc1 = new OleDbParameter[70];
                ...
                else
                {
                    ...
                    paramCCVerDesc1[67] = new OleDbParameter("@NEIGHBOUR_REFERENCE", OleDbType.VarChar, 100);
                    paramCCVerDesc1[67].Value = NeighbourReferance;
                    paramCCVerDesc1[68] = new OleDbParameter("@MAILING_ADDRESS", OleDbType.VarChar, 100);
                    paramCCVerDesc1[68].Value = Email;
                    ///////end by kamal
                
                    paramCCVerDesc1[69] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                    paramCCVerDesc1[69].Direction = ParameterDirection.Output;
                
                    OleDbHelper.ExecuteNonQuery(oledbTrans1, CommandType.StoredProcedure, "spAddEditCCDescription1BV", paramCCVerDesc1);
                    if (Convert.ToInt32(paramCCVerDesc1[69].Value) == 1)
                    {
                        sRetVal = " Record added successfully.";

                    }
                    else if (Convert.ToInt32(paramCCVerDesc1[69].Value) == 2)
                    {
                        sRetVal = " Record updated successfully.";
                    }
                    else
            ...
            try
            {
                ...
                sSql = "";
                OleDbParameter[] paramCreditCardOtherDtl = new OleDbParameter[110];
                ...
                else
                {
                    ...
                    paramCreditCardOtherDtl[77] = new OleDbParameter("@AdditionalComments", OleDbType.VarChar, 1000);
                    ...
                    /////added by kamal matekar for femu
                    paramCreditCardOtherDtl[99] = new OleDbParameter("@Address_Apporch", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[99].Value = AddressApporch;

                    paramCreditCardOtherDtl[100] = new OleDbParameter("@If_address_not_found", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[100].Value = IfAddressNotFound;

                    paramCreditCardOtherDtl[101] = new OleDbParameter("@Do_Neighbour_Neighboring_shops_or_offices_know_the_customer", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[101].Value = DoNeighbourNeighboringshopsorofficesknowthecustomer;

                    paramCreditCardOtherDtl[102] = new OleDbParameter("@Brief_Job_Responsibilities", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[102].Value = BriefJobResponsibilities;

                    paramCreditCardOtherDtl[103] = new OleDbParameter("@Reason_for_applicant_not_met", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[103].Value = ReasonforApplicantNotMet;

                    paramCreditCardOtherDtl[104] = new OleDbParameter("@Type_Of_Organization", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[104].Value = TypeOfOrganization;

                    paramCreditCardOtherDtl[105] = new OleDbParameter("@If_Other_specify", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[105].Value = IfOtherSpecify;

                    paramCreditCardOtherDtl[106] = new OleDbParameter("@Type_of_occupation", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[106].Value = TypeOfOccupation;

                    paramCreditCardOtherDtl[107] = new OleDbParameter("@Head_office_branch", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[107].Value = Headofficebranch;

                    paramCreditCardOtherDtl[108] = new OleDbParameter("@TypeOfLoan", OleDbType.VarChar, 150);
                    paramCreditCardOtherDtl[108].Value = TypeOfLoan;

                    paramCreditCardOtherDtl[109] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                    paramCreditCardOtherDtl[109].Direction = ParameterDirection.Output;


                    OleDbHelper.ExecuteNonQuery(oledbTrans2, CommandType.StoredProcedure, "spAddEditVeriOtherDetailsBV", paramCreditCardOtherDtl);
                    if (Convert.ToInt32(paramCreditCardOtherDtl[109].Value) == 1)
                    {
                        sRetVal = " Record added successfully .";

                    }
                    else if (Convert.ToInt32(paramCreditCardOtherDtl[109].Value) == 2)
                    {
                        sRetVal = "Record updated successfully.";
                    }
                    else
            ...
            try
            {
                ...
                sSql = "";
                OleDbParameter[] paramCreditCardVerDtl = new OleDbParameter[15];
                ...
                else
                {
                    ...
                    paramCreditCardVerDtl[8] = new OleDbParameter("@SupervisorRemark", OleDbType.VarChar, 3000);
                    ...
                    paramCreditCardVerDtl[13] = new OleDbParameter("@Reason", OleDbType.VarChar,100);
                    paramCreditCardVerDtl[13].Value = Reason; 
                    paramCreditCardVerDtl[14] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                    paramCreditCardVerDtl[14].Direction = ParameterDirection.Output;


                    OleDbHelper.ExecuteNonQuery(oledbTrans3, CommandType.StoredProcedure, "spAddEditVeriDetailsBV", paramCreditCardVerDtl);
                    if (Convert.ToInt32(paramCreditCardVerDtl[14].Value) == 1)
                    {
                        sRetVal = " Record added successfully.";

                    }
                    else if (Convert.ToInt32(paramCreditCardVerDtl[14].Value) == 2)
                    {
                        sRetVal = " Record updated successfully .";
                    }
                    else
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////
            /////////////////////////////////////////////start Mashrec bank code santosh/////////////////////////
            ////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            try
            {
                ...
                sSql = "";
                OleDbParameter[] paramCreditCardVerDtl = new OleDbParameter[41];
                paramCreditCardVerDtl[0] = new OleDbParameter("@OperationType", OleDbType.VarChar, 10);
                if (!(strTableToEditArray[4].Equals("1")))
                {
                    paramCreditCardVerDtl[0].Value = "ADD";
                ...
                paramCreditCardVerDtl[1] = new OleDbParameter("@Case_Id", OleDbType.VarChar, 15);
                paramCreditCardVerDtl[1].Value = CaseId;
                paramCreditCardVerDtl[2] = new OleDbParameter("@VERIFICATION_TYPE_ID", OleDbType.VarChar, 15);
                paramCreditCardVerDtl[2].Value = VerificationType;
                paramCreditCardVerDtl[3] = new OleDbParameter("@Emirates", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[3].Value = Emirates;
                paramCreditCardVerDtl[4] = new OleDbParameter("@Pobox_No", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[4].Value = PoboxNo;
                paramCreditCardVerDtl[5] = new OleDbParameter("@Signboard_Door", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[5].Value = SignboardDoor;
                paramCreditCardVerDtl[6] = new OleDbParameter("@Mode_Salary", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[6].Value = ModeSalary;
                paramCreditCardVerDtl[7] = new OleDbParameter("@Busi_To", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[7].Value = BusiTo;
                paramCreditCardVerDtl[8] = new OleDbParameter("@Comp_Clients", OleDbType.VarChar, 750);
                paramCreditCardVerDtl[8].Value = CompClients;
                paramCreditCardVerDtl[9] = new OleDbParameter("@Comp_Bank", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[9].Value = CompBank;
                paramCreditCardVerDtl[10] = new OleDbParameter("@Office1", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[10].Value = Office1;
                paramCreditCardVerDtl[11] = new OleDbParameter("@Office2", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[11].Value = Office2;
                paramCreditCardVerDtl[12] = new OleDbParameter("@Office3", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[12].Value = Office3;
                paramCreditCardVerDtl[13] = new OleDbParameter("@Office4", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[13].Value = Office4;
                paramCreditCardVerDtl[14] = new OleDbParameter("@Date_Join", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[14].Value = DateJoin;
                paramCreditCardVerDtl[15] = new OleDbParameter("@Applicant_Report", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[15].Value = ApplicantReport;
                paramCreditCardVerDtl[16] = new OleDbParameter("@Desig", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[16].Value = Desig;
                paramCreditCardVerDtl[17] = new OleDbParameter("@Applicant_Owner", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[17].Value = ApplicantOwner;
                paramCreditCardVerDtl[18] = new OleDbParameter("@Yes_Relation", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[18].Value = YesRelation;
                paramCreditCardVerDtl[19] = new OleDbParameter("@Details_Verified", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[19].Value = DetailsVerified;
                paramCreditCardVerDtl[20] = new OleDbParameter("@Loan_Number", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[20].Value = LoanNumber;
                paramCreditCardVerDtl[21] = new OleDbParameter("@Ref_Tel_Number", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[21].Value = RefTelNumber;
                paramCreditCardVerDtl[22] = new OleDbParameter("@Ref_Cont", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[22].Value = RefCont;
                paramCreditCardVerDtl[23] = new OleDbParameter("@Area", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[23].Value = Area;
                paramCreditCardVerDtl[24] = new OleDbParameter("@Emirate_1", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[24].Value = Emirate1;
                paramCreditCardVerDtl[25] = new OleDbParameter("@Loan_Appli", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[25].Value = LoanAppli;
                paramCreditCardVerDtl[26] = new OleDbParameter("@Location", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[26].Value = Location;
                paramCreditCardVerDtl[27] = new OleDbParameter("@VisitingCard", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[27].Value = VisitingCard;
                paramCreditCardVerDtl[28] = new OleDbParameter("@BusinessOwnership", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[28].Value = BusinessOwnership;
                paramCreditCardVerDtl[29] = new OleDbParameter("@SeparateOfficeArea", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[29].Value = SeparateOfficeArea;
                paramCreditCardVerDtl[30] = new OleDbParameter("@CommentsOnBusinessActivities", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[30].Value = CommentOnBusinessActivity;
                paramCreditCardVerDtl[31] = new OleDbParameter("@desig1", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[31].Value = Sponser1Designation;
                paramCreditCardVerDtl[32] = new OleDbParameter("@desig2", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[32].Value = Sponser2Designation;
                paramCreditCardVerDtl[33] = new OleDbParameter("@Fav_Place", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[33].Value = FavouritePlace;
                paramCreditCardVerDtl[34] = new OleDbParameter("@Ref_UAE", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[34].Value = ReferenceNoInUAE;
                paramCreditCardVerDtl[35] = new OleDbParameter("@Other_Bank", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[35].Value = AnyOtherBankCcFinancialfacility;
                paramCreditCardVerDtl[36] = new OleDbParameter("@Vehical_Own", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[36].Value = VehicalOwned;
                paramCreditCardVerDtl[37] = new OleDbParameter("@Vehical_Fin", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[37].Value = VehicalFinanced;
                paramCreditCardVerDtl[38] = new OleDbParameter("@Breakup_Emp", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[38].Value = BreakUpNumberOfEmployeesWithDesignations;
                paramCreditCardVerDtl[39] = new OleDbParameter("@Premise_Share", OleDbType.VarChar, 500);
                paramCreditCardVerDtl[39].Value = IsOfficePremisesSharedAnyOtherOffice;
                paramCreditCardVerDtl[40] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                paramCreditCardVerDtl[40].Direction = ParameterDirection.Output;

                OleDbHelper.ExecuteNonQuery(oledbTrans4, CommandType.StoredProcedure, "spAddEditVeriDetailsBV_Soc", paramCreditCardVerDtl);
                if (Convert.ToInt32(paramCreditCardVerDtl[40].Value) == 1)
                {
                    sRetVal = " Record added successfully.";

                }
                else if (Convert.ToInt32(paramCreditCardVerDtl[40].Value) == 2)
                {
                    sRetVal = " Record updated successfully .";
                }
                else
            ...
            ///////////////////////////////////end code////////////////////////////////////
            //oledbRead.Close();hemantg@india.com, dematadmin@icicibank.com
            /////////////////////////////////////////////////////////////////////////////////////////////
            /////////////////////////////////////////////////////////////////////////////////////////////
            /////--------CPV_CC_CASE_DETAILS-------------------
           ...
           // }
            ...
            try
            {
                ...
                paramDeleteAttempt[5] = new OleDbParameter("@SubRemark", OleDbType.VarChar, 255);
                paramDeleteAttempt[5].Value = SubRemark; 
                paramDeleteAttempt[6] = new OleDbParameter("@VerficationTypeID", OleDbType.VarChar, 15);
                paramDeleteAttempt[6].Value = VerficationTypeID;
                ...
                if (arrAttempt.Count > 0)
                {
                    foreach (ArrayList item in arrAttempt)
                    {
                        ...
                        OleDbParameter[] paramAttempt = new OleDbParameter[8];
                        ...
                        paramAttempt[5] = new OleDbParameter("@SubRemark", OleDbType.VarChar, 255);
                        paramAttempt[5].Value = SubRemark; 
                        paramAttempt[6] = new OleDbParameter("@VerficationTypeID", OleDbType.VarChar, 15);
                        paramAttempt[6].Value = VerficationTypeID;
                        paramAttempt[7] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                        paramAttempt[7].Direction = ParameterDirection.Output;
      ...
      string strError ="";
        try
        {
            ...
            try
            {
                ...
                OleDbParameter[] paramCCVerDesc = new OleDbParameter[101];
                paramCCVerDesc[0] = new OleDbParameter("@OperationType", OleDbType.VarChar, 10);
                if (!(strTableToEditArray[0].Equals("1")))
                {
                    paramCCVerDesc[0].Value = "ADD";
                ...
                else
                {
                    ...
                    paramCCVerDesc[98] = new OleDbParameter("@NAME_SOCIETY_BOARD", OleDbType.VarChar, 50);
                    paramCCVerDesc[98].Value = NameDisplayedInNameBoardOfTheSociety;

                    paramCCVerDesc[99] = new OleDbParameter("@Nature_Business", OleDbType.VarChar, 50);
                    paramCCVerDesc[99].Value = NatureBusiness;
                  
                    ////paramCCVerDesc[98] = new OleDbParameter("@StandLive", OleDbType.VarChar, 100);
                    ////paramCCVerDesc[98].Value = StandLive;
                    ////paramCCVerDesc[99] = new OleDbParameter("@TypeProof", OleDbType.VarChar, 100);
                    ////paramCCVerDesc[99].Value = TypeProof;
                    paramCCVerDesc[100] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                    paramCCVerDesc[100].Direction = ParameterDirection.Output;
                ...
                if (Convert.ToInt32(paramCCVerDesc[100].Value) == 1)
                {
                    sRetVal = "Record added successfully.";

                }
                else if (Convert.ToInt32(paramCCVerDesc[100].Value) == 2)
                {
                    sRetVal = "Record updated successfully.";
                }
                else
            ...
            try
            {
                ...
                else
                {
                    ...
                    /////////add by kamal matekar-femu

                    paramCCVerDesc1[24] = new OleDbParameter("@NEIGHBOUR_ADD_2", OleDbType.VarChar, 25);
                    paramCCVerDesc1[24].Value = Neighbour2Add;

                    paramCCVerDesc1[25] = new OleDbParameter("@MAILING_ADDRESS", OleDbType.VarChar, 100);
                    paramCCVerDesc1[25].Value = Email;

                    paramCCVerDesc1[26] = new OleDbParameter("@AVG_MONTH_TURNOVER", OleDbType.VarChar, 15);
                    paramCCVerDesc1[26].Value = AvgMonthTurnOver;

                    paramCCVerDesc1[27] = new OleDbParameter("@BUSINESS_STOCK_SEEN", OleDbType.VarChar, 20);
                    ...
                    ////paramCCVerDesc1[25] = new OleDbParameter("@AuthoSign", OleDbType.VarChar, 100);
                    ////paramCCVerDesc1[25].Value = AuthoSign;
                    ////paramCCVerDesc1[26] = new OleDbParameter("@VeriScore", OleDbType.VarChar, 100);
                    ////paramCCVerDesc1[26].Value = VeriScore;
            ...
            try
            {
                ...
                else
                {
                   ...
                   //////////////added by kamal matekar for femu
                    ...
                    paramCreditCardOtherDtl[12].Value = AddressApporch;
                    paramCreditCardOtherDtl[13] = new OleDbParameter("@Applicant_lives_with", OleDbType.VarChar, 50);
                    paramCreditCardOtherDtl[13].Value = Applicantliveswith;
                    paramCreditCardOtherDtl[14] = new OleDbParameter("@Additional_Comments", OleDbType.VarChar, 1000);
                    ...
                    ////////////////ended by kamal matekar for femu
            ...
            {
                sSql = "";
                OleDbParameter[] paramCreditCardVerDtl = new OleDbParameter[27];
                paramCreditCardVerDtl[0] = new OleDbParameter("@OperationType", OleDbType.VarChar, 10);
                if (!(strTableToEditArray[3].Equals("1")))
                {
                    paramCreditCardVerDtl[0].Value = "ADD";
                ...
                else
                {
                    ...
                    paramCreditCardVerDtl[9] = new OleDbParameter("@SupervisorRemark", OleDbType.VarChar, 3000);
                    ...
                    paramCreditCardVerDtl[16].Value = Reason;

                    paramCreditCardVerDtl[17] = new OleDbParameter("@SpouseOccu", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[17].Value = SpouseOccu;
                    paramCreditCardVerDtl[18] = new OleDbParameter("@SpouseName", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[18].Value = SpouseName;
                    paramCreditCardVerDtl[19] = new OleDbParameter("@CarPark", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[19].Value = CarPark;
                    paramCreditCardVerDtl[20] = new OleDbParameter("@EntranceMotorable", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[20].Value = EntranceMotorable;
                    paramCreditCardVerDtl[21] = new OleDbParameter("@ExteriorPremises", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[21].Value = ExteriorPremises;
                    paramCreditCardVerDtl[22] = new OleDbParameter("@ResidenceInternal", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[22].Value = ResidenceInternal;

                    paramCreditCardVerDtl[23] = new OleDbParameter("@Flooring", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[23].Value = Flooring;
                    paramCreditCardVerDtl[24] = new OleDbParameter("@Roofing", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[24].Value = Roofing;
                    paramCreditCardVerDtl[25] = new OleDbParameter("@StanLiving", OleDbType.VarChar, 500);
                    paramCreditCardVerDtl[25].Value = StanLiving; 
                    paramCreditCardVerDtl[26] = new OleDbParameter("@MessageNo", OleDbType.Integer);
                    paramCreditCardVerDtl[26].Direction = ParameterDirection.Output;


                    OleDbHelper.ExecuteNonQuery(oledbTrans3, CommandType.StoredProcedure, "spAddEditCCVeriDetailsRV", paramCreditCardVerDtl);

                if (Convert.ToInt32(paramCreditCardVerDtl[26].Value) == 1)
                {
                    sRetVal = "Record added successfully.";

                }
                else if (Convert.ToInt32(paramCreditCardVerDtl[26].Value) == 2)
                {
                    sRetVal = "Record updated successfully.";
                }
                else
