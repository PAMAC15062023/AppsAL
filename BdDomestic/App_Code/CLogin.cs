...
public class CLogin
{
    ...
    private string strMFA_applicable;
    ...
    public string MFA_applicable
    {
        get { return strMFA_applicable; }
        set { strMFA_applicable = value; }
    }
    public void LogInfo()
    {
    ...
    public String UserAuthenticate()
    {
        ...
        if (o != null)
        {
            sqlUser = "SELECT UR.ROLE_ID, EM.FIRSTNAME + ' ' + EM.LASTNAME AS FLNAME,(Select MFA_applicable from MFA_Applicability_tbl) as MFA_applicable " +
            ...
            while (drHierarchy.Read())
            {
                if (count == 0)
                {
                    ...
                    strMFA_applicable = Convert.ToString(drHierarchy["MFA_applicable"]);
                }
                else
                {
