...
public partial class QueryBuilder_QC_CentreClient_MIS : System.Web.UI.Page
{
    DateTime dtfrom;
    DateTime dtto;
    string Fdate;
    ...
    protected DataTable getcases()
    {
        ...
        qry = "EXEC Get_QC_Case_Mis '" + ddlCenter.SelectedValue.ToString() + "','" + txtFromDate.Text + "', '" + txtToDate.Text + "'";
