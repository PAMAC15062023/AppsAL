<%@ Page Language="C#" MasterPageFile="~/CPV/Cellular/CEL_MasterPage.master" AutoEventWireup="true" Theme="SkinFile" CodeFile="CEL_QC_FEAssignment.aspx.cs" Inherits="CPV_Cellular_CEL_QC_FEAssignment" Title="Cellular QC FE Assignment" %>
...
<fieldset><legend class="FormHeading">QC FE Assignment</legend>
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <tr><td >Date</td><td style="width: 2px">:</td><td>
        ...
        <td>Verification Type</td><td style="width: 2px">:</td><td>
                <asp:DropDownList ID="ddlType" runat="server" DataSourceID="sdsVeriType" DataTextField="VERIFICATION_TYPE_CODE" DataValueField="VERIFICATION_TYPE_ID" AutoPostBack="false" SkinID="ddlSkin" OnDataBound="ddlType_DataBound">
                </asp:DropDownList></td>
                <td>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlSearchFE" runat="server" DataSourceID="sdsSearchFE"
                        DataTextField="FULLNAME" DataValueField="FE_ID" SkinID="ddlSkin" OnDataBound="ddlSearchFE_DataBound">
                    </asp:DropDownList></td>
    ...
    <tr>
        ...
        <asp:DropDownList ID="ddlFromPin" runat="server" DataSourceID="sdsPincode" DataTextField="PINCODE" DataValueField="PINCODE" SkinID="ddlSkin" OnDataBound="ddlFromPin_DataBound">
        </asp:DropDownList></td>
        <td >To Pincode</td><td style="width: 2px">:</td><td><asp:DropDownList ID="ddlToPin" runat="server" DataSourceID="sdsPincode" DataTextField="PINCODE" DataValueField="PINCODE" SkinID="ddlSkin" OnDataBound="ddlToPin_DataBound">
        </asp:DropDownList></td>
        <td>
        ...
        <td >FE Name<span style="color:Red;">*</span></td><td style="width: 2px">:</td><td>
            <asp:DropDownList ID="ddlFE" runat="server" DataSourceID="sdsFE" DataTextField="FULLNAME" DataValueField="FE_ID" SkinID="ddlSkin" ValidationGroup="vgrpFE" OnDataBound="ddlFE_DataBound">
            </asp:DropDownList></td>   
    ...
    <tr><td>        
        <asp:GridView ID="gvFEAssignmentCases" runat="server" DataSourceID="sdsGV" OnSorting="gvFEAssignmentCases_Sorting"  OnDataBound="gvFEAssignmentCases_DataBound" Width="100%" SkinID="gridviewSkin">           
            <Columns>
            <asp:TemplateField>
                <HeaderTemplate>
    ...
    <tr><td align="right" style="height: 26px"><asp:Button ID="btnAssign1" runat="server" SkinId="btnAssingSkin" OnClick="btnAssign_Click" ValidationGroup="vgrpFE" /></td></tr>
     ...
     <asp:SqlDataSource ID="sdsVeriType" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>" ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE_CODE FROM VERIFICATION_TYPE_MASTER WHERE (VERIFICATION_TYPE_ID IN (26)) AND (PARENT_TYPE_CODE = 'VV')"></asp:SqlDataSource>
    ...
    &nbsp;&nbsp;
        ...
        <asp:RequiredFieldValidator ID="valfe" runat="server" ErrorMessage="Please select FE Name"  Display="None" SetFocusOnError="True" ValidationGroup="vgrpFE" ControlToValidate="ddlFE"></asp:RequiredFieldValidator>
</asp:Content>
