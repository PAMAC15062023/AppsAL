...
public partial class CC_CC_QCResidenceVerification : System.Web.UI.Page
{
    string verificationType = "QRV";
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (Context.Request.QueryString["CaseID"] != null && Context.Request.QueryString["CaseID"] != "" && Context.Request.QueryString["VerTypeId"] != null && Context.Request.QueryString["VerTypeId"] != "")
                {
                    ...
                    if ((sVerifyTypeId == "25") || (sVerifyTypeId == "QRV"))  //for RV
                        lblHead.Text = "QC Residence Verification";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (iCount == 1)
        {
            Response.Redirect("CC_QCVerificationView.aspx?Msg=" + lblMsg.Text);
        }
    }
    ...
    {
        Response.Redirect("CC_QCVerificationView.aspx");
    }
