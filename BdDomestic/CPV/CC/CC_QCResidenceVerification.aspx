...
AutoEventWireup="true" CodeFile="CC_QCResidenceVerification.aspx.cs" Inherits="CC_CC_QCResidenceVerification"%>
...
<%--end santosh--%>
       ...
       <asp:Panel ID="PnlDetailstakenbytpc" runat="server"  Width="100%" Visible="false">
            ...
            <td class="TDWidth">
                ...
                <td style="width:2%">:</td>
                <td>
                <asp:TextBox ID="TxtDetailstakenbytpc" runat="server"  SkinID="txtSkin" MaxLength="50"></asp:TextBox>
                </td>                
            </tr>
            </table>
         </asp:Panel>
       ...
       <asp:Panel ID="PnlRemarkSociey" runat="server"  Width="80%" Visible="false">
            ...
            <td class="TDWidth">
                ...
                <td style="width:2%">:</td>
                <td>
                <asp:TextBox ID="TxtRemarkSociey" runat="server" Width="100%" SkinID="txtSkin" MaxLength="50"></asp:TextBox>
                </td>                
            </tr>
            </table>
         </asp:Panel>
    ...
    <asp:Label SkinID="lblSkin" ID="lblRatingHead" runat="server" ForeColor="blue"  Text="RATING" Font-Bold="True"></asp:Label></td>
         ...
         <asp:Panel ID="pnlAddConfirmation" runat="server"  Width="100%" Visible="false">
           ...
           <asp:Panel ID="pnlEmpStatus1" runat="server"  Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblEmpStatus1" runat="server"  Text="Employment status-1"></asp:Label>
                </td><td style="width:2%">:</td>
                <td >
                    <asp:TextBox SkinID="txtSkin" ID="txtEmpStatus1" runat="server"  MaxLength="50"></asp:TextBox>
                </td>
                </tr>
               </table>
           </asp:Panel>   
           ...
           <asp:Panel ID="pnlEmpStatus2" runat="server"  Width="100%" Visible="false">
            ...
            <asp:Panel ID="pnlProductName" runat="server"  Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblProductName" runat="server"  Text="Product Name"></asp:Label>
                </td><td style="width:2%">:</td>
                <td >
        ...
        <asp:Panel ID="pnlApplicantLivesWith" runat="server" Width="100%" Visible="false">
          <table cellpadding="0" cellspacing="0" border="0" id="tblApplicantLivesWith" style="width:100%" runat="server">
           ...
           <asp:Panel ID="pnlResidenceAddressUpdatedbyFE" runat="server" Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblResidenceAddressUpdatedbyFE" runat="server" Text="Residence Address"></asp:Label>
                </td><td style="width:2%">:</td>
                <td  >
                    <asp:TextBox SkinID="txtSkin"  ID="txtResidenceAddressUpdatedbyFE" runat="server" MaxLength="15"></asp:TextBox>
                </td>
                </tr>
               </table>
           </asp:Panel>
         ...
         <asp:Panel ID="pnlRelationshipWithBank" runat="server" Width="100%" Visible="false">
                ...
                <td  >
                    <asp:TextBox SkinID="txtSkin"  ID="txtRelationshipWithBank" runat="server" MaxLength="15"></asp:TextBox>
                </td>
                </tr>
               </table>
           </asp:Panel>
    ...
    <td>                     
         ...
         <asp:SqlDataSource ID="sdsOutcome" runat="server"  ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
              ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>"  
    ...
    <td >
        <asp:TextBox SkinID="txtSkin" ID="txtDeclineReason" runat="server"  Width="80%" MaxLength="255"></asp:TextBox>
    </td>
    </tr>
   </table>
...
<td style="width:2%">:</td>
<td>
<asp:TextBox SkinID="txtSkin"   MaxLength="700" ID="txtSupervisorRemark" runat="server"  Width="80%"></asp:TextBox>
</td>
</tr>
<tr>
<td colspan="2">
...
<table>
    ...
    <asp:SqlDataSource ID="sdsFE" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
        ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SubStatus_Master;1" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
</fieldset>
</td></tr></table>
</asp:Content>