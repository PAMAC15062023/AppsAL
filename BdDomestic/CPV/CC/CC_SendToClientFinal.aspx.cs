...
public partial class CPV_CC_CC_SendToClientFinal : System.Web.UI.Page
{
            ...
            for (Int32 j = 0; j < gvSendTat.Rows.Count; j++)
            {
                ...
                if (Ch.Checked)
                {
                    ...
                    //Calling Tat Calculation Function...
                     objclient.TATHRS = objclient.CalulateTATHrs(fdate, strSendDate, Session["ClientId"].ToString(), Session["CentreId"].ToString(), "CPV_CC_CASE_DETAILS");                    
                   ...
                   // objclient.TATHRS = hdnTat.Value.ToString();
                    ...
                    try
                    {
                        objclient.insertGridFields(strSendDate, hdnWithinTat.Value, "CPV_CC_CASE_DETAILS");
                        //lblMsg.Visible = true;
