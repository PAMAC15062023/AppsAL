...
<table border="0" cellpadding="1" cellspacing="0" width="99%" id="TABLE2"> 
                  ...
                  <Columns>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateFieldResource2"> 
                        <ItemTemplate>
                            ...
                            CommandName="DeleteCC" meta:resourcekey="lnkDeleteCreditCardResource1" Enabled="False" Visible="False" ><img src="../../Images/icon_delete.gif" alt="Delete" style="border:0" />
                            </asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle Width="20px" />
                    </asp:TemplateField>
 ...
 <tr>
 <td colspan="9">
 <asp:SqlDataSource ID="sdsCreditCard" runat="server" ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>"
