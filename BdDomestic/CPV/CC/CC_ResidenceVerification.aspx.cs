...
public partial class CC_CC_ResidenceVerification : System.Web.UI.Page
{
            ...
            try
            {
                ...
                if ((Session["ClientId"].ToString().Trim() == "1013") || (Session["ClientId"].ToString().Trim() == "101154")) //101154
                {
                    if (Context.Request.QueryString["CaseID"] != null && Context.Request.QueryString["CaseID"] != "" && Context.Request.QueryString["VerTypeId"] != null && Context.Request.QueryString["VerTypeId"] != "")
                    {
                        ...
                        if (Context.Request.QueryString["VerTypeId"] == "1")
                        {
                            Response.Redirect("CC_ResidenceVerification_GESBI.aspx?CaseId=" + Context.Request.QueryString["CaseID"] + "&VerTypeId=" + Context.Request.QueryString["VerTypeId"] + "&Mode=" + strMode, false);
                        }
                    }
                }
                #endregion
                //End Line -Avinash Wankhede Dated 15 June 2009
                ...
                if (Context.Request.QueryString["CaseID"] != null && Context.Request.QueryString["CaseID"] != "" && Context.Request.QueryString["VerTypeId"] != null && Context.Request.QueryString["VerTypeId"] != "")
                {
                    ...
                    if (oledbCaseDescRead.Read())
                    {
                        ...
                        ddlStandLive.SelectedValue = oledbCaseDescRead["Door_Lock"].ToString();
                        ddlTypeProof.SelectedValue = oledbCaseDescRead["Door_colour"].ToString();  
                        ...
                        /////////////added by kamal matekar femu
                        txtNameontheSocietyAddressboard.Text = oledbCaseDescRead["NAME_SOCIETY_BOARD"].ToString();

                        string sNatureofBusiness = oledbCaseDescRead["Nature_Business"].ToString();
                        if (sNatureofBusiness.Trim() != "")
                        {
                            string[] arrNatureofBusiness = sNatureofBusiness.Split(':');
                            if (arrNatureofBusiness.Length > 0)
                            {
                                if (arrNatureofBusiness[0].ToString() == "Others" && arrNatureofBusiness.Length > 1)
                                {
                                    DDLNatureOfBusiness.SelectedValue = "Others";
                                    txtNatureOfBusiness.Text = arrNatureofBusiness[1].ToString();
                                }
                                else
                                {
                    ...
                    if (oledbCaseDesc1Read.Read())
                    {
                        ...
                        txtAuthoSign.Text = oledbCaseDesc1Read["Job_Desc"].ToString();
                        txtVeriScore.Text = oledbCaseDesc1Read["Job_Type"].ToString();
                        txtNameTPC2.Text = oledbCaseDesc1Read["neighbour_name_2"].ToString();   
                    ...
                    if (oledbCaseVerOtherDtlRead.Read())
                    {
                        ...
                        string sApplicantLivesWith = oledbCaseVerOtherDtlRead["Applicant_lives_with"].ToString();
                        if (sApplicantLivesWith.Trim() != "")
                        {
                            string[] arrApplicantLiveswith = sApplicantLivesWith.Split(':');
                            if (arrApplicantLiveswith.Length > 0)
                            {
                                if (arrApplicantLiveswith[0].ToString() == "Others" && arrApplicantLiveswith.Length > 1)
                                {
                                    ddlApplicantLivesWith.SelectedValue = "Others";
                                    txtApplicantLivesWithOthers.Text = arrApplicantLiveswith[1].ToString();
                                }
                                else
                                {
                                    ddlApplicantLivesWith.SelectedValue = arrApplicantLiveswith[0].ToString();
                                }
                            }
                        }

                        txtResidenceAddressUpdatedbyFE.Text = oledbCaseVerOtherDtlRead["Residence_Address_updatedbyFE"].ToString();
                        txtAddressOfCompany.Text = oledbCaseVerOtherDtlRead["Address_of_Company"].ToString();
                        txtRelationshipWithBank.Text = oledbCaseVerOtherDtlRead["Relationship_With_Bank"].ToString();
                        txtRoofType.Text = oledbCaseVerOtherDtlRead["Roof_Type"].ToString();
                        txtNumberOfRooms.Text = oledbCaseVerOtherDtlRead["Number_of_Rooms"].ToString();
                        txtFamilySeen.Text = oledbCaseVerOtherDtlRead["Family_Seen"].ToString();
                        ddlNamePlateonDoor.SelectedValue = oledbCaseVerOtherDtlRead["NAME_PLATE"].ToString();
                    ...
                    if (oledbCaseVerDtlRead.Read())
                    {
                        ...
                        txtSpouseOccu.Text = oledbCaseVerDtlRead["Spouse_Occu"].ToString();
                        txtSpouseName.Text = oledbCaseVerDtlRead["Spouse_Name"].ToString();
                        ddlCarPark.SelectedValue = oledbCaseVerDtlRead["Car_Park"].ToString();
                        ddlEntranceMotorable.SelectedValue = oledbCaseVerDtlRead["Entrance_Motorable"].ToString();
                        ddlExteriorPremises.SelectedValue = oledbCaseVerDtlRead["Exterior_Premises"].ToString();
                        ddlResidenceInternal.SelectedValue = oledbCaseVerDtlRead["Residence_Internal"].ToString();
                        txtFlooring.Text = oledbCaseVerDtlRead["Flooring"].ToString();
                        ddlRoofing.SelectedValue = oledbCaseVerDtlRead["Roofing"].ToString();
                        ddlStanLiving.SelectedValue = oledbCaseVerDtlRead["StanLiving"].ToString();
                    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            objCCVer.StandLive = ddlStandLive.SelectedItem.Text.Trim();
            objCCVer.TypeProof = ddlTypeProof.SelectedItem.Text.Trim();
            ...
            //////added by kamal matekar
            objCCVer.NameDisplayedInNameBoardOfTheSociety = txtNameontheSocietyAddressboard.Text.Trim();

            if (DDLNatureOfBusiness.SelectedItem.Text.Trim() == "Others(specify)")
                objCCVer.NatureBusiness = "Others(specify)" + ":" + txtNatureOfBusiness.Text.Trim();
            else
            ...
            objCCVer.VerificationConductAt = txtVerificationContactAt.Text.Trim();
            objCCVer.AuthoSign = txtAuthoSign.Text.Trim();
            objCCVer.VeriScore = txtVeriScore.Text.Trim();
            ...
            objCCVer.SpouseOccu = txtSpouseOccu.Text.Trim();
            objCCVer.SpouseName = txtSpouseName.Text.Trim();
            objCCVer.CarPark = ddlCarPark.SelectedValue.ToString();
            objCCVer.EntranceMotorable = ddlEntranceMotorable.SelectedValue.ToString();
            objCCVer.ExteriorPremises = ddlExteriorPremises.SelectedValue.ToString();
            objCCVer.ResidenceInternal = ddlResidenceInternal.SelectedValue.ToString();
            objCCVer.Flooring = txtFlooring.Text.Trim();
            objCCVer.Roofing = ddlRoofing.SelectedValue.ToString();
            objCCVer.StanLiving = ddlStanLiving.SelectedValue.ToString();    


            /////add by kamal matekar for femu --CPV_CC_VERI_OTHER_DETAILS
            ...
            if (ddlApplicantLivesWith.SelectedItem.Text.Trim() == "Others")
                objCCVer.Applicantliveswith = "Others" + ":" + txtApplicantLivesWithOthers.Text.Trim();
            else
                objCCVer.Applicantliveswith = ddlApplicantLivesWith.SelectedItem.Text.Trim();

            objCCVer.ResidenceAddress = txtResidenceAddressUpdatedbyFE.Text.Trim();
            objCCVer.Addressofcompany = txtAddressOfCompany.Text.Trim();

            objCCVer.RelationshipwithBank = txtRelationshipWithBank.Text.Trim();
            objCCVer.RoofType = txtRoofType.Text.Trim();
            objCCVer.NumberofRooms = txtNumberOfRooms.Text.Trim();
            objCCVer.FamilySeen = txtFamilySeen.Text.Trim();
            objCCVer.Nameplate = ddlNamePlateonDoor.SelectedItem.Text.Trim();
    ...
    {
        txtNewInfoFERemark.TextMode = TextBoxMode.MultiLine;
    ...
    private void ISEditFalse()
    {
        ...
        ddlStandLive.Enabled = false;
        ddlTypeProof.Enabled = false;  
        ...
        ddlRoofing.Enabled = false;
        ddlStanLiving.Enabled = false;
        ////////////////////------------------------
        ////START Attempt Details
