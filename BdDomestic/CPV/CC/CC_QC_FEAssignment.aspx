<%@ Page Language="C#" MasterPageFile="~/CPV/CC/CC_MasterPage.master" AutoEventWireup="true" CodeFile="CC_QC_FEAssignment.aspx.cs" Inherits="CPV_CC_CC_QC_FEAssignment" Title="PAMAC Online" Theme="SkinFile"%>
...
<tr><td style="padding-left:10px; height: 381px;">
<fieldset><legend class="FormHeading">QC FE Assignment</legend>
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <tr><td >Date</td><td style="width: 2px">:</td><td>
        ...
        <td>Verification Type</td><td style="width: 2px">:</td><td>
                ...
                <td>
                    ...
                    <td><asp:Button ID="btnSearch" runat="server" ValidationGroup="FEAssign" OnClick="btnSearch_Click" SkinID="btnSearchSkin" /></td>
            </tr>
            <tr><td></td></tr>
    ...
    <tr>
        ...
        <td>
                <asp:Button ID="btnSearchFE" runat="server" OnClick="btnSearchFE_Click" SkinID="btnSearchSkin" /></td>
        <td >FE Name<span style="color:Red;">*</span></td><td style="width: 2px">:</td><td>
            <asp:DropDownList ID="ddlFE" runat="server" DataSourceID="sdsFE" DataTextField="FULLNAME" DataValueField="FE_ID" SkinID="ddlSkin" OnDataBound="ddlFE_DataBound">
            </asp:DropDownList></td>   
            <td align="right"><asp:Button ID="btnAssign" runat="server" OnClick="btnAssign_Click" ValidationGroup="vgrpFE" SkinID="btnAssingSkin" /></td>         
        </tr>
    </table></td></tr>  
    <tr><td>        
        <asp:GridView ID="gvFEAssignmentCases" runat="server" OnPageIndexChanging="gvFEAssignmentCases_PageIndexChanging" OnSorting="gvFEAssignmentCases_Sorting" OnDataBound="gvFEAssignmentCases_DataBound" DataSourceID="sdsGV" Width="100%" SkinID="gridviewSkin">           
            <Columns>
            <asp:TemplateField>
                <HeaderTemplate>
    ...
    <tr><td align="right"><asp:Button ID="btnAssign1" runat="server" OnClick="btnAssign_Click" ValidationGroup="vgrpFE" SkinID="btnAssingSkin" /></td></tr>
    </table>
    </fieldset>
    </td></tr>
</table>
     ...
     SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE_CODE FROM VERIFICATION_TYPE_MASTER WHERE (VERIFICATION_TYPE_ID IN (25,26)) AND (PARENT_TYPE_CODE = 'VV')"></asp:SqlDataSource>
