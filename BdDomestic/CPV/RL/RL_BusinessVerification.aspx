...
<tr><td></td><td>
 <asp:Table ID="tblBusiVerification" runat="server" Width="100%">
   ...
   <asp:Panel ID="pnlLanNo" runat="server" Width="100%" Visible="false">
     ...
     <%--add by santosh as per new requirmet--%>
    ...
    <asp:Panel ID="pnlCustomerSeen" runat="server" Width="100%" Visible="false">
     ...
     <asp:Panel ID="pnlVehiOwn" runat="server" Width="100%" Visible="false">
        ...
        <tr>
        <td class="TDWidth"  >
            <asp:Label SkinID="lblSkin" ID="lblVehiOwn" runat="server" Text="Vehicles owned:"></asp:Label>
            </td><td style="width:2%">:</td>
            <td>
         ...
         <asp:Panel ID="pnlBussPrem" runat="server" Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblBussPrem" runat="server" Text="Business Premises:"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="tblRefName" style="width:100%" runat="server">
            <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblRefName" runat="server" Text="Name of referance no 1"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
      ...
      <asp:Panel ID="pnlRefAdd" runat="server" Width="100%" Visible="false">
        <table cellpadding="0" cellspacing="0" border="0" id="tblRefAdd" style="width:100%" runat="server">
            <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblRefAdd" runat="server" Text="Address of referance no 1"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
      ...
      <asp:Panel ID="pnlMonthTurnover" runat="server" Width="100%" Visible="false">
        <table cellpadding="0" cellspacing="0" border="0" id="tblMonthTurnover" style="width:100%" runat="server">
            ...
            <td class="TDWidth"  >
                ...
                <td>
                <asp:TextBox SkinID="txtSkin" Width="80%" ID="txtMonthTurnover" runat="server"></asp:TextBox>
                </td>
                </tr>
                </table>
      </asp:Panel>    
      <asp:Panel ID="pnlNumberBeds" runat="server" Width="100%" Visible="false">
        <table cellpadding="0" cellspacing="0" border="0" id="tblNumberBeds" style="width:100%" runat="server">
            <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblNumberBeds" runat="server" Text="Number of beds(if nursing home):"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
      ...
      <asp:Panel ID="pnlNeighChek" runat="server" Width="100%" Visible="false">
        <table cellpadding="0" cellspacing="0" border="0" id="tblNeighChek" style="width:100%" runat="server">
            <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblNeighChek" runat="server" Text="Neighbourthood check with closest chemist:(name and address):"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
       ...
       <asp:Panel ID="pnlClinicYear" runat="server" Width="100%" Visible="false">
        <table cellpadding="0" cellspacing="0" border="0" id="tblClinicYear" style="width:100%" runat="server">
            <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblClinicYear" runat="server" Text="How long has the clinic been existing:"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
      ...
      <asp:Panel ID="pnlSeparateResi" runat="server" Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblSeparateResi" runat="server" Text="If residence cum office, then separate office area?"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <asp:Panel ID="pnlSeparateFactory" runat="server" Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblSeparateFactory" runat="server" Text="Is there a separate factory?"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <asp:Panel ID="pnlSeparateEntrance" runat="server" Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblSeparateEntrance" runat="server" Text="Separate entrances seen to office and residence?"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <asp:Panel ID="pnlSeparateOffice" runat="server" Width="100%" Visible="false">
                ...
                <tr>
                <td class="TDWidth">
                    <asp:Label SkinID="lblSkin" ID="lblSeparateOffice" runat="server" Text="Was there a separate office earlier?"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
      ...
      <asp:Panel ID="pnlMainlineBusiness" runat="server" Width="100%" Visible="false">
        <table cellpadding="0" cellspacing="0" border="0" id="Table1" style="width:100%" runat="server">
            ...
            <td class="TDWidth"  >
                ...
                <td>
                <asp:TextBox SkinID="txtSkin" Width="80%" ID="txtMainlineBusiness" runat="server" MaxLength="100" ></asp:TextBox>
                </td>
                </tr>
                </table>
      </asp:Panel>      
