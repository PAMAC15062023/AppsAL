<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/RL/RL_MasterPage.master" Theme="SkinFile" CodeFile="RL_ViewCase.aspx.cs" Inherits="CPV_RL_RL_ViewCase" %>
...
<table border="0" cellpadding="1" cellspacing="0" width="99%" id="TABLE2"> 
 ...
 <tr>
 <td colspan="9" >
 <asp:GridView ID="gvRL" AllowSorting="True" AllowPaging="True"  OnRowCommand="gvRL_RowCommand"  OnRowDataBound="gvRL_RowDataBound" DataSourceID="sdsRL" runat="server" AutoGenerateColumns="False"  
     ...
     <Columns>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateFieldResource2"> 
                        <ItemTemplate>
                            ...
                            CommandName="DeleteRL" meta:resourcekey="lnkDeleteCreditCardResource1" Enabled="False" Visible="False" ><img src="../../Images/icon_delete.gif" alt="Delete" style="border:0" />
                            </asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle Width="20px" />
                    </asp:TemplateField>
 ...
 <tr>
 <td colspan="9">
 <asp:SqlDataSource ID="sdsRL" runat="server" ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>"
     ...
     FROM CPV_RL_CASE_DETAILS WHERE SEND_DATETIME IS  NULL AND ([Client_Id] = ?) AND ([Centre_Id] = ?) ORDER BY CASE_ID DESC"
