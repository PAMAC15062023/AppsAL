...
public partial class RL_ResidenceVerification_Vend : System.Web.UI.Page
{
    string verificationType = "Vend";
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (Context.Request.QueryString["CaseID"] != null && Context.Request.QueryString["CaseID"] != "" && Context.Request.QueryString["VerTypeId"] != null && Context.Request.QueryString["VerTypeId"] != "")
                {
                    ...
                    if ((sVerifyTypeId == "31") || (sVerifyTypeId == "Vend"))  //for RV
                        //lblHead.Text = "No Objection Certificate";
                        lblHead.Text = "Vendor Verification";
                    ...
                    OleDbDataReader oledbCaseDtl_Vend;
                    ...
                    oledbCaseDtl_Vend = objRV.GetCASEDetail_Vend(sCaseId, sVerifyTypeId);
                    ...
                    if (oledbCaseDtl_Vend.Read() == true)
                    {
                        /////////add code for Hdfc Vend////////////////////////
                        ddlSellConfMem.SelectedValue = oledbCaseDtl_Vend["Name_Seller_conf_neigh"].ToString();
                        ddlSellTran.SelectedValue = oledbCaseDtl_Vend["Seller_aware"].ToString();
                        ddlSellProp.SelectedValue = oledbCaseDtl_Vend["whom_sell_prop"].ToString();
                        txtNameBuy.Text = oledbCaseDtl_Vend["buyer_name"].ToString();
                        txtSellKnow.Text = oledbCaseDtl_Vend["sell_get_know_buy"].ToString();
                        ddlSellLoan.SelectedValue = oledbCaseDtl_Vend["sell_finan_institution"].ToString();
                        txtOutLoan.Text = oledbCaseDtl_Vend["out_loan"].ToString();
                        ddlSellMorg.SelectedValue = oledbCaseDtl_Vend["mortgage"].ToString();
                        ddlSellDoc.SelectedValue = oledbCaseDtl_Vend["poss_doc"].ToString();
                        ddlSellPhoto.SelectedValue = oledbCaseDtl_Vend["photo_Iden"].ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (ValidateTextArea() == true)
            {
                ...
                objRV.SellProp = ddlSellProp.SelectedValue.ToString();
                objRV.NameBuy = txtNameBuy.Text.Trim();
                objRV.SellKnow = txtSellKnow.Text.Trim();
                objRV.SellLoan = ddlSellLoan.SelectedValue.ToString();
                objRV.OutLoan = txtOutLoan.Text.Trim();
                objRV.SellMorg = ddlSellMorg.SelectedValue.ToString();
                objRV.SellDoc = ddlSellDoc.SelectedValue.ToString();
                objRV.SellPhoto = ddlSellPhoto.SelectedValue.ToString();
              ...
              //  objRV.VisibleItems = ddlVisibleItems.SelectedValue.ToString();
                ...
                sMsg1 = objRV.InsertUpdateRLResiVerificationEntry_Vend();
    ...
    private void IfIsEditFalse()
    {
        ...
        ddlSellDoc.Enabled = false;
        ddlSellLoan.Enabled = false;
        ddlSellMorg.Enabled = false;
        ddlSellPhoto.Enabled = false;
        ddlSellProp.Enabled = false;
        ddlSellTran.Enabled = false;
        txtOutLoan.Enabled = false;
        txtNameBuy.Enabled = false;
        txtSellKnow.Enabled = false;  
    }
