...
public partial class CPV_RL_FEAssignment : System.Web.UI.Page
{
    ...
    public void FillView()
    {
        ...
        if (strClientID != "" && strCentreID != "")
        {
            ...
            String strSelADD = "";
            if (ddlType.SelectedItem.ToString() == "RV" || ddlType.SelectedItem.ToString() == "Vend" || ddlType.SelectedItem.ToString() == "Noc")
            {
            ...
            //}
            if (ddlType.SelectedItem.ToString() == "RCO")
            {
                strSelADD = "(ISNULL(CD.RES_ADD_LINE_1+' ','') + ISNULL(CD.RES_ADD_LINE_2+' ','') + ISNULL(CD.RES_ADD_LINE_3+' ','')) AS [Resident Address], CD.RES_CITY AS [City], CD.RES_PIN_CODE AS [Pincode], ";
            }
