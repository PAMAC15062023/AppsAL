<%@ Page Language="C#" MasterPageFile="RL_MasterPage.master" AutoEventWireup="true" CodeFile="RL_VerificationView.aspx.cs" Inherits="RL_VerificationView" Theme="skinFile" %>
    ...
    <tr><td  style="height: 14px"></td><td style="height: 14px"></td><td style="height: 14px"></td></tr>
        <tr>
            ...
            <asp:DropDownList SkinID="ddlSkin" ID="ddlVerifyType" runat="server" DataSourceID="sdsVerifyType"
                 DataTextField="VERIFICATION_TYPE" DataValueField="VERIFICATION_TYPE_ID" >
            </asp:DropDownList>
