<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" Theme="skinFile" AutoEventWireup="true" CodeFile="RL_CaseStatusView.aspx.cs" Inherits="CPV_RL_RL_CaseStatusView"  %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Select Verification Type">
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblNoc" runat="server" Text="Noc" Visible="false" />
                    <asp:Label ID="lblSlashNoc" runat="server" Width="9px" Visible="False" ForeColor="Blue">/</asp:Label>
                    
                    <asp:Label ID="lblVend" runat="server" Text="Vend" Visible="false" />
                    <asp:Label ID="lblSlashVend" runat="server" Width="9px" Visible="False" ForeColor="Blue">/</asp:Label>
