<%@ Page Language="C#" MasterPageFile="RL_MasterPage.master" AutoEventWireup="true"
    Theme="SkinFile" CodeFile="RL_ResidenceVerification.aspx.cs" Inherits="RL_ResidenceVerification" %>
            ...
            <tr>
                        ...
                        <asp:TableRow ID="tblrow" runat="server">
                            <asp:TableCell ID="tblCell" runat="server">
                               ...
                               <asp:Panel ID="pnlDateTimeOfVerification" runat="server" Width="100%" Visible="false">
                                ...
                                <asp:Panel ID="pnlAreaOfHouse" runat="server" Width="100%" Visible="true">
                                ...
                                <asp:Panel ID="pnlNamePlateonDoor" runat="server" Width="100%" Visible="true">
                                ...
                                <asp:Panel ID="pnlNumberofRooms" runat="server" Width="100%" Visible="true">
                                ...
                                <asp:Panel ID="pnlStandardOfLiving" runat="server" Width="100%" Visible="true">
                                ...
                                <asp:Panel ID="pnlFlooring" runat="server" Width="100%" Visible="true">
                               ...
                               <asp:Panel ID="pnlSocietyBoardSighted" runat="server" Width="100%" Visible="true">
                               ...
                               <asp:Panel ID="pnlVerifierComments" runat="server" Width="100%" Visible="true">
              ...
              DataTextField="STATUS_CODE" DataValueField="CASE_STATUS_ID" OnDataBound="ddlOverallVerification_DataBound" AutoPostBack="false">
                               ...
                               <asp:Panel ID="pnlPagerNo" runat="server" Width="100%" Visible="false">
                                  ...
                                  <asp:Panel ID="pnlVisibleItems" runat="server" Width="100%" Visible="true">
                               ...
                               <!--ended by kamal matekar----->
                                ...
                                <asp:Panel ID="pnlChildren" runat="server" Width="100%" Visible="true">
                                ...
                                <asp:Panel ID="pnlCarPark" runat="server" Width="100%" Visible="true">
                                ...
                                <asp:Panel ID="pnlResiExti" runat="server" Width="100%" Visible="true">
                               ...
                               <asp:Panel ID="pnlResiIntl" runat="server" Width="100%" Visible="true">
                               ...
                               <asp:Panel ID="pnlConsHouse" runat="server" Width="100%" Visible="true">
                                 ...
                                 <asp:Panel ID="pnlExteriorPremises" runat="server"  Width="100%" Visible="true">
            ...
            <td class="TDWidth" style="height: 22px">
                ...
                <asp:DropDownList SkinID="ddlSkin" ID="ddlExteriorPremises" runat="server"   AutoPostBack="false">
                    ...
                    <asp:ListItem>Poor</asp:ListItem>                  
                             ...
                             <asp:Panel ID="pnlRoofType" runat="server" Width="100%" Visible="true">
