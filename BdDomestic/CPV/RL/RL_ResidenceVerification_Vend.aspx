<%@ Page Language="C#" MasterPageFile="RL_MasterPage.master" AutoEventWireup="true"
    Theme="SkinFile" CodeFile="RL_ResidenceVerification_Vend.aspx.cs" Inherits="RL_ResidenceVerification_Vend" %>
...
<tr><td style="padding-left:10px">
                        ...
                        <asp:TableRow ID="tblrow" runat="server">
                            <asp:TableCell ID="tblCell" runat="server">
                               ...
                               <asp:Panel ID="pnlDateTimeOfVerification" runat="server" Width="100%" Visible="false">
                                ...
                                <%--add this code for Hdfc Noc 30/12/2009--%>
                                <asp:Panel ID="pnlSellConfMem" runat="server" Width="100%" Visible="false">
                                    <table id="tblSellConfMem" cellpadding="0" cellspacing="0" style="width: 100%"
                                        ...
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblSellConfMem" runat="server" Text="Name of the Seller confirmed from Neighbour/Society Members?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                ...
                                <asp:Panel ID="pnlSellProp" runat="server" Width="100%" Visible="false">
                                    <table id="tblSellProp" cellpadding="0" cellspacing="0" style="width: 100%"
                                        runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblSellProp" runat="server" Text="To whom is the seller selling his/her property?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                                <asp:DropDownList ID="ddlSellProp" runat="server" AutoPostBack="false" SkinID="ddlSkin">
                                                    <asp:ListItem Text="NA" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <asp:Panel ID="pnlNameBuy" runat="server" Width="100%" Visible="false">
                                    <table id="tblNameBuy" cellpadding="0" cellspacing="0" style="width: 100%"
                                        runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblNameBuy" runat="server" Text="Name of the Buyer"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                                <asp:TextBox SkinID="txtSkin" ID="txtNameBuy" Width="80%"  MaxLength="500" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                                <asp:Panel ID="pnlSellKnow" runat="server" Width="100%" Visible="false">
                                    <table id="tblSellKnow" cellpadding="0" cellspacing="0" style="width: 100%"
                                        runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblSellKnow" runat="server" Text="How did the seller get to know the buyer?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                                <asp:TextBox SkinID="txtSkin" ID="txtSellKnow" Width="80%"  MaxLength="500" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                                <asp:Panel ID="pnlSellLoan" runat="server" Width="100%" Visible="false">
                                    <table id="tblSellLoan" cellpadding="0" cellspacing="0" style="width: 100%"
                                        ...
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblSellLoan" runat="server" Text="Has the seller availed a loan from any financial institution or bank, on the above property?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                ...
                                <asp:Panel ID="pnlOutLoan" runat="server" Width="100%" Visible="false">
                                    <table id="tblOutLoan" cellpadding="0" cellspacing="0" style="width: 100%"
                                        runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblOutLoan" runat="server" Text="If yes (Name of Bank) & Outstanding Loan?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                                <asp:TextBox SkinID="txtSkin" ID="txtOutLoan" Width="80%" MaxLength="500" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                                <asp:Panel ID="pnlSellMorg" runat="server" Width="100%" Visible="false">
                                    <table id="tblSellMorg" cellpadding="0" cellspacing="0" style="width: 100%"
                                        runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblSellMorg" runat="server" Text="Has the seller approached the Society for an NOC for Mortgage?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                                <asp:DropDownList ID="ddlSellMorg" runat="server" AutoPostBack="false" SkinID="ddlSkin">
                                                    <asp:ListItem Text="NA" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <asp:Panel ID="pnlSellDoc" runat="server" Width="100%" Visible="false">
                                    <table id="tblSellDoc" cellpadding="0" cellspacing="0" style="width: 100%"
                                        runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblSellDoc" runat="server" Text="Is the seller in possession of the original title documents?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                                <asp:DropDownList ID="ddlSellDoc" runat="server" AutoPostBack="false" SkinID="ddlSkin">
                                                    <asp:ListItem Text="NA" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <asp:Panel ID="pnlSellPhoto" runat="server" Width="100%" Visible="false">
                                    <table id="tblSellPhoto" cellpadding="0" cellspacing="0" style="width: 100%"
                                        runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblSellPhoto" runat="server" Text="Photo identification of seller verified?"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
                                                <asp:DropDownList ID="ddlSellPhoto" runat="server" AutoPostBack="false" SkinID="ddlSkin">
                                                    <asp:ListItem Text="NA" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                </asp:DropDownList>
    ...
    <asp:ValidationSummary ID="vsValidateDate" runat="server"  
        ...
        <asp:SqlDataSource ID="sdsFE" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
            ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SubStatus_Master;1"
