...
public partial class RL_QCTeleResidenceVerification : System.Web.UI.Page
{
        ...
        try
        {
            if (!IsPostBack)
            {
                if (Context.Request.QueryString["CaseID"] != null && Context.Request.QueryString["CaseID"] != "" && Context.Request.QueryString["VerTypeId"] != null && Context.Request.QueryString["VerTypeId"] != "")
                {
                    ...
                    Get_Details_For_QCTele(txtCaseID.Text.Trim(), VeriType, "RL");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Get_Details_For_QCTele(txtCaseID.Text.Trim(), veritype1, "RL");
