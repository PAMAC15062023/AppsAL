<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" AutoEventWireup="true" CodeFile="RL_QC_FEAssignment.aspx.cs" Inherits="CPV_RL_RL_QC_FEAssignment" Theme="SkinFile" Title="PAMAC Online Service" %>
...
<fieldset><legend class="FormHeading">QC FE Assignment</legend>
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <asp:CustomValidator ID="valgv" runat="server" ClientValidationFunction="vaidation"
        Display="None" ErrorMessage="Please select at least one Case. " 
        SetFocusOnError="True" ValidationGroup="vgrpFE"></asp:CustomValidator>
</asp:Content>
