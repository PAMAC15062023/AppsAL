...
public partial class CPV_KYC_KYC_QCRV_VERI : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (iCount == 1)
        {
            Response.Redirect("KYC_QCVerificationView.aspx?Msg=" + lblMsg.Text);
        }
    }
    ...
    {
        Response.Redirect("KYC_QCVerificationView.aspx");
    }
    ...
    {
        Response.Redirect("KYC_QCRV_VERI.aspx?CaseID=" + hidCaseID.Value + "&VerTypeId=1&VerificationTypeCode=" + hidVerificationTypeCode.Value + "&Mode=View");
    }
    protected void lbBV_Click(object sender, EventArgs e)
    {
        Response.Redirect("KYC_QCBUSINESS_VERI.aspx?CaseID=" + hidCaseID.Value + "&VerTypeId=2&VerificationTypeCode=" + hidVerificationTypeCode.Value + "&Mode=View");
    }
