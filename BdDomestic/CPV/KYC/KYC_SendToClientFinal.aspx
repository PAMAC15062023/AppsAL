<%@ Page Language="C#" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" AutoEventWireup="true" CodeFile="KYC_SendToClientFinal.aspx.cs" Inherits="CPV_KYC_KYC_SendToClientFinal" Theme="SkinFile"%>
...
alt="Calendar" src="../../Images/SmallCalendar.gif" />
    ...
    <td>
        <asp:Button ID="btnSearch" runat="server" SkinID="btnSearchSkin" OnClick="btnSearch_Click" ValidationGroup="grpSearch"/>&nbsp;
...
<td colspan="5">
    ...
    <tr>
    <td colspan="6" style="height: 54px">
    ...
    <td style="height: 26px; width: 59px;" id="TD2"><asp:Label id="lblsenddate" runat="server" SkinID="lblSkin" Text="Send Date" ></asp:Label>*</td>
    <td style="height: 26px"><asp:TextBox id="txtSendDt" ReadOnly="true" runat="server" ValidationGroup="grpSend" MaxLength="10" SkinID="txtSkin"  CssClass="textbox"></asp:TextBox>&nbsp;
        <asp:Label id="lblsenddatefotmate" runat="server" SkinID="lblSkin" Text="[dd/mm/yyyy]" ></asp:Label>
    </td>
    <td style="height: 26px"><asp:Label id="lblsendtime"  runat="server" SkinID="lblSkin" Text="Send Time "></asp:Label>*</td>
...
<asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="List" ShowMessageBox="True" 
    ...
    <asp:CustomValidator ID="CustomValidator_TatCalculation" runat="server" Display="None"
        ErrorMessage="First Calculate TAT" Width="158px" ClientValidationFunction="Validation_CalculateTAT" ValidationGroup="grpSend"></asp:CustomValidator></td>
    <td >
    </td>
</tr>
    <tr>
