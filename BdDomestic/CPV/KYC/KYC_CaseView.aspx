<%@ Page Language="C#" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master"  Theme="SkinFile" AutoEventWireup="true" CodeFile="KYC_CaseView.aspx.cs" Inherits="KYC_KYC_CaseView"  %>
...
<fieldset ><legend class="FormHeading">View Cases</legend>
  <table style="width: 100%" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr>
          ...
          <tr><td><br /><table border="0" cellpadding="0" cellspacing="0" id="tblCCSearch" width="100%">
              <tr>
                  <td >
                      Ref No</td>
                  <td>
                      <asp:TextBox ID="txtRefNo" MaxLength="50" runat="server" SkinID="txtSkin"></asp:TextBox></td>
                  <td>
                      Name</td>
                  <td>
                      <asp:TextBox ID="txtName" MaxLength="200" runat="server" SkinID="txtSkin"></asp:TextBox></td>
                  <td><asp:CheckBox id="chkName" runat="server"  SkinID="chkSkin" Text="Absolute" ></asp:CheckBox> </td>
                  <td>
                  </td>
              </tr>
              <tr>
          ...
          <tr><td>
              <asp:GridView ID="gvKYC" AllowSorting="True" AllowPaging="True" PageSize="15" DataSourceID="sdsKYC" runat="server" AutoGenerateColumns="False" OnRowCommand="gvKYC_RowCommand" OnRowDataBound="gvKYC_RowDataBound" SkinID="gridviewSkin">
                  <Columns>
