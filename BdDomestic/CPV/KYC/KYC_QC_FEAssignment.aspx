<%@ Page Language="C#" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" AutoEventWireup="true" CodeFile="KYC_QC_FEAssignment.aspx.cs" Theme="SkinFile" Inherits="CPV_KYC_KYC_QC_FEAssignment" Title="PAMAC Online Service" %>
...
<fieldset><legend class="FormHeading">QC FE Assignment</legend>
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <tr><td>        
        <asp:GridView ID="gvFEAssignmentCases" runat="server" DataSourceID="sdsGV" OnPageIndexChanging="gvFEAssignmentCases_PageIndexChanging" OnSorting="gvFEAssignmentCases_Sorting"  OnDataBound="gvFEAssignmentCases_DataBound" Width="100%" SkinID="gridviewSkin">           
            <Columns>
            <asp:TemplateField>
                <HeaderTemplate>
