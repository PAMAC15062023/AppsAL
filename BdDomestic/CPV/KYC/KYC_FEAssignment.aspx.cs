...
public partial class CPV_KYC_KYC_FEAssignment : System.Web.UI.Page
{
    ...
    public void FillView()
    {
        ...
        if (strClientID != "" && strCentreID != "")
        {
            ...
            strSelADD = "(ISNULL(CD.RES_ADD_LINE_1+' ','') + ISNULL(CD.RES_ADD_LINE_2+' ','') + ISNULL(CD.RES_ADD_LINE_3+' ','')) AS [Resident Address],(ISNULL(CD.Off_ADD_LINE_1+' ','') + ISNULL(CD.Off_ADD_LINE_2+' ','') + ISNULL(CD.Off_ADD_LINE_3+' ','')) AS [Office Address], CD.RES_CITY AS [Resi City],CD.Off_CITY AS [Off City], CD.RES_PIN_CODE AS [Resi Pincode],CD.Off_PIN_CODE AS [Off Pincode], ";
