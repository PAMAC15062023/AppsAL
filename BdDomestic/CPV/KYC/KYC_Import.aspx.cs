...
public partial class CPV_KYC_KYC_Import : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string strimportedRecord = oImport.GetNumberOfRecord("CPV_KYC_CASE_DETAILS", "CASE_REC_DATETIME", strcentreID, strclusterID, strclientID).ToString();
