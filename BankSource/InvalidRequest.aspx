<%@ page language="C#" autoeventwireup="true" inherits="InvalidRequest, App_Web_invalidrequest.aspx.cdcab7d2" viewStateEncryptionMode="Always" %>
                ...
                <tr>
                    ...
                    <td height="450" valign="top">
                        <font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<br />
                            ...
                            <br />
                            <br />
                            <asp:Label ID="lblMessage" runat="server" Font-Size="13pt" ForeColor="Red" Height="44px"
                                Text="Invalid Request or Session Expired , Please continue with username and password"
                                Width="882px" Font-Bold="True"></asp:Label><br />
                            <asp:LinkButton ID="lnkLogin" runat="server" Font-Bold="True" OnClick="lnkLogin_Click"
                                ToolTip="Please click to Login button" Width="575px">Login Again</asp:LinkButton></font></td>
                </tr>
                <tr>
