<%@ Page Title="" Language="C#" MasterPageFile="~/IncidentTracker2.Master" AutoEventWireup="true" CodeBehind="IT_ChangePassword.aspx.cs" Inherits="IncidentTracker.IT_ChangePassword" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 848px; height: 280px">
        ...
        <tr>
            ...
            <td class="TableTitle" style="width:502px">&nbsp; Old Password&nbsp; <span style="color: #ff0000">*</span></td>
        ...
        <tr>
            <td style="width: 9px"></td>
            <td class="TableTitle">&nbsp; New  Password&nbsp; <span style="color: #ff0000">*</span></td>
        ...
        <tr>
            ...
            <td class="TableTitle" style="height: 8px;">Confirm Password<span style="color: #ff0000">*</span>
            </td>
        ...
        <tr>
            <td colspan="1" style="width: 9px; height: 66px"></td>
        ...
        <tr style="font-size: 8pt">
            <td class="TableTitle" colspan="8" rowspan="1" style="height: 37px">&nbsp;&nbsp;
                <asp:Button ID="btnConfirm" runat="server" Text="Save" Font-Bold="True" Width="71px"
                    ValidationGroup="grpCngPwd" BorderWidth="1px" OnClick="btnConfirm_Click" />
                &nbsp;
