...
{
    public partial class IT_UserMaster : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                BindReportingManager();// add on 24/01/2025
            }
        }
        ...
        private void Get_RoleMaster()
        {
            try
            {
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "IT_GetRoleMaster_SP";
                SqlDataAdapter sqlDA = new SqlDataAdapter();
                sqlDA.SelectCommand = sqlCom;
                DataTable dt = new DataTable();
                sqlDA.Fill(dt);
                ...
                ddlUserGroupList.DataTextField = "RoleName";
                ddlUserGroupList.DataValueField = "RoleID";
        ...
        private void Get_UserInfo(string pUserID)
        {
            ...
            try
            {
                if (sqlCon.State == ConnectionState.Closed)
                {
                    ...
                    sqlCom.Connection = sqlCon;
                    sqlCom.CommandType = CommandType.StoredProcedure;
                    sqlCom.CommandText = "IT_UserInfo_SP";
        ...
        {
            Insert_UserInfo();
            Get_UserInfo(txtUserID.Text.Trim());
            Reset_Controls();
        }
        private void Insert_UserInfo()
        {
            try
            {
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "IT_InsertUserInfo_SP"; 
                ...
                RoleId.Value = Convert.ToInt32(ddlUserGroupList.SelectedItem.Value);
                ...
                SqlParameter ReportingManager = new SqlParameter(); //add on 24/01/2025
        ...
        {
            Response.Redirect("~/Pages/IT_MenuPage.aspx", true);
        }
        ...
        protected void BindReportingManager()
        {
            try
            {
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "IT_BindReportingManagerList_SP";
