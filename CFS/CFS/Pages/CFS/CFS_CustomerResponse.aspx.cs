...
public partial class Pages_CFS_CFS_CustomerResponse : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                string CustomerId = Convert.ToString(Request.QueryString["custid"]);

                hfCustomerId.Value = Convert.ToString(Request.QueryString["custid"]);

                bool isSubmited = CheckSurvey(CustomerId);
                ...
                if (isSubmited == true)
                {
                    ...
                    lblMessage.Text = "Response Already Submitted";
                }
                else
                {
                    SurveySubmitedPanel.Visible = false;
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        // if ans 1 and ans2 and ans3 and ans4 = 'yes'
        // then ddelAnsw5.selec = 51

        if (rbtnYes.Checked == true && rbtnYes2.Checked == true && rbtnYes3.Checked == true && rbtnYes4.Checked == true)
        {
            answer_51 = "Y";
            max_marks5 = 25;
        }
        ...
        if (result > 0)
        {
            ...
            lblMessage.Visible = true;
            lblMessage.Text = "Thank You - Response Accepted";
    ...
    protected void SendMail(string CustomerId)
    {
        ...
        try
        {
            ...
            string MailCC = verticalHeadEmailId +","+DCHEmailId + ","+
                            "csat@pamac.com" +","+ DCHCoordinatorEmailId;
    ...
    protected bool CheckSurvey(string CustomerId)
    {
        SqlConnection sqlCon = new SqlConnection(ConfigurationSettings.AppSettings["ConnectionString"]);
        ...
        sqlCom.Connection = sqlCon;
        sqlCom.CommandType = CommandType.StoredProcedure;
        sqlCom.CommandText = "CFS_CheckeSurvey_SP";
        SqlDataAdapter sqlDA = new SqlDataAdapter();
        sqlDA.SelectCommand = sqlCom;
