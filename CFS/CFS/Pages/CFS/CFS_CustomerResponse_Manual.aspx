<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="CFS_CustomerResponse_Manual.aspx.cs" Inherits="Pages_CFS_CFS_CustomerResponse_Manual" %>
        ...
        <table>
            <tr>
                <td class="TableGrid" style="width: 95px;">
                    <asp:Label ID="lblcustomerlist" runat="server" Text="Customer Name"></asp:Label>
                </td>
                <td class="TableGrid" style="width: 95px;">
