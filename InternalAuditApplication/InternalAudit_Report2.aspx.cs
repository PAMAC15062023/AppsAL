...
{
    public partial class InternalAudit_Report2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BindVertical();
                BindFinalStatus();
                pnlGridForReport2.Visible = false;
        ...
        protected void GetReportDataSearchWise()
        {
            try
            {
                ...
                string FinalStatus_2 = string.Empty;
                ...
                if (ddlFinalStatus.SelectedItem.Text != "--Select--")
                {
                    FinalStatus_2 = ddlFinalStatus.SelectedItem.Text;
                }
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "InternalAudit_GetDataForReport2_SP";
                sqlCom.CommandTimeout = 0;
                ...
                FinalStatus.Value = FinalStatus_2; //ddlFinalStatus.SelectedItem.Text;
                FinalStatus.ParameterName = "@FinalStatus";
                sqlCom.Parameters.Add(FinalStatus);
                ...
                if (dt.Rows.Count > 0)
                {
                    GVDetailsFromReport2.DataSource = dt;
                    GVDetailsFromReport2.DataBind();
                    pnlGridForReport2.Visible = true;
                    BtnExport.Visible = true;

                    GVDetailsFromReport2.Rows[0].Cells[0].Enabled = false;
                    GVDetailsFromReport2.Rows[0].Cells[1].Enabled = false;
                }
                else
                {
                    GVDetailsFromReport2.DataSource = null;
                    GVDetailsFromReport2.DataBind();
                    pnlGridForReport2.Visible = false;
                    BtnExport.Visible = false;
        ...
        {
            String attachment = "attachment; filename=" + "Report2" + ".xls";
            ...
            GVDetailsFromReport2.EnableViewState = false;
            GVDetailsFromReport2.GridLines = GridLines.Both;
            GVDetailsFromReport2.RenderControl(htw);
