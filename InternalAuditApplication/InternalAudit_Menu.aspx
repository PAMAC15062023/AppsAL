<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InternalAudit_Menu.aspx.cs" Inherits="InternalAuditApplication.InternalAudit_Menu" %>
                            ...
                            <table cellspacing="0" border="0" cellpadding="2" width="100%">
                                <tr>
                                    ...
                                    <td align="right" style="height: 17px">&nbsp;&nbsp;<asp:LinkButton
                                        ...
                                        &nbsp;&nbsp;
                                        &nbsp;&nbsp;<asp:LinkButton
                                            ID="lnkLogOut" runat="server" Font-Bold="True" ToolTip="Log out" OnClick="lnkLogOut_Click1">Log out</asp:LinkButton>
                                        &nbsp;&nbsp;
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="dropdown-content">
                        <table>
                            <tr id="Admin" runat="server">
                                <td>
                                    <a href="InternalAudit_ImportScheduler.aspx">Import Scheduler</a>
                                    <a href="InternalAudit_Scheduler.aspx">Scheduler</a>
                                    <a href="InternalAudit_Assessment.aspx">Assessment</a>
                                    <a href="InternalAudit_StatusUpdate.aspx">Status Update</a>
                                    <a href="InternalAudit_Report1.aspx">MIS</a>
                                    <a href="InternalAudit_Report2.aspx">Details Report</a>
                                    <a href="InternalAudit_Report3.aspx">Tracker</a>
                                    <a href="InternalAudit_AssessmentDetailsReport.aspx">Assessment Details Report</a>
                                    <a href="InternalAudit_VerticalMaster.aspx">Vertical Master</a>
                                    <a href="InternalAudit_BranchMaster.aspx">Branch Master</a>
                                    <a href="InternalAudit_UnitMaster.aspx">Unit Master</a>
                                    <a href="UserMaster.aspx">User Master</a>
                                    <a href="InternalAudit_AuditeeCAP.aspx">Auditee CAP</a>
                                </td>
                            </tr>
                            <tr id="Auditor" runat="server">
                                <td>
                                    <a href="InternalAudit_Scheduler.aspx">Scheduler</a>
                                    <a href="InternalAudit_Assessment.aspx">Assessment</a>
                                    <a href="InternalAudit_StatusUpdate.aspx">Status Update</a>
