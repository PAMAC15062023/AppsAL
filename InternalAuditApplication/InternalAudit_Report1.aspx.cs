...
{
    public partial class InternalAudit_Report1 : System.Web.UI.Page
    {
        ...
        protected void GetReportDataSearchWise()
        {
            try
            {
                ...
                string Scope_NonScope = string.Empty;
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "InternalAudit_GetDataForReport1_SP";
                sqlCom.CommandTimeout = 0;
                ...
                if (dt.Rows.Count > 0)
                {
                    GVDetailsFromReport1.DataSource = dt;
                    GVDetailsFromReport1.DataBind();

                    BtnExport.Visible = true;
                    pnlGridForReport1.Visible = true;
                    GVDetailsFromReport1.Rows[0].Cells[0].Enabled = false;
                    GVDetailsFromReport1.Rows[0].Cells[1].Enabled = false;

                    lblMsgXls.Text = ""; //add on 28/08/2024 by rutuja
                }
                else
                {
                    GVDetailsFromReport1.DataSource = null;
                    GVDetailsFromReport1.DataBind();
                    BtnExport.Visible = false;
                    pnlGridForReport1.Visible = false;
        ...
        private void Genrate_Excel()
        {
            ...
            GVDetailsFromReport1.EnableViewState = false;
            GVDetailsFromReport1.GridLines = GridLines.Both;
            GVDetailsFromReport1.RenderControl(htw);
