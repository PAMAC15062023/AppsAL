    ...
    public partial class UserMaster : System.Web.UI.Page
    {
        ...
        protected void BindRole()
        {
            try
            {
                ...
                sqlCom.CommandText = "InternalAudit_BindRole_SP";
        ...
        protected void GetUserDetails(string UserID)
        {
            ...
            SqlCommand cmd = new SqlCommand("InternalAudit_GetUserDetails_SP", sqlCon);
        ...
        private void Insert_UserInfo()
        {
            try
            {
                ...
                {
                    msg = msg + "Please Enter Employee Email ID !! ";
                }
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "InternalAudit_InsertUserMaster_SP";
                ...
                Branch_Hub_Id.Value = ddlCPC.SelectedItem.Text;
        ...
        protected void BindReportingManager()
        {
            try
            {
                ...
                sqlCom.Connection = sqlCon;
                sqlCom.CommandType = CommandType.StoredProcedure;
                sqlCom.CommandText = "InternalAudit_BindReportingManagerList_SP";
                sqlCom.CommandTimeout = 0;
