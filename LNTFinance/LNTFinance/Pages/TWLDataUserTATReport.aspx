<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/LNT_CommonMaster.Master" AutoEventWireup="true" CodeBehind="TWLDataUserTATReport.aspx.cs" Inherits="LNTFinance.Pages.TWLDataUserTATReport" %>
    ...
    <table style="width: 688px;">
        <tr>
            <td class="TableTitle" style="height: 27px" colspan="4">
                <span style="font-size: 13pt; font-weight: bold;">TWL&nbsp;DATA&nbsp;User&nbsp;TAT&nbsp;Report</span>
            </td>
        </tr>
    </table>
    <table style="width: 688px;">
