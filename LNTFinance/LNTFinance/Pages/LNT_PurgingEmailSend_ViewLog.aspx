<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/LNT_CommonMaster.Master" AutoEventWireup="true" CodeBehind="LNT_PurgingEmailSend_ViewLog.aspx.cs" Inherits="LNTFinance.Pages.LNT_PurgingEmailSend_ViewLog" %>
    ...
    <table style="width: 688px;">
        <tr>
            <td class="TableTitle" style="height: 27px" colspan="4">
                <span style="font-size: 13pt; font-weight: bold;">Mail VIEW LOG</span>
            </td>
        </tr>
    </table>
    <table style="width: 688px;">
            ...
            <td class="TableTitle" style="height: 27px" colspan="4">
                ...
                <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click"
                    ...
                    <asp:Button ID="btnExport" runat="server" Text="Export" BorderColor="#400000"
                      OnClick="btnExport_Click"   BorderWidth="1px" Font-Bold="False" Width="105px" Visible="false" />&nbsp;
