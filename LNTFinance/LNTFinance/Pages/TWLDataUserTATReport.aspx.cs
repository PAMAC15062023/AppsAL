...
{
    public partial class TWLDataUserTATReport : System.Web.UI.Page
    {
            ...
            try
            {
                if (txtFromDate.Text != "")
                {
                    if (txtToDate.Text != "")
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("LNT_GetTWLDataUserTATReport_SP", sqlCon);
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            String attachment = "attachment; filename=TWLDataUserTATReport.xls";
