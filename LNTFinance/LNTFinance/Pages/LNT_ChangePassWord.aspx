<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/LNT_CommonMaster.Master" AutoEventWireup="true" CodeBehind="LNT_ChangePassWord.aspx.cs" Inherits="LNTFinance.Pages.LNT_ChangePassWord" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <tr>
            ...
            <asp:TextBox ID="txtOldPassword" runat="server" MaxLength="20" TextMode="Password" SkinID="txtSkin"></asp:TextBox></td>  <%--//OnTextChanged="txtOldPassword_TextChanged" AutoPostBack="true"--%>
        ...
        <tr style="font-size: 8pt">
            <td class="TableTitle" colspan="8" rowspan="1" style="height: 37px">
                &nbsp;&nbsp;
                <asp:Button ID="btnConfirm" runat="server" Text="Save" Font-Bold="True" 
                    Width="71px" ValidationGroup="grpCngPwd" BorderWidth="1px" OnClick="btnConfirm_Click" />
                &nbsp;
                ...
                &nbsp; <asp:Button ID="btnLogin" runat="server" Font-Bold="True"
                    Text="Login Again"  BorderWidth="1px" OnClick="btnLogin_Click" />&nbsp;
			...
			<div class="shadow2">
				<div class="shadow3">
                    ...
                    <li class="MsoNormal" style="margin: 0in 0in 0pt; mso-list: l0 level1 lfo1; tab-stops: list .5in">
                        ...
                        <span style="font-size: 8pt; color: navy; font-family: verdana">Your Password
                            Should consist of  least 1 Numeric [0-9] and 1 special character [!@#$%^&amp;*].</span></li><li class="MsoNormal" style="margin: 0in 0in 0pt; mso-list: l0 level1 lfo1; tab-stops: list .5in">
                <span style="font-size: 8pt; color: navy; font-family: verdana">Your Password
